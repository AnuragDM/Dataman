<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="AddCompany.aspx.cs" Inherits="AstralFFMS.AddCompany" %>
                            ...
                            <div class="row">
                                <div class="col-lg-5 col-md-6 col-sm-8 col-xs-10">
                                    <div class="form-group">
                                        ...
                                        <input type="text" runat="server" class="form-control" maxlength="30" id="Compname" placeholder="Enter First Name" tabindex="2" />

                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Description:</label>&nbsp;&nbsp;<label for="requiredFields" style="color: red;">*</label>
                                        <input type="text" runat="server" class="form-control" maxlength="30" id="Desc" placeholder="Enter Last Name" tabindex="2" />

                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Phone:</label>&nbsp;&nbsp;<label for="requiredFields" style="color: red;">*</label>
                                        <input type="text" runat="server" class="form-control" maxlength="40" id="Phone" placeholder="Enter Job Title" tabindex="2" />
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Url:</label>&nbsp;&nbsp;<label for="requiredFields" style="color: red;">*</label>
                                        <input type="text" runat="server" class="form-control" maxlength="75" id="Url" placeholder="Enter Company" tabindex="2" />
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputEmail1"></label>
                                        <input type="text" runat="server" class="form-control" maxlength="6" id="Zip" onkeypress="javascript:return isNumber (event)" placeholder="Enter Zip" tabindex="5" />
                                        <br />
