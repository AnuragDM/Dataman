<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.master" AutoEventWireup="true" Inherits="ActivityCompareRpt" Codebehind="ActivityCompareRpt.aspx.cs" %>
               ...
               <div class="clearfix"></div>
                ...
                <div class="form-group col-md-4 col-sm-4 col-xs-12" >
                   ...
                   <label for="Second Person Name" >Second Person Name :</label>
                    <asp:DropDownList ID="ddlsecondperson" CssClass="textbox form-control" Width="100%" runat="server">
                        </asp:DropDownList>
                </div>
                <div class="clearfix"></div>
                <div class="form-group col-md-4 col-sm-4 col-xs-12" >                   
                ...
                <div class="form-group col-md-4 col-sm-4 col-xs-12" >
                   ...
                   <label for="Third Person Name" >Third Person Name :</label>
                    <asp:DropDownList ID="ddlthirdperson" CssClass="textbox form-control" Width="100%" runat="server" >
                        </asp:DropDownList>
                </div>
                <div class="clearfix"></div>
                 <div class="form-group col-md-4 col-sm-4 col-xs-12" >
                   ...
                   <label for="From Date" >From Date :</label>
                    ...
                    <asp:TextBox ID="txt_fromdate" Enabled="false" runat="server" CssClass="textbox form-control fdate" MaxLength="10" OnTextChanged="txt_fromdate_TextChanged" AutoPostBack="true" ></asp:TextBox>
                    </div>
                         <div class="col-md-1 col-xs-2 col-sm-3 no-padding">
                      ...
                      <div class="col-md-4 col-xs-3 col-sm-4 paddingright0 ">
             <asp:TextBox ID="Txt_FromTime" runat="server" CssClass="textbox form-control time"  MaxLength="5"></asp:TextBox>
                          </div>
                ...
                <div class="form-group col-md-4 col-sm-4 col-xs-12" >
                   ...
                   <label for="To Date" >To Date :</label>
                    <div class="clearfix"></div>
                     <div class="col-md-7 col-sm-5 col-xs-7 no-padding">
                 <asp:TextBox ID="TextBox1" Enabled="false" runat="server" CssClass="textbox form-control fdate" MaxLength="10" OnTextChanged="TextBox1_TextChanged" AutoPostBack="true" ></asp:TextBox>
                    </div>
                       <div class="col-md-1 col-xs-2 col-sm-3 no-padding">
                     ...
                     <%--<asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/img/Calendar.png" />--%>
                          <div class="col-md-4 col-xs-3 col-sm-4 paddingright0 ">
                           <asp:TextBox ID="TextBox2" runat="server" CssClass="textbox form-control time "  MaxLength="5"></asp:TextBox>
                       </div>
                ...
                <div class="form-group col-md-4 col-sm-4 col-xs-12" >
                   ...
                   <div class="col-md-2 no-padding"> <asp:TextBox ID="txtaccu" runat="server" Text="200" Width="50px" CssClass="form-control"></asp:TextBox></div>
