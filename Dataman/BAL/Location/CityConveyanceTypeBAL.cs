...
namespace BAL
{
   public class CityConveyanceTypeBAL
   {
       public int InsertUpdateCityConveyanceType(Int32 Id, string Name)
       {
           ...
           DbConnectionDAL.ExecuteNonQuery(CommandType.StoredProcedure, "Sp_InsUpdCityConveyanceType", dbParam);
       ...
       public int delete(string Id)
       {
           ...
           DbConnectionDAL.ExecuteNonQuery(CommandType.StoredProcedure, "Sp_DeleteCityConveyanceType", dbParam);
