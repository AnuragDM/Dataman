<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="DesignationMaster.aspx.cs" Inherits="AstralFFMS.DesignationMaster" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        function BindGrade() {
            ...
            var obj = { GradeId: 0 };
            $('#<%=ddlgrade.ClientID %>').empty().append('<option selected="selected" value="0">Loading...</option>');
            $.ajax({
                type: "POST",
                url: pageUrl + '/PopulateGrade',
            ...
            function OnPopulated(response) {
                PopulateControl(response.d, $("#<%=ddlgrade.ClientID %>"));
            }
            function PopulateControl(list, control) {
                if (list.length > 0) {
                    ...
                    var id = $('#<%=HiddenGradeUnderID.ClientID%>').val();
                    //  alert(id);
                    if (id != "") {
                        control.val(id);
                    }
    ...
    <script type="text/javascript">
        function validate() {
            if ($('#<%=DesName.ClientID%>').val() == "") {
                errormessage("Please enter Designation Name.");
                return false;
            }

            var value = ($('#<%=DesName.ClientID%>').val().charAt(0));
            ...
            if ($('#<%=SrtTyp.ClientID%>').val() == "") {
                errormessage("Please enter Sort Type.");
                return false;
            }
            document.getElementById("<%=HiddenGradeUnderID.ClientID%>").value = $('#<%=ddlgrade.ClientID%>').val();
        }
    </script>
    <script type="text/javascript">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-default">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        <input id="DesId" hidden="hidden" />
                                        <label for="exampleInputEmail1">Designation Name:</label>&nbsp;&nbsp;<label for="requiredFields" style="color: red;">*</label>
                                        <asp:TextBox class="form-control" MaxLength="100" ID="DesName" placeholder="Enter Designation Name" runat="server" TabIndex="2"></asp:TextBox>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddlgrade" Width="100%" CssClass="form-control" runat="server" TabIndex="4"></asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Sync Id:</label>
                                        <input runat="server" type="text" class="form-control" maxlength="50" id="SyncId" placeholder="Enter Sync Id" tabindex="6">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group " runat="server">
                                        ...
                                        <asp:DropDownList ID="ddltype" Width="100%" CssClass="form-control" runat="server" >
                                            ...
                                            <asp:ListItem Text="BACK OFFICE"></asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Sort Type:</label>&nbsp;&nbsp;<label for="requiredFields" style="color: red;">*</label>
                                        <input runat="server" type="text" class="form-control" maxlength="1" id="SrtTyp" placeholder="Enter Sort Type" onkeypress="return onlyNumberKey(event)" autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="row">
                                        <div class="col-md-8 col-xs-12">
                                            ...
                                            <div class="form-group top-form">
                                                <label for="exampleInputEmail1">Eligible for Conveyance:</label>
                                                <input id="chkElgbleForConv" runat="server" type="checkbox" class="checkbox" />
                                            </div>
                                        </div>
                        ...
                        <div class="box-footer">
                            <asp:HiddenField ID="HiddenGradeUnderID" runat="server" />
                    ...
                    <div class="box">
                        ...
                        <div class="box-body table-responsive">
                            <asp:Repeater ID="rpt" runat="server">
                                ...
                                <ItemTemplate>
                                     <tr onclick="DoNav('<%#Eval("DesId") %>');">
                                        <asp:HiddenField ID="HiddenField1" runat="server" Value='<%#Eval("DesId") %>' />
                                        <td><%#Eval("DesName") %></td>
                                        <td><%#Eval("Grade") %></td>
                                        <td><%#Eval("SyncId") %></td>
                                        <td><%#Eval("EligibleforConveyance") %></td>
                                        <td><%#Eval("Active") %></td>
                                        <td><%#Eval("DesType") %></td>
                                        <td><%#Eval("SortType") %></td>
                                    </tr>
