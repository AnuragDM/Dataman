<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="EditMeetPlan.aspx.cs" Inherits="AstralFFMS.EditMeetPlan" %>
                        ...
                        <div id="InputWork">
                            ...
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Edit Meet Plan Entry</h3>
                                ...
                                <!-- form start -->
                                <div class="box-body">
                                    <div class="col-lg-9 col-md-11 col-sm-10 col-xs-10">
                                        ...
                                        <div class="form-group col-md-3 paddingleft0 paddingright0">
                                            ...
                                            <asp:TextBox ID="txtMeetDate" runat="server" CssClass="form-control" Enabled="false" ReadOnly="true" Style="background-color: white;"></asp:TextBox>
                                        ...
                                        <div class="form-group col-md-4 paddingright0">
                                            ...
                                            <asp:DropDownList ID="ddlmeetType" Enabled="false" runat="server" CssClass="form-control"></asp:DropDownList>
                                        </div>
                                    ...
                                    <asp:HiddenField ID="hfCustomerId" runat="server" />
                                        ...
                                        <div class="form-group col-md-3 paddingleft0 paddingright0">
                                            ...
                                            <asp:TextBox ID="txtNoOfUsers" onkeypress="return IsNumeric(event);" runat="server" MaxLength="5" placeholder="Enter the No of Users" CssClass="form-control numeric text-right"></asp:TextBox>
                                        </div>
                                        <div class="form-group col-md-3 paddingright0">
                                            <label for="exampleInputEmail1">No Of Staff:</label>
                                            <asp:TextBox ID="txtNoofStaf" onkeypress="return IsNumeric(event);" runat="server" MaxLength="5" CssClass="form-control numeric text-right"></asp:TextBox>
                                        </div>
                                        <div class="form-group col-md-3 paddingright0">
                                 ...
                                 <asp:TextBox ID="txtvalueforretailer"  runat="server" MaxLength="12"  CssClass="form-control numeric"></asp:TextBox>
                                        ...
                                        <div class="form-group col-md-3 paddingleft0 paddingright0" style="padding-left:18px;">
                                            ...
                                            <ajaxToolkit:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" CompletionListCssClass="completionList"
                                                ...
                                                DelimiterCharacters="" ServiceMethod="SearchDist" ServicePath="~/EditMeetPlan.aspx" MinimumPrefixLength="3" EnableCaching="true"
                                ...
                                <label for="exampleInputEmail1"></label>
                                 <asp:TextBox ID="TextBox2" Visible="false" runat="server" MaxLength="5"    CssClass="form-control numeric"></asp:TextBox>
                                    ...
                                    <div class="box-footer">
                                        <asp:Button ID="btnsave" CssClass="btn btn-primary" OnClientClick="return Validation();" runat="server" Text="Update" OnClick="btnsave_Click" />
                                        <asp:Button ID="Cancel" CssClass="btn btn-primary" runat="server" Text="Cancel" OnClick="Cancel_Click" />
                                        <asp:Button ID="btndelete" CssClass="btn btn-primary" runat="server" Text="Delete" OnClick="btndelete_Click" OnClientClick="Confirm()" />
                                        <asp:Button ID="btnMeetprdct" CssClass="btn btn-primary" runat="server" Text="Meet Product" OnClick="btnMeetprdct_Click" />
                                    </div>
                                    <br />
                                    <div>
