...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <%--  <a href="RptDSRPartyWiseAnalysis.aspx">RptDSRPartyWiseAnalysis.aspx</a>--%>
    ...
    <style type="text/css">
        ...
        #ContentPlaceHolder1_trview input[type=checkbox]{
            margin: 0px 0px 0;
        }
   ...
   <script type="text/javascript">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box-body">
                            <div class="col-md-12">
                                ...
                                <div class="row">                               
                                     <div id="divtrview" class="col-md-3 col-sm-3 col-xs-12" runat="server">
                                        <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        //            $(api.column(13).footer()).html(searchTotal);
