<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="UploadEmployee.aspx.cs" Inherits="AstralFFMS.UploadEmployee" %>
                ...
                <div id="InputWork">
                    ...
                    <div class="box box-primary">
                      ...
                      <div style="float:right">
                        <asp:HyperLink ID="hpl" runat="server" Text="Download Sample" NavigateUrl="~/SampleImportSheets/Employee.csv" ></asp:HyperLink>
