<%@ Page Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="PartyMonthWComAchiv.aspx.cs" Inherits="AstralFFMS.PartyMonthWComAchiv" %>
                    ...
                    <div class="col-md-12">
                        <div id="InputWork">
                            ...
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Retailer Wise/Month Wise Comparative Acheivment</h3>
                                </div>
                                <!-- /.box-header -->
                                <!-- form start -->
                                <div class="box-body">
                        ...
                        <div id="rptmain" runat="server">
                            <div class="box-header table-responsive">
                                <asp:Repeater ID="TopRetailer" runat="server">          <%-- distitemsalerpt--%>
                                    <HeaderTemplate>
                                        <table id="itemsaleTable" class="table table-bordered table-striped">
                                            <thead>
                                                <tr>   
                                                    ...
                                                    <th>Mobile</th>
                                                    <th style="text-align: right">Total Sale till Today</th>
                                    ...
                                    <ItemTemplate>
                                             ...
                                             <tr>
                                                <td><%#(((RepeaterItem)Container).ItemIndex+1).ToString()%>
                                                    <asp:Label ID="lblSno" runat="server" Visible="false" Text='<%# (((RepeaterItem)Container).ItemIndex+1).ToString()%>'></asp:Label></td> 
                                                <td><%# Eval("PartyName")%>
                                                ...
                                                <td><%# Eval("ConPer")%>
                                                      <asp:Label ID="lblConPer" runat="server" Visible="false" Text='<%# Eval("ConPer")%>'></asp:Label></td> 
                                                <td><%# Eval("Mobile")%>
                                                     <asp:Label ID="lblMobile" runat="server" Visible="false" Text='<%# Eval("Mobile")%>'></asp:Label></td>                                         
                                                <td style="text-align: right"><%# Eval("Pendency","{0:F2}")%>
                                                      <asp:Label ID="lblPendency" runat="server" Visible="false" Text='<%# Eval("Pendency","{0:F2}")%>'></asp:Label></td> 
                                                <td style="text-align: right"><%# Eval("PrevMonth","{0:F2}")%>
                                                      <asp:Label ID="lblPrevMonth" runat="server" Visible="false" Text='<%# Eval("PrevMonth","{0:F2}")%>'></asp:Label></td> 
                                                <td style="text-align: right"><%# Eval("CurrentMnth","{0:F2}")%>
                                                      <asp:Label ID="lblCurrentMnth" runat="server" Visible="false" Text='<%# Eval("CurrentMnth","{0:F2}")%>'></asp:Label></td> 
                                                  <td><%# Eval("SalePerson")%>
                                                      <asp:Label ID="lblSalePerson" runat="server" Visible="false" Text='<%# Eval("SalePerson")%>'></asp:Label></td>
         ...
         $(function () {
             $('#itemsaleTable').dataTable({
                 ...
                 "footerCallback": function (tfoot, data, start, end, display) {
                     ...
                     debugger;
                     var costColumnIndex = $('th').filter(function (i) { return $(this).text() == 'Total Sale till Today'; }).first().index();
                     ...
                     var costColumnIndex1 = $('th').filter(function (i) { return $(this).text() == 'Avg Monthly Sale In last 3 Months'; }).first().index();
                     ...
                     var costColumnIndex2 = $('th').filter(function (i) { return $(this).text() == 'Current Month sale'; }).first().index();
