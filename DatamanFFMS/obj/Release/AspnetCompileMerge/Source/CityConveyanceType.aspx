<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="CityConveyanceType.aspx.cs" Inherits="AstralFFMS.CityConveyanceType" EnableEventValidation="false" %>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        function validate() {
            if ($('#<%=CityConveyanceTypeName.ClientID%>').val() == "") {
                errormessage("Please enter Conveyance City Type.");
                return false;
            }

            var value = ($('#<%=CityConveyanceTypeName.ClientID%>').val().charAt(0));
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var valLength = "";
            $('#<%=CityConveyanceTypeName.ClientID%>').keypress(function (key) {

                valLength = ($('#<%=CityConveyanceTypeName.ClientID%>').val().length + 1);
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-default">
                        <div class="box-header">
                            <h3 class="box-title">City Conveyance Type Master</h3>
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-lg-5 col-md-6 col-sm-8 col-xs-10">
                                <div class="form-group">
                                    ...
                                    <input runat="server" type="text" class="form-control" maxlength="100" id="CityConveyanceTypeName" placeholder="Enter City Conveyance Type Name">
                                </div>
                            </div></div>
                        </div>
        ...
        <div class="box-body" id="rptmain" runat="server" style="display: none;">
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">City Conveyance Type List</h3>
                            <div style="float: right">
                            ...
                            <asp:Repeater ID="rpt" runat="server">
                                <HeaderTemplate>
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th>City Conveyance Type Name</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                </HeaderTemplate>
