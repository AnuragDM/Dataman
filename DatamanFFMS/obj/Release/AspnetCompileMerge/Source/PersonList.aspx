<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.master" AutoEventWireup="true" Inherits="PersonList" Codebehind="PersonList.aspx.cs" %>
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <label for="Group Name" >Group Name :</label>
                                 <asp:DropDownList ID="ddlgrpname" runat="server" Width="100%" AutoPostBack="true" OnSelectedIndexChanged="ddlgrpname_SelectedIndexChanged" CssClass="form-control"></asp:DropDownList>
                  
                                 </div>
                             <div class="form-group col-md-5">
                                  
                                   <label for="Group Name" >Person Name :</label>
                    <asp:DropDownList ID="DropDownList2" CssClass="textbox form-control"  
                        Width="100%" runat="server" ></asp:DropDownList>
                                 </div>
                                  <div class="col-md-2" style="margin-top:20px;">
                                 <asp:Button ID="btnfill" runat="server" Text="Fill" CssClass="btn btn-primary" 
                            CausesValidation="false" onclick="btnfill_Click" />
                                   </div>
                                      </div>
                       </div>
                             <div class="clearfix"></div>
                        ...
                        <div class="box-body table-responsive">
                         ...
                         PageSize="15"   Width="100%" DataKeyNames="ID" OnSelectedIndexChanged="gvData_SelectedIndexChanged">
                                  ...
                                  <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="120px" HeaderText="Action">
                                    <ItemTemplate>
                                      <asp:LinkButton  CommandName="select" ID="LinkButton2" CausesValidation="false" runat="server" CssClass="btn btn-success"
                                       ...
                                       <asp:LinkButton  CommandName="delete" ID="LinkButton1" CausesValidation="false" runat="server" OnClientClick="return ConfirmOnDelete('');" CssClass="btn btn-danger"
                                            Text="Delete" ><i class="fa fa-close"></i></asp:LinkButton>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Center" Width="120px"></ItemStyle>
                                </asp:TemplateField>
                                 <asp:BoundField DataField="PersonName" HeaderText="Name" />
                                <asp:BoundField DataField="DeviceNo" HeaderText="Device No" />
