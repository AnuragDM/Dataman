    ...
    <script type="text/javascript">
        function validate() {
            if ($('#<%=FVName.ClientID%>').val() == "") {
                errormessage("Please enter Failed Visit Remark.");
                return false;
            }
                            ...
                            <div class="row">
                                <div class="col-lg-5 col-md-6 col-sm-8 col-xs-10">
                                    <div class="form-group">
                                        ...
                                        <label for="exampleInputEmail1">Failed Visit Remark:</label>&nbsp;&nbsp;<label for="requiredFields" style="color: red;">*</label>
                                        <asp:TextBox class="form-control" MaxLength="100" ID="FVName" placeholder="Enter Failed Visit Remark" runat="server"></asp:TextBox>
        ...
        <div class="box-body" id="rptmain" runat="server" style="display: none;">
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Failed Visit Remark List</h3>
                            <div style="float: right">
