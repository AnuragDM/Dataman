<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="LeaveForL3.aspx.cs" Inherits="AstralFFMS.LeaveForL3" %>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body table-responsive">
                            <asp:Repeater ID="rpt" runat="server">
                                ...
                                <ItemTemplate>
                                      <tr onclick="DoNav('<%#"LeaveRequest.aspx?SMId="+Eval("SMId")+"&LVRQId="+Eval("LVRQId")+"&LeaveCase=AC"%>');">                                   
