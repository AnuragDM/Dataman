<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="MeetTargetEntryHO.aspx.cs" Inherits="AstralFFMS.MeetTargetEntry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <style>
        ...
        #ContentPlaceHolder1_GridView2 table tbody tr:last-child {
                ...
                <div id="InputWork">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Meet Target Entry For HO</h3>
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <div class="box-body col-lg-3 col-md-4 col-sm-4 col-xs-7">
                        ...
                        <div class="col-md-12">
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" HeaderStyle-BackColor="#3c8dbc" Width="100%" HeaderStyle-ForeColor="White" OnRowDataBound="GridView1_RowDataBound" OnRowCommand="GridView1_RowCommand">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Planned by Area Incharge">
                                                <ItemTemplate>
                                                    <%--  <asp:Label ID="lblArea" runat="server" Text='<%#Eval("Name") %>'></asp:Label>--%>
                                                    <asp:LinkButton ID="lnkArea" runat="server" CommandName="Area" CommandArgument='<%#Eval("Id")%>'></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <%--     <asp:TemplateField HeaderText="Planned by Level 1">
                                               <ItemTemplate>
                            ...
                            <div class="form-group">
                                <div class="table table-responsive">
                                    ...
                                    <asp:Label ID="lblPartTypeID" Visible="false" runat="server" CssClass="form-control text-bold">  </asp:Label>
                                    ...
                                    <asp:GridView ID="GridView2" runat="server" ShowFooter="true" AutoGenerateColumns="false" HeaderStyle-BackColor="#3c8dbc" Width="100%" HeaderStyle-ForeColor="White" OnRowDataBound="GridView2_RowDataBound">
                                        <Columns>
                                            <asp:TemplateField HeaderText="Team">
                                                ...
                                                <FooterTemplate>
                                                    <asp:Label ID="lbltotal" Text="Total" Style="color: #000;" runat="server" CssClass="form-control text-bold"></asp:Label>
                                                </FooterTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Target of Meet">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Apr">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtapr" runat="server" Width="80px" onblur="Cal(this);" CssClass="form-control numeric text-right" onkeypress="return isNumber(event)" MaxLength="8"> </asp:TextBox>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:TextBox ID="txtapr1" runat="server" Width="80px" onblur="Cal(this);" ReadOnly="true" CssClass="form-control numeric text-right" onkeypress="return isNumber(event)" MaxLength="12"> </asp:TextBox>
                                                </FooterTemplate>

                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="May">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtmay" runat="server" Width="80px" onblur="Cal(this);" CssClass="form-control numeric text-right" onkeypress="return isNumber(event)" MaxLength="8"> </asp:TextBox>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:TextBox ID="txtmay1" runat="server" Width="80px" onblur="Cal(this);" ReadOnly="true" CssClass="form-control numeric text-right" onkeypress="return isNumber(event)" MaxLength="12"> </asp:TextBox>
                                                </FooterTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Jun">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtjun" runat="server" Width="80px" onblur="Cal(this);" CssClass="form-control numeric text-right" onkeypress="return isNumber(event)" MaxLength="8"> </asp:TextBox>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Jul">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtjul" runat="server" Width="80px" onblur="Cal(this);" CssClass="form-control numeric text-right" onkeypress="return isNumber(event)" MaxLength="8"> </asp:TextBox>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:TextBox ID="txtjul1" runat="server" Width="80px" onblur="Cal(this);" ReadOnly="true" CssClass="form-control numeric text-right" onkeypress="return isNumber(event)" MaxLength="12"> </asp:TextBox>
                                                </FooterTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Aug">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtaug" runat="server" Width="80px" onblur="Cal(this);" CssClass="form-control numeric text-right" onkeypress="return isNumber(event)" MaxLength="8"> </asp:TextBox>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:TextBox ID="txtaug1" runat="server" Width="80px" onblur="Cal(this);" ReadOnly="true" CssClass="form-control numeric text-right" onkeypress="return isNumber(event)" MaxLength="12"> </asp:TextBox>
                                                </FooterTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Sept">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtspt" runat="server" Width="80px" onblur="Cal(this);" onkeypress="return isNumber(event)" MaxLength="8" CssClass="form-control numeric text-right"> </asp:TextBox>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:TextBox ID="txtspt1" runat="server" Width="80px" onblur="Cal(this);" ReadOnly="true" CssClass="form-control numeric text-right" onkeypress="return isNumber(event)" MaxLength="12"> </asp:TextBox>
                                                </FooterTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Oct">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtoct" runat="server" Width="80px" onblur="Cal(this);" onkeypress="return isNumber(event)" MaxLength="8" CssClass="form-control numeric text-right"> </asp:TextBox>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:TextBox ID="txtoct1" runat="server" Width="80px" onblur="Cal(this);" ReadOnly="true" CssClass="form-control numeric text-right" onkeypress="return isNumber(event)" MaxLength="12"> </asp:TextBox>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Nov">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtNov" runat="server" Width="80px" onblur="Cal(this);" onkeypress="return isNumber(event)" MaxLength="8" CssClass="form-control numeric text-right"> </asp:TextBox>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:TextBox ID="txtNov1" runat="server" Width="80px" onblur="Cal(this);" ReadOnly="true" CssClass="form-control numeric text-right" onkeypress="return isNumber(event)" MaxLength="12"> </asp:TextBox>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Dec">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtDec" runat="server" Width="80px" onblur="Cal(this);" onkeypress="return isNumber(event)" MaxLength="8" CssClass="form-control numeric text-right"> </asp:TextBox>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:TextBox ID="txtDec1" runat="server" Width="80px" onblur="Cal(this);" ReadOnly="true" CssClass="form-control numeric text-right" onkeypress="return isNumber(event)" MaxLength="12"> </asp:TextBox>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Jan">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtJan" runat="server" onblur="Cal(this);" Width="80px" onkeypress="return isNumber(event)" MaxLength="8" CssClass="form-control numeric text-right"> </asp:TextBox>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:TextBox ID="txtJan1" runat="server" onblur="Cal(this);" Width="80px" ReadOnly="true" CssClass="form-control numeric text-right" onkeypress="return isNumber(event)" MaxLength="12"> </asp:TextBox>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Feb">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtFeb" runat="server" onblur="Cal(this);" Width="80px" onkeypress="return isNumber(event)" MaxLength="8" CssClass="form-control numeric text-right"> </asp:TextBox>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:TextBox ID="txtFeb1" runat="server" onblur="Cal(this);" Width="80px" ReadOnly="true" CssClass="form-control numeric text-right" onkeypress="return isNumber(event)" MaxLength="12"> </asp:TextBox>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Mar">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtMarch" onblur="Cal(this);" onkeypress="return isNumber(event)" Width="80px" MaxLength="8" runat="server" CssClass="form-control numeric text-right"> </asp:TextBox>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:TextBox ID="txtMarch1" onblur="Cal(this);" ReadOnly="true" Width="80px" onkeypress="return isNumber(event)" MaxLength="12" runat="server" CssClass="form-control numeric text-right"> </asp:TextBox>
                                                </FooterTemplate>
                                            </asp:TemplateField>
