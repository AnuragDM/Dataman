<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="CRMLeadMaster.aspx.cs" Inherits="AstralFFMS.CRMLeadMaster" %>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        function validate() {
            if ($('#<%=Lead.ClientID%>').val() == "") {
                errormessage("Please enter Lead Name");
                return false;
            }

            var value = ($('#<%=Lead.ClientID%>').val().charAt(0));
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var valLength = "";
            $('#<%=Lead.ClientID%>').keypress(function (key) {

                valLength = ($('#<%=Lead.ClientID%>').val().length + 1);
    ...
    <script type="text/javascript">
        function DoNav(Lead_Id) {
          
            if (Lead_Id != "") {
                document.getElementById("ContentPlaceHolder1_mainDiv").style.display = 'block';
                document.getElementById("ContentPlaceHolder1_rptmain").style.display = 'none';
                $('#spinner').show();
                __doPostBack('', Lead_Id)
            }
        }
    </script>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-default">
                        <div class="box-header">
                            <h3 class="box-title">Lead Master</h3>
                            ...
                            <div class="row">
                                <div class="col-lg-5 col-md-4 col-sm-4">
                                    <div class="form-group">
                                        <input id="TagId" hidden="hidden" />
                                        <label for="exampleInputEmail1">Lead:</label>&nbsp;&nbsp;<label for="requiredFields" style="color: red;">*</label>
                                        <input type="text" runat="server" class="form-control" maxlength="50" id="Lead" placeholder="Enter Lead Name" tabindex="2">
                                    </div>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body table-responsive">
                            <asp:Repeater ID="rpt" runat="server">
                                ...
                                <ItemTemplate>
                                    <tr onclick="DoNav('<%#Eval("Lead_Id") %>');">
                                        <asp:HiddenField ID="HiddenField1" runat="server" Value='<%#Eval("Lead_Id") %>' />
                                        <td><%#Eval("Lead") %></td>
                                    </tr>
                                </ItemTemplate>
                                <FooterTemplate>
