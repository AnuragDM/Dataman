<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="DSRPendingList.aspx.cs" Inherits="AstralFFMS.DSRPendingList" %>
    ...
    <script>
        ...
        function DoNav(SMId,role,date) {
            if (SMId != "") {
                ...
                if (role == "L1")
                {
                    window.open("NewRptDailyWorkingApprovalL1.aspx?Date=" + date + "&SMId=" + SMId + "");
                }
                else if (role == "L2")
                {
                    window.open("NewRptDailyWorkingApprovalL2.aspx?Date=" + date + "&SMId=" + SMId + "");
                }
                else if (role == "L3")
                {
                    window.open("NewRptDailyWorkingApprovalL3.aspx?Date=" + date + "&SMId=" + SMId + "");
                }
                ...
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <div class="box-body table-responsive">
                            <asp:Repeater ID="rptDsrlist" runat="server">
                                <HeaderTemplate>
                                ...
                                <ItemTemplate>
                                    <tr onclick="DoNav('<%#Eval("SMId") %>','<%#Eval("rolename") %>','<%#Eval("vdate") %>');">
                                        ...
                                        <td><%#Eval("rolename") %>
                                         <asp:Label ID="lblrolename" runat="server" Visible="false" Text='<%# Eval("smname")%>'></asp:Label></td>
                                        <td><%#String.Format("{0:dd/MMM/yyyy}",Eval("vdate") )%>
                                         <asp:Label ID="lblvdate" runat="server" Visible="false" Text='<%#String.Format("{0:dd/MMM/yyyy}",Eval("vdate") )%>'></asp:Label></td>
