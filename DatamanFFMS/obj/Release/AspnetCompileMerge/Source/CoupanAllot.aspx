<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="CoupanAllot.aspx.cs" Inherits="AstralFFMS.CoupanAllot" %>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-default">
                        <div class="box-header">
                            <h3 class="box-title">Coupon Issue To Distributor</h3>                           
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <div class="box-body">
                            <div class="col-lg-5 col-md-7 col-sm-7 col-xs-9">                               
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="ddlPrefix" runat="server" Width="100%" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlPrefix_SelectedIndexChanged"></asp:DropDownList>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group" hidden="hidden">
                                    <label for="exampleInputEmail1">Issue Coupon (Individual):</label>
                                      <asp:TextBox ID="txtIndividual"  CssClass="form-control numeric text-right" runat="server" OnTextChanged="txtIndividual_TextChanged" AutoPostBack="true"></asp:TextBox>
                                </div>
                                <div class="form-group">                               
                                     <asp:TextBox ID="TextBox1"  CssClass="form-control numeric text-right" runat="server" Visible="false" placeholder="Enter Coupon No."></asp:TextBox>
                                </div>
                                <div class="form-group">                                 
                                     <asp:TextBox ID="TextBox2"  CssClass="form-control numeric text-right" runat="server" Visible="false" placeholder="Enter Coupon No."></asp:TextBox>
                                </div>
                                <div class="form-group">                                
                                     <asp:TextBox ID="TextBox3"  CssClass="form-control numeric text-right" runat="server" Visible="false" placeholder="Enter Coupon No."></asp:TextBox>
                                </div>
                                <div class="form-group">                                 
                                     <asp:TextBox ID="TextBox4"  CssClass="form-control numeric text-right" runat="server" Visible="false" placeholder="Enter Coupon No."></asp:TextBox>
                                </div>
                                <div class="form-group">                                
                                     <asp:TextBox ID="TextBox5"  CssClass="form-control numeric text-right" runat="server" Visible="false" placeholder="Enter Coupon No."></asp:TextBox>
                                </div>
                                <div class="form-group">                                
                                     <asp:TextBox ID="TextBox6"  CssClass="form-control numeric text-right" runat="server" Visible="false" placeholder="Enter Coupon No."></asp:TextBox>
                                </div>
                                <div class="form-group">                                
                                     <asp:TextBox ID="TextBox7"  CssClass="form-control numeric text-right" runat="server" Visible="false" placeholder="Enter Coupon No."></asp:TextBox>
                                </div>
                                <div class="form-group">                              
                                     <asp:TextBox ID="TextBox8"  CssClass="form-control numeric text-right" runat="server" Visible="false" placeholder="Enter Coupon No."></asp:TextBox>
                                </div>
                                <div class="form-group">                                 
                                     <asp:TextBox ID="TextBox9"  CssClass="form-control numeric text-right" runat="server" Visible="false" placeholder="Enter Coupon No."></asp:TextBox>
                                </div>
                                <div class="form-group">                                
                                     <asp:TextBox ID="TextBox10"  CssClass="form-control numeric text-right" runat="server" Visible="false" placeholder="Enter Coupon No."></asp:TextBox>
                                </div>                                             
