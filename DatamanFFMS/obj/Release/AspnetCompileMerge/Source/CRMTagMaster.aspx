<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="CRMTagMaster.aspx.cs" Inherits="AstralFFMS.CRMTagMaster" %>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        function validate() {
            if ($('#<%=Tag.ClientID%>').val() == "") {
                errormessage("Please enter Tag Name");
                return false;
            }

            var value = ($('#<%=Tag.ClientID%>').val().charAt(0));
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var valLength = "";
            $('#<%=Tag.ClientID%>').keypress(function (key) {
                valLength = ($('#<%=Tag.ClientID%>').val().length + 1);
                if (valLength < 2) {
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-default">
                        <div class="box-header">
                            <h3 class="box-title">Tag Master</h3>
                            ...
                            <div class="row">
                                <div class="col-lg-5 col-md-6 col-sm-8 col-xs-10">
                                    <div class="form-group">
                                        ...
                                        <label for="exampleInputEmail1">Tag:</label>&nbsp;&nbsp;<label for="requiredFields" style="color: red;">*</label>
                                        <input type="text" runat="server" class="form-control" maxlength="50" id="Tag" placeholder="Enter Tag Name" tabindex="2">
                                    </div>
                                    <div class="form-group">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body table-responsive">
                            <asp:Repeater ID="rpt" runat="server">
                                ...
                                <ItemTemplate>
                                    <tr onclick="DoNav('<%#Eval("Tag_Id") %>');">
                                        <asp:HiddenField ID="HiddenField1" runat="server" Value='<%#Eval("Tag_Id") %>' />
                                        <td><%#Eval("Tag") %></td>
