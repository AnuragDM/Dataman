<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="Region.aspx.cs" Inherits="AstralFFMS.Region" EnableEventValidation="false" %>
   ...
   <%-- <script src="<%=ResolveUrl("~")%>plugins/select2/select2.js"></script>
             ...
             $('#<%=ddlParentLoc.ClientID %>').empty().append('<option selected="selected" value="0">Loading...</option>');
               ...
               function PopulateControl(list, control) {
                      if (list.length > 0) {
                          ...
                          var id = $('#<%=HiddenConUnderID.ClientID%>').val();
                          //  alert(id);
                          if (id != "") {
                              control.val(id);
                          }
    ...
    <script type="text/javascript">
        function validate() {
            ...
            document.getElementById("<%=HiddenConUnderID.ClientID%>").value = $('#<%=ddlParentLoc.ClientID%>').val();
        }
    </script>
    <script type="text/javascript">
        $(document).ready(function () {
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-default">
                        <div class="box-header">
                            <h3 class="box-title">Region Master</h3>
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-lg-5 col-md-6 col-sm-8 col-xs-10">
                                ...
                                <input type="text" runat="server" class="form-control" maxlength="100" id="Location" placeholder="Enter Region Name" tabindex="2">
                            </div>
                                   <div class="form-group">
                           ...
                           <asp:DropDownList ID="ddlParentLoc" runat="server" Width="100%"  CssClass="form-control" TabIndex="3"></asp:DropDownList>
                            ...
                            <div class="form-group">
                                ...
                                <input id="chkIsActive" runat="server" type="checkbox" checked="checked" class="checkbox" tabindex="6" />
                            ...
                            <asp:Repeater ID="rpt" runat="server">
                                ...
                                <ItemTemplate>
                                    <tr onclick="DoNav('<%#Eval("AreaId") %>');">
                                        ...
                                        <td id="AreaName"><%#Eval("AreaName") %></td>
                                        <td id="Parent"><%#Eval("Parent") %></td>
                                        <td id="SyncId"> <%#Eval("SyncId") %></td>
                                        <td id="Active1"><%#Eval("Active1") %></td>
                                    </tr>
                                </ItemTemplate>
                                <FooterTemplate>
                                    </tbody>     </table>       
