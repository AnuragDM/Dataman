<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="ASMWiseSale.aspx.cs" Inherits="AstralFFMS.ASMWiseSale" %>
                        ...
                        <div id="InputWork">
                            ...
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title">ASM Wise Secondary Sale</h3>
                                </div>
                                <!-- /.box-header -->
                                <!-- form start -->
                                <div class="box-body">
                            ...
                            <div class="box-header table-responsive">
                                <asp:Repeater ID="Topsaleproduct" runat="server" OnItemCommand="Topsaleproduct_ItemCommand">     
                                    ...
                                    <ItemTemplate>
                                            ...
                                            <td><%# Eval("smname")%>
                                            <asp:Label ID="lblProductGroup" runat="server" Visible="false" Text='<%# Eval("smname")%>'></asp:Label></td>
                                           <%-- <td><%# Eval("Product")%>
