<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="CreateNewPurchaseOrder.aspx.cs" EnableEventValidation="false" Inherits="AstralFFMS.CreateNewPurchaseOrder" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function RdbN() {
            $('#<%=ProjectDiv.ClientID%>').hide();
        }
        function RdbP() {
            $('#<%=ProjectDiv.ClientID%>').show();
        }

        function AddTransporter(val) {

            if (val == "Other") { $('#<%= TP.ClientID %>').show(); }
            else { $('#<%= TP.ClientID %>').hide(); }
        }
    </script>
                ...
                <div class="box box-primary primarybox-ul">
                   ...
                   <%-- <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="row">
                                                <div class="col-md-12 distributor-ul">
                                                    ...
                                                    <ajaxToolkit:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" CompletionListCssClass="completionList"
                                                        OnClientItemSelected="ClientItemSelected" EnableCaching="true" ServicePath="CreateNewPurchaseOrder.aspx"
                                        ...
                                        <asp:GridView ID="gvDetails" ShowFooter="True" runat="server" class="table table-bordered table-striped" AutoGenerateColumns="False">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtItem" runat="server" Width="328px" Text='<%#Eval("ItemName") %>' class="form-control distributor-ul" AutoPostBack="true" OnTextChanged="txtItem_TextChanged" TabIndex="2"></asp:TextBox>
                                                ...
                                                <asp:TemplateField HeaderText="Remark">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtRemarks" TabIndex="4" runat="server" Width="280px" MaxLength="255" class="form-control" Text='<%#Eval("Remarks") %>'></asp:TextBox>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <asp:RadioButtonList ID="ProjectType" runat="server" RepeatDirection="Horizontal" CssClass="radiogroup">
                                            <asp:ListItem Selected="True" Value="N" onClick="RdbN();">Normal</asp:ListItem>
                                            <asp:ListItem Value="P" onClick="RdbP();">Project</asp:ListItem>
                                        </asp:RadioButtonList>
                                        <br />
                                        <div id="ProjectDiv" runat="server" style="display: none;">
                                        ...
                                        <label for="exampleInputEmail1">Transporter:</label><%--&nbsp;&nbsp;<label for="requiredFields" style="color: red;">*</label>--%><asp:DropDownList ID="ddlTransporter" Width="100%" TabIndex="7" CssClass="form-control select2" runat="server" onChange="AddTransporter(this.value);"></asp:DropDownList>
                                        <div id="TP" style="display: none;" runat="server">
                                        ...
                                        <asp:DropDownList ID="ddlScheme" runat="server" Width="100%" CssClass="form-control select2"></asp:DropDownList>
                                        <br />
                                        <label for="exampleInputEmail1">Remark:</label>
                                        <asp:TextBox ID="Remarks" TabIndex="8" Width="100%" runat="server" class="form-control" TextMode="MultiLine" placeholder="Enter Remark" Height="180px"></asp:TextBox>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label>Address Line 1:</label>&nbsp;&nbsp;<label for="requiredFields" style="color: red;">*</label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <asp:DropDownList ID="ddlCity" Width="100%" CssClass="form-control select2" runat="server" TabIndex="14" AutoPostBack="True" OnSelectedIndexChanged="ddlCity_SelectedIndexChanged"></asp:DropDownList>
                                            </div>
                                            <div class="col-md-6">
                                                <label>Pincode:</label>&nbsp;
                    ...
                    <div class="box-footer">
                        ...
                        <div class="col-md-3">
                            <div style="float: right;">
                                <asp:Button Style="margin-right: 5px;" Visible="false" type="button" ID="CancelOrder" runat="server" Text="Cancel Order" class="btn btn-primary" OnClick="CancelOrder_Click" />
                            </div>
                        </div>
                        <br />
                        <br />
                            ...
                            <div class="col-md-12">
                                <div class="col-md-12 paddingleft0">
                                    <div id="DIV1" class="form-group col-md-2">
                                        ...
                                        <asp:TextBox ID="txtmDate" runat="server" CssClass="form-control" BackColor="White" ReadOnly="true"></asp:TextBox>
                                    ...
                                    <div class="form-group col-md-2 ">
                                        ...
                                        <asp:TextBox ID="txttodate" runat="server" CssClass="form-control" BackColor="White" ReadOnly="true"></asp:TextBox>
                                    ...
                                    <div class="form-group col-md-3 ">
                                        ...
                                        <asp:DropDownList ID="ddlStatus" runat="server" Width="100%" CssClass="form-control select2">
