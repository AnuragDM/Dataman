<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="RptDailyWorkingApprovalL1.aspx.cs" Inherits="AstralFFMS.RptDailyWorkingApprovalL1" %>
                          ...
                          Save: function () {
                              ...
                              $.ajax({
                                  ...
                                  success: function (data) {
                                      ...
                                      window.location.href = 'RptDailyWorkingApprovalL1.aspx?hasval=' + setval + '&smIDStr=<%=ViewState["smIDStr"]%>&userid=<%=ViewState["UserId"]%>';
