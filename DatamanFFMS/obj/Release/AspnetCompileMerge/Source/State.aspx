<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="State.aspx.cs" Inherits="AstralFFMS.State" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        function validate() {
            ...
            document.getElementById("<%=HiddenUnderID.ClientID%>").value = $('#<%=ddlParentLoc.ClientID%>').val();
                    ...
                    <div class="box box-default">
                        ...
                        <div class="box-body">
                           ...
                           <div class="form-group">
                                ...
                                <input type="text" runat="server" class="form-control" maxlength="100" id="Location" placeholder="Enter State Name" tabindex="2">
                            </div>
                            <div class="form-group">
                           ...
                           <asp:DropDownList ID="ddlParentLoc" runat="server" width="100%" CssClass="form-control" TabIndex="3" ></asp:DropDownList>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" runat="server" class="form-control" maxlength="50" id="SyncId" placeholder="Enter Sync Id" tabindex="6">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Buisness Place:</label>
                           <asp:DropDownList ID="ddlBuisness" runat="server" width="100%" CssClass="form-control" TabIndex="7" ></asp:DropDownList>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Section:</label>
                           <asp:DropDownList ID="ddlSection" runat="server" width="100%" CssClass="form-control" TabIndex="8" ></asp:DropDownList>
                            </div>
                           <div class="form-group">
                                <label for="exampleInputEmail1">Cost Centre:</label>
                            <asp:TextBox ID="CostCentre1" runat="server" class="form-control" placeholder="Enter Cost Centre"></asp:TextBox>
                            <ajaxToolkit:FilteredTextBoxExtender ID="flt_TB_CostCentre" runat="server" FilterType="Numbers,Custom" ValidChars="." TargetControlID="CostCentre1" />
                            </div>

                            <div class="form-group">
                                <label for="exampleInputEmail1">Active:</label>
                                <input id="chkIsActive" runat="server" type="checkbox" checked="checked" class="checkbox" tabindex="9" />
