<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="MaterialGrp.aspx.cs" Inherits="AstralFFMS.MaterialGrp" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        function validate() {
            if ($('#<%=MaterialGroup.ClientID%>').val() == "") {
                errormessage("Please enter Material Group Name");
                return false;
            }

            var value = ($('#<%=MaterialGroup.ClientID%>').val().charAt(0));
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var valLength = "";
            $('#<%=MaterialGroup.ClientID%>').keypress(function (key) {

                valLength = ($('#<%=MaterialGroup.ClientID%>').val().length + 1);
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-default">
                        <div class="box-header">
                            <h3 class="box-title">Product Group </h3>
                            ...
                            <div class="row">
                                <div class="col-lg-5 col-md-6 col-sm-8 col-xs-10">
                                    <div class="form-group">
                                        ...
                                        <input type="text" runat="server" class="form-control" maxlength="50" id="MaterialGroup" placeholder="Enter Material Group" tabindex="2">
                                    </div>
                                    <div class="form-group" runat="server" visible="false">
                                        <label for="exampleInputEmail1">Item Code:</label>
                                        <input type="text" runat="server" class="form-control" maxlength="50" id="ItemCode" placeholder="Enter Item Code" tabindex="4">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="chkIsAdmin" runat="server" type="checkbox" checked="checked" class="checkbox" tabindex="6" />
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Product Group</th>
                                                <th style="text-align:left" hidden>Item Type</th>
                                                <th>Sync ID</th>
                                                <th>Active</th>
                                            </tr>
                                        </thead>
