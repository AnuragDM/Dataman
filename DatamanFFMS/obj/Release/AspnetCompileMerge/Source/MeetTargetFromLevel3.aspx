<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="MeetTargetFromLevel3.aspx.cs" Inherits="AstralFFMS.MeetTargetFromLevel3" %>
                ...
                <div id="InputWork">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Meet Target - All Level</h3>
                                    ...
                                    <div class="table table-responsive">
                                        ...
                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" HeaderStyle-BackColor="#3c8dbc" Width="100%" HeaderStyle-ForeColor="White" OnRowDataBound="GridView1_RowDataBound" OnRowCommand="GridView1_RowCommand">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Total Meet">
                                                    <ItemTemplate>
