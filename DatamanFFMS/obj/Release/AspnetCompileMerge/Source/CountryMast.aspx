<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="CountryMast.aspx.cs" Inherits="AstralFFMS.CountryMast" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        function validate() {
            ...
            if ($('#<%=ISDCode.ClientID%>').val() == "") {
                errormessage("Please enter ISD Code");
                return false;
            }
        }
    </script>
                            ...
                            <div class="row">
                                <div class="col-lg-5 col-md-6 col-sm-8 col-xs-10">
                                    <div class="form-group">
                                        ...
                                        <input type="text" runat="server" class="form-control" maxlength="100" id="Location" placeholder="Enter Country Name" tabindex="2">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">ISD Code:</label>&nbsp;&nbsp;<label for="requiredFields" style="color: red;">*</label>
                                        <input type="text" runat="server" class="form-control numeric text-right" maxlength="5" id="ISDCode" placeholder="Enter ISD Code" tabindex="4">
                                    </div>
                                    <div class="form-group">
