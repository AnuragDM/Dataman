<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="DashboardSecondary.aspx.cs" Inherits="AstralFFMS.DashboardSecondary" EnableEventValidation="false" %>
                            ...
                            <asp:Repeater ID="rptTotalOrder" runat="server">
                                ...
                                <ItemTemplate>
                                    <tr onclick="DoNav('<%#Eval("SMId") %>');">
                                        ...
                                        <td><%#Eval("TotalParty") %>
                                        <asp:Label ID="lbltotalparty" runat="server" Visible="false" Text='<%# Eval("TotalParty")%>'></asp:Label></td>
                                        <td><%#Eval("TotalOrder") %>
                                        <asp:Label ID="lbltotalorder" runat="server" Visible="false" Text='<%# Eval("TotalOrder")%>'></asp:Label></td>
