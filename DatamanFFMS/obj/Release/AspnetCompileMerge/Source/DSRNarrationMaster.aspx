                            ...
                            <div class="row">
                                <div class="col-lg-5 col-md-6 col-sm-8 col-xs-10">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox class="form-control" MaxLength="500" ID="Name" placeholder="Enter Dsr Name" runat="server"></asp:TextBox>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox class="form-control" MaxLength="5" onkeypress="javascript:return isNumber (event)" ID="SortOrder" placeholder="Enter Sort Order" runat="server"></asp:TextBox>
