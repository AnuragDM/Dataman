<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="UploadPriceList.aspx.cs" Inherits="FFMS.UploadPriceList" %>
                ...
                <div id="InputWork">
                    ...
                    <div class="box box-primary">
                      ...
                      <div style="float:right">
                        <asp:HyperLink ID="hpl" runat="server" Text="Download Sample" NavigateUrl="~/SampleImportSheets/Pricelist.csv" ></asp:HyperLink>
