<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="SalesTargetFormLevel2.aspx.cs" Inherits="AstralFFMS.SalesTargetFormLevel2" %>
                ...
                <div id="InputWork">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Sales Target Entry Form L-2</h3>
                        ...
                        <div class="box-body">
                            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-9">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Current Year:</label>&nbsp;&nbsp;<label for="requiredFields" style="color:red;">*</label>
                            ...
                            <div class="col-md-12">
                                   ...
                                   <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" HeaderStyle-BackColor="#3c8dbc" Width="100%" HeaderStyle-ForeColor="White" OnRowDataBound="GridView1_RowDataBound" OnRowCommand="GridView1_RowCommand" >
                                       <Columns>
                                           ...
                                           <asp:TemplateField HeaderText="Target from HO/Senior">
                                             ...
                                             <asp:TemplateField HeaderText="Assigned to L1" >
                                               <ItemTemplate>
                                             <asp:LinkButton ID="lnkTarget" CommandName="HO" runat="server" CommandArgument=<%#Eval("Id")%>></asp:LinkButton>
                                               </ItemTemplate>
                                           </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Planned By L1">
                                               <ItemTemplate>
                                                  <%-- <asp:LinkButton ID="lnkAssignedByLevel2" runat="server" CommandName="Level2" CommandArgument=<%#Eval("PartyTypeId")%> ></asp:LinkButton>--%>
                                               </ItemTemplate>
                                           </asp:TemplateField>
                               ...
                               <div class="form-group">
                                   <div class="table table-responsive">
                                <!--<label for="exampleInputEmail1"><asp:Label ID="lblPartTypeName" Visible="false"  runat="server" CssClass="form-control text-bold"></asp:Label>-->
                                           ...
                                           <asp:TemplateField HeaderText="Sept" >
                                            ...
                                            <asp:TemplateField HeaderText="Oct" >
                                             ...
                                             <asp:TemplateField HeaderText="Jan" >
                                               <ItemTemplate>
                                                   <asp:TextBox ID="txtJan" runat="server" width="80px"  onblur="Cal(this);"  onkeypress="return isNumber(event)" MaxLength="8" CssClass="form-control numeric text-right" > </asp:TextBox>
                                               </ItemTemplate>
                                                  <FooterTemplate>
                                                       <asp:TextBox ID="txtJan1" runat="server" width="80px" onblur="Cal(this);" ReadOnly="true"  CssClass="form-control numeric text-right" onkeypress="return isNumber(event)" MaxLength="12"> </asp:TextBox>
                                                 </FooterTemplate>
                                           </asp:TemplateField>
                                           <asp:TemplateField HeaderText="Feb" >
                                               <ItemTemplate>
                                                   <asp:TextBox ID="txtFeb" runat="server" width="80px"  onblur="Cal(this);"  onkeypress="return isNumber(event)" MaxLength="8" CssClass="form-control numeric text-right"> </asp:TextBox>
                                               </ItemTemplate>
                                                <FooterTemplate>
                                                       <asp:TextBox ID="txtFeb1" runat="server" width="80px" onblur="Cal(this);" ReadOnly="true" CssClass="form-control numeric text-right" onkeypress="return isNumber(event)" MaxLength="12"> </asp:TextBox>
                                                 </FooterTemplate>
                                           </asp:TemplateField>
                                              <asp:TemplateField HeaderText="Mar" >
                                               <ItemTemplate>
                                                   <asp:TextBox ID="txtMarch" onblur="Cal(this);" width="80px"  onkeypress="return isNumber(event)" MaxLength="8" runat="server" CssClass="form-control numeric text-right"> </asp:TextBox>
                                               </ItemTemplate>
                                                  <FooterTemplate>
                                                       <asp:TextBox ID="txtMarch1" onblur="Cal(this);" width="80px" ReadOnly="true"  onkeypress="return isNumber(event)" MaxLength="12" runat="server" CssClass="form-control numeric text-right"> </asp:TextBox>
                                                  </FooterTemplate>
                                           </asp:TemplateField>
