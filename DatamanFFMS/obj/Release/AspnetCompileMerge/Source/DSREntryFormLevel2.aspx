<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" EnableEventValidation="false"  CodeBehind="DSREntryFormLevel2.aspx.cs" Inherits="AstralFFMS.DSREntryFormLevel2" %>
    ...
    <script type="text/javascript">
        function validate() {
            ...
            if ($('#<%=ddlcity.ClientID%>').val() == "0") {
                errormessage("Please select Today's City");
                return false;
            }
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-default">
                        <div class="box-header">
                            <h3 class="box-title">DSR Entry L-2</h3>
        ...
        <div class="box-body" id="rptmain" runat="server" style="display: none;">
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">DSR L-2 List</h3>
                            <div style="float: right">
