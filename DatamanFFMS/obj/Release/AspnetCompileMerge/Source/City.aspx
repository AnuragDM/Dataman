<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="City.aspx.cs" Inherits="AstralFFMS.City" EnableEventValidation="false" %>
               ...
               $('#<%=ddlParentLoc.ClientID %>').empty().append('<option selected="selected" value="0">Loading...</option>');
                  ...
                  function PopulateControl(list, control) {
                      if (list.length > 0) {
                          ...
                          var id = $('#<%=HiddeDisCitynUnderID.ClientID%>').val();
                          //  alert(id);
                          if (id != "") {
                              control.val(id);
                          }
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-default">
                            ...
                            <div class="row">
                                <div class="col-lg-5 col-md-6 col-sm-8 col-xs-10">
                                    <div class="form-group">
                                        ...
                                        <input type="text" runat="server" class="form-control" maxlength="100" id="Location" placeholder="Enter City Name" tabindex="2">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">District:</label>&nbsp;&nbsp;<label for="requiredFields" style="color: red;">*</label>
                                        <asp:DropDownList ID="ddlParentLoc" runat="server" Width="100%" CssClass="form-control" TabIndex="3"></asp:DropDownList>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">STD Code:</label>&nbsp;&nbsp;<label for="requiredFields" style="color: red;">*</label>
                                        <input type="text" runat="server" class="form-control numeric text-right" maxlength="5" id="StdCode" placeholder="Enter STD Code" tabindex="5">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Sync Id:</label>
                                        <input type="text" runat="server" class="form-control" maxlength="50" id="SyncId" placeholder="Enter Sync Id" tabindex="5">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">City Type:</label>&nbsp;&nbsp;<label for="requiredFields" style="color: red;">*</label>
                                        <asp:DropDownList ID="ddlcityType" runat="server" Width="100%" CssClass="form-control" TabIndex="7"></asp:DropDownList>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">City Conveyance Type:</label>&nbsp;&nbsp;<label for="requiredFields" style="color: red;">*</label>
                                        <asp:DropDownList ID="ddlcityconveyancetype" runat="server" Width="100%" CssClass="form-control" TabIndex="9"></asp:DropDownList>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Active:</label>
                                        <input id="chkIsActive" runat="server" type="checkbox" checked="checked" class="checkbox" tabindex="10" />
                        ...
                        <div class="box-footer">
                            <asp:HiddenField ID="HiddeDisCitynUnderID" runat="server" />
                                ...
                                <ItemTemplate>
                                    <tr onclick="DoNav('<%#Eval("AreaId") %>');">
                                       ...
                                       <%-- <td><%#Eval("Parent") %></td>--%>
                                        ...
                                        <td><%#Eval("STDCode") %></td>
                                        <td><%#Eval("SyncId") %></td>
                                        <td><%#Eval("CityTypeName") %></td>
                                        <td><%#Eval("CityConveyance") %></td>
                                        <td><%#Eval("Active1") %></td>
                                    </tr>
                                </ItemTemplate>
                                <FooterTemplate>
