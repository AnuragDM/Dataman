<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="DistributerDispatchOrderViewForm.aspx.cs" Inherits="AstralFFMS.DistributerDispatchOrderViewForm" %>
                        ...
                        <div id="InputWork">
                            ...
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Distributor Dispatch Order Report</h3>
                                </div>
                                <!-- /.box-header -->
                                <!-- form start -->
                                <div class="box-body">
                                        ...
                                        <table id="itemsaleTable" class="table table-bordered table-striped">
                                            <thead>
                                                <tr>                                                  
                                                    ...
                                                    <th style="text-align: left; width: 17%">OrderStatus</th>
                                        ...
                                        <td><%#Eval("VDate","{0:dd/MMM/yyyy}")%></td>
                                         <td><%# Eval("SyncId")%></td>
                                            ...
                                            <td><asp:LinkButton CommandName="selectDate" ID="LinkButton1"
                                                ...
                                                <asp:LinkButton CommandName="ViewItem" ID="LinkButton3"
                                                    CausesValidation="False" runat="server" OnClientClick="window.document.forms[0].target='_self'; setTimeout(function(){window.document.forms[0].target='';}, 500);" 
                                                    Text="ItemDetail" 
            ...
            <div class="modal" id="ItemDetail" runat="server">
                <div class="modal-dialog">
                    <div class="modal-content" style="height: 320px !important; overflow-y: auto !important;">
                        ...
                        <!-- Modal Header -->
                        <div class="modal-header">
                            <h4 class="modal-title">Distributor Dispatch Order Item Details</h4>
