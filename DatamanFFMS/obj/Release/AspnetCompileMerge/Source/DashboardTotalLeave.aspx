<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="DashboardTotalLeave.aspx.cs" Inherits="AstralFFMS.DashboardTotalLeave" EnableEventValidation="false" %>
                            ...
                            <asp:Repeater ID="rpt" runat="server">
                                ...
                                <ItemTemplate>
                                    <tr onclick="DoNav('<%#Eval("SMId") %>');">
                                        ...
                                        <td><%#String.Format("{0:dd/MMM/yyyy}", Eval("fromdate"))%></td>
                                       <td> <%#String.Format("{0:dd/MMM/yyyy}", Eval("todate"))%></td>
                                        <td><%#Eval("reason") %></td>
                                    </tr>
                                </ItemTemplate>
                                <FooterTemplate>
