<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="VarianceReportL3.aspx.cs" Inherits="AstralFFMS.VarianceReportL3" %>
                    ...
                    <div id="InputWork">
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Daily Variance Report L3</h3>
                            </div>
                            <!-- /.box-header -->
                            <!-- form start -->
                                ...
                                <div class="row">
                                    <div class="col-md-2 col-sm-5 col-xs-9">
                                        <div class="form-group">
                                            ...
                                            <asp:TreeView ID="trview" runat="server" CssClass="table-responsive" ExpandDepth="10" ShowCheckBoxes="All" Width="801px"></asp:TreeView>  
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                            ...
                            <div class="box-body table-responsive">
                                ...
                                <asp:GridView runat="server" ID="gvData" Width="100%" EmptyDataText="No Records Found"
                                    AutoGenerateColumns="False" CssClass="tblb" ShowFooter="True" OnRowDataBound="gvData_RowDataBound">
                                    <Columns>
