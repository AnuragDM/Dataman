<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="RptDailyWorkingApprovalL2.aspx.cs" Inherits="AstralFFMS.RptDailyWorkingApprovalL2" %>
                         ...
                         Save: function () {
                             ...
                             $.ajax({
                                 ...
                                 success: function (data) {
                                     ...
                                     window.location.href = 'RptDailyWorkingApprovalL2.aspx?hasval=' + setval + '&smIDStr=<%=ViewState["smIDStr"]%>&userid=<%=ViewState["UserId"]%>';
                                        ...
                                        <div style="overflow: hidden;">
                                            <table style="font-size: 12px;">
                                                ...
                                                <tr>                                                
                                                    ...
                                                    <td>
                                                        <textarea id="TextArea1" class="form-control" style="resize: none; height: 80px;" cols="20" rows="2" runat="server" placeholder="Enter Remark"></textarea></td>
                                                </tr>
                                               <%-- <tr>
                                                    <td></td>
