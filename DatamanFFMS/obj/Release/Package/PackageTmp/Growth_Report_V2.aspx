<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="Growth_Report_V2.aspx.cs" Inherits="AstralFFMS.Growth_Report_V2" %>
                    ...
                    <div class="col-md-12">
                        <div id="InputWork">
                            ...
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <%-- <h3 class="box-title">Retailer Growth Analysis (Product Wise)</h3>--%>
                                     <img src="img/Location/investment.png" />
                                    <h2 class="box-title">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <asp:ListBox ID="CityListbox" runat="server" css="form" SelectionMode="Multiple" OnSelectedIndexChanged="CityListbox_SelectedIndexChanged" AutoPostBack="true" class="form-control"></asp:ListBox>
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Area:</label>
                                                <asp:ListBox ID="AreaListBox" runat="server" OnSelectedIndexChanged="AreaListBox_SelectedIndexChanged" AutoPostBack="true" SelectionMode="Multiple" class="form-control"></asp:ListBox>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <asp:ListBox ID="Lstbeatbox" runat="server" SelectionMode="Multiple" OnSelectedIndexChanged="Lstbeatbox_SelectedIndexChanged" AutoPostBack="true" class="form-control"></asp:ListBox>
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <asp:ListBox ID="Lstpartybox" runat="server" SelectionMode="Multiple" class="form-control"></asp:ListBox>
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <asp:ListBox ID="matGrpListBox" runat="server" SelectionMode="Multiple"
                                                    OnSelectedIndexChanged="matGrpListBox_SelectedIndexChanged" AutoPostBack="true" class="form-control"></asp:ListBox>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <asp:ListBox ID="productListBox" runat="server" SelectionMode="Multiple" class="form-control"></asp:ListBox>
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <div id="DIV1" class="form-group">
                                                <label for="exampleInputEmail1">From Date:</label>
                                                <asp:TextBox ID="txtfmDate" runat="server" Width="100%" CssClass="form-control" Style="background-color: white;" AutoCompleteType="Disabled"></asp:TextBox>
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="txttodate" runat="server" Width="100%" CssClass="form-control" Style="background-color: white;" AutoCompleteType="Disabled"></asp:TextBox>
                                ...
                                <div class="box-footer">
                                    ...
                                    <asp:Button type="button" ID="btnGo" runat="server" Text="Generate" class="btn btn-primary button1"                                       OnClick="btnGo_Click" />
                        ...
                        <div id="rptmain" runat="server">
                            <div class="box-header table-responsive">
                                <asp:Repeater ID="rptRPWiseGrowth" runat="server">
                                    <HeaderTemplate>
                                        <table id="itemsaleTable" class="table table-bordered table-striped">
                                            <thead>
                                                <tr>
                                                    <th>Retailer</th>
                                                    <th>Product</th>
                                                    <th style="text-align: right">Avg Monthly Sale In last 3 Months.</th>
                                                    <th style="text-align: right; width: 10%">Current Month Sale</th>
                                                    <th style="text-align: right; width: 10%">Percentage Growth</th>
                                                </tr>
                                            </thead>
                                            <tfoot>
                                                <tr>
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <tr>
                                            <td><%# Eval("Party")%>
                                                <asp:Label ID="lblparty" runat="server" Visible="false" Text='<%# Eval("Party")%>'></asp:Label></td>
                                            <td><%# Eval("Item")%>
                                                <asp:Label ID="lblitem" runat="server" Visible="false" Text='<%# Eval("Item")%>'></asp:Label></td>
                                            <td style="text-align: right"><%# Eval("Avg_Value","{0:F2}")%>
                                                <asp:Label ID="lblavgvalue" runat="server" Visible="false" Text='<%# Eval("Avg_Value","{0:F2}")%>'></asp:Label></td>
                                            <td style="text-align: right"><%# Eval("Value","{0:F2}")%>
                                                <asp:Label ID="lblvalue" runat="server" Visible="false" Text='<%# Eval("Value","{0:F2}")%>'></asp:Label></td>
                                            <td style="text-align: right"><%# Eval("Percentage","{0:F2}")%>
                                                <asp:Label ID="lblpercentage" runat="server" Visible="false" Text='<%# Eval("Percentage","{0:F2}")%>'></asp:Label></td>
                                        </tr>
        ...
        $(function () {
            $('#itemsaleTable').dataTable({
                ...
                "footerCallback": function (tfoot, data, start, end, display) {
                    ...
                    debugger;
                    var costColumnIndex = $('th').filter(function (i) { return $(this).text() == 'Avg Monthly Sale In last 3 Months.'; }).first().index();
                    ...
                    var costColumnIndex1 = $('th').filter(function (i) { return $(this).text() == 'Current Month Sale'; }).first().index();
