<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="DashboardPrimary.aspx.cs" Inherits="AstralFFMS.DashboardPrimary" EnableEventValidation="false" %>
...
.price-slider span {
    ...
    <script>
        ...
        function DoNav(SMId,Partytype) {
            if (SMId != "") {
                var name = getQueryVariable("Name");
                var date = $("#<%=FromDate.ClientID%>").val();
               // var date = getQueryVariable("Date");
                window.open("DashboardPrimaryDetail.aspx?Date=" + date + "&Name=" + name + "&SMId=" + SMId + "&Type=" + Partytype + "");
            }
        }
    </script>
                        ...
                        <div class="box-body table-responsive">
                            <asp:Repeater ID="rptCollection" runat="server">
                                ...
                                <ItemTemplate>
                                    ...
                                    <tr onclick="DoNav('<%#Eval("SMId") %>','<%#Eval("Partytype1") %>');">
                                       
                                        <asp:HiddenField ID="HiddenField1" runat="server" Value='<%#Eval("SMId") %>' />
                                        <td><%#Eval("smname") %></td>
                                        <td><%#Eval("TotalDistributors") %></td>
                                      <%--  <td><%#Eval("Totalcollection") %></td>--%>
