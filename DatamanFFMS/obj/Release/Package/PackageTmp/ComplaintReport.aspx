                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body" id="div1">
                                <div class="row">
                                    ...
                                    <div runat="server" id="divdist" style="display: none;" class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                        <div class="form-group">
                                ...
                                <div class="row" id="divptype" style="display: none;" runat="server">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" id="divpname">
                                        <div class="form-group">
                                    ...
                                    <div  runat="server" class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
