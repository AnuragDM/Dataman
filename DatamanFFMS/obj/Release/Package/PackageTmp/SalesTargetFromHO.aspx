...
<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="SalesTargetFromHO.aspx.cs" Inherits="AstralFFMS.SalesTargetFromHO" %>
                ...
                <div id="InputWork">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <%--<h3 class="box-title">Sales Target Entry From HO <b>(In Lakhs)</b></h3>--%>
                        ...
                        <div class="col-md-12">
                                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-9">
                                    <div class="form-group">
                                        ...
                                        <asp:RadioButtonList ID="itemgroupRadioButtonlst" RepeatDirection="Horizontal" runat="server" AutoPostBack="true" OnSelectedIndexChanged="itemgroupRadioButtonlst_SelectedIndexChanged">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-9">
                                    <div class="form-group">
                                        ...
                                        <asp:RadioButtonList ID="targetRadioButtonList" RepeatDirection="Horizontal" runat="server" AutoPostBack="true" OnSelectedIndexChanged="targetRadioButtonList_SelectedIndexChanged">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-9" id="divunit" runat="server">
                                    <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-9">
                                    <div class="form-group">
                                        <asp:Button ID="Button1" OnClientClick="return valid1();" CssClass="btn btn-primary" Text="Fill" OnClick="Button1_Click" runat="server" />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="box-header with-border">
                                ...
                                <div style="float: right">
                                    <h3 class="box-title">
                                        <asp:Label ID="Lbl1" runat="server" ></asp:Label></h3>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="table table-responsive">
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" HeaderStyle-BackColor="#3c8dbc" Width="100%" HeaderStyle-ForeColor="White" OnRowDataBound="GridView1_RowDataBound" OnRowCommand="GridView1_RowCommand">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Assigned By District Head">
                                                <ItemTemplate>
                            ...
                            <div class="box-header with-border">
                                ...
                                <div style="float: right">
                                    <h3 class="box-title">
                                        <asp:Label ID="lbl2" runat="server" ></asp:Label></h3>
                                </div>
                            </div>
                            <div class="form-group">
                                    ...
                                    <asp:GridView ID="GridView2" runat="server" ShowFooter="true" AutoGenerateColumns="false" HeaderStyle-BackColor="#3c8dbc" Width="100%" HeaderStyle-ForeColor="White" OnRowDataBound="GridView2_RowDataBound">
                                        <Columns>
                                            <asp:TemplateField HeaderText="Team">
                                                ...
                                                <FooterTemplate>
                                                    <asp:Label ID="lbltotal" Style="color: #000;" Text="Total" runat="server" CssClass="form-control text-bold"></asp:Label>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Jun">
                                                ...
                                                <FooterTemplate>
                                                    <asp:TextBox ID="txtjun1" runat="server" Width="80px" onblur="Cal(this);" ReadOnly="true" CssClass="form-control numeric text-right" MaxLength="12"> </asp:TextBox>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Jan">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtJan" runat="server" onblur="Cal(this);" Width="80px" MaxLength="8" CssClass="form-control numeric text-right"> </asp:TextBox>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:TextBox ID="txtJan1" runat="server" onblur="Cal(this);" Width="80px" ReadOnly="true" CssClass="form-control numeric text-right" MaxLength="12"> </asp:TextBox>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Feb">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtFeb" runat="server" onblur="Cal(this);" Width="80px" MaxLength="8" CssClass="form-control numeric text-right"> </asp:TextBox>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:TextBox ID="txtFeb1" runat="server" onblur="Cal(this);" Width="80px" ReadOnly="true" CssClass="form-control numeric text-right" MaxLength="12"> </asp:TextBox>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Mar">
                                                ...
                                                <FooterTemplate>
                                                    <asp:TextBox ID="txtMarch1" onblur="Cal(this);" ReadOnly="true" Width="80px" MaxLength="12" runat="server" CssClass="form-control numeric text-right"> </asp:TextBox>
                                                </FooterTemplate>
                                            </asp:TemplateField>
