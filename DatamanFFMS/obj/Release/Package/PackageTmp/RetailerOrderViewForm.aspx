<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="RetailerOrderViewForm.aspx.cs" Inherits="AstralFFMS.RetailerOrderViewForm" %>
                            ...
                            <div class="box box-primary">
                                    ...
                                    <div class="row">
                                       ...
                                       <%-- <div class="col-md-3 col-sm-6 col-xs-7" hidden>
                                        ...
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Status :</label>&nbsp;&nbsp;<label for="requiredFields" style="color: red;display:none;">*</label>      <br />   
                                                <asp:DropDownList runat="server" ID="lstStatus">
                                                    <asp:ListItem Text="All" Value="A" />
                                                    <asp:ListItem Text="Posted" Value="Y"/>
                                                    <asp:ListItem Text="Non-Posted" Value="N" />
                                                </asp:DropDownList>                                       
                                                <asp:ListBox ID="ListBox1" runat="server" SelectionMode="Multiple" OnSelectedIndexChanged="ListBox1_SelectedIndexChanged" AutoPostBack="true" Visible="false"></asp:ListBox>
                                ...
                                <div class="box-footer">
                                   ...
                                   <%-- <asp:Button Style="margin-right: 5px;" type="button" ID="btnExport" runat="server" Text="Export" ToolTip="Export To Excel" class="btn btn-primary"
                                     ...
                                     <asp:Button Style="margin-right: 5px;" type="button" ID="btnExport" runat="server" Text="Export" ToolTip="Export To Excel" class="btn btn-primary"
                                      OnClick="btnExport_Click"/>
                                     <asp:Button Style="margin-right: 5px;" type="button" ID="btnPost" runat="server" Text="Post Orders" ToolTip="Post To Nav" class="btn btn-primary"
                                ...
                                <asp:Repeater ID="distitemsalerpt" runat="server" OnItemCommand="distitemsalerpt_ItemCommand">
                                        ...
                                        <table id="itemsaleTable" class="table table-bordered table-striped">
                                            <thead>
                                                <tr>                                                  
                                                    ...
                                                    <th style="text-align: left; width: 20%">Retailer Sync Id</th>
                                                    <th style="text-align: left; width: 20%">Retailer Name</th>
                                                         <th style="text-align: left; width: 20%">BeatName</th>
                                                    <th style="text-align: left; width: 17%">OrderDocId</th>
                                                    <th style="text-align: right; width: 17%">Total Qty</th>
                                                    <th style="text-align: right; width: 12%">Total Amount</th>
                                                    <th style="text-align: left; width: 12%">OrderStatus</th>
                                                    <th>Order Place By</th>
                                                    <th style="text-align: left; width: 17%">View Detail </th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        ...
                                        <asp:HiddenField ID="hdnDate" runat="server" Value='<%#Eval("VDate","{0:dd/MMM/yyyy}")%> ' />
                                            <asp:HiddenField ID="hdnDistributorName" runat="server" Value='<%#Eval("PartyName")%>' />
                                        <asp:HiddenField ID="hdnDocId" runat="server" Value='<%#Eval("OrdDocId")%>' />
                                        <td><%#Eval("VDate","{0:dd/MMM/yyyy}")%></td>
                                         <td><%# Eval("syncid")%></td>
                                            <td><%# Eval("PartyName")%></td>
                                            <td><%# Eval("AreaName")%></td>
                                            <td><%# Eval("OrdDocId")%></td>
                                            <td style="text-align: right;" ><%# Eval("tqty")%></td>
                                            ...
                                            <td><asp:LinkButton CommandName="selectDate" ID="LinkButton1"
                                                ...
                                                <asp:LinkButton CommandName="ViewItem" ID="LinkButton3" CommandArgument='<%#Eval("OrdDocId")%>'
                                                    CausesValidation="False" runat="server" OnClientClick="window.document.forms[0].target='_self'; setTimeout(function(){window.document.forms[0].target='';}, 500);" 
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content" style="height:550px !important;overflow-y:auto !important;">
                              ...
                              <div class="modal-header">
                                <h4 class="modal-title">Retailer Order Details</h4>
                                                ...
                                                <ItemTemplate>
                                                    <tr onclick="DoNav('<%#Eval("ItemId") %>');">
                                                        <asp:HiddenField ID="HiddenField1" runat="server" Value='<%#Eval("ItemId") %>' />
                                                         <asp:HiddenField ID="HiddenField2" runat="server" Value='<%#Eval("OrdDocId") %>' />
                                                        <td><%#Eval("ItemName") %></td>
                                                        <td><%#Eval("OrderQty") %></td>
                ...
                <div class="modal-dialog">
                   <!--  <div class="col-lg-12 col-md-6 col-sm-8">-->
                    <div class="modal-content" style="height: 560px !important;  overflow-y: auto !important;">
                        ...
                        <!-- Modal Header -->
                        <div class="modal-header">
                            <h4 class="modal-title">Retailer Order Item Details</h4>
                      ...
                      <td style="margin-left:20px;"><b>Remark:</b></td>  
                       <td>--%>
                        ...
                        <div class="modal" id="myModal1" runat="server">
                          <div class="modal-dialog">
                            <div class="modal-content" style="height:211px !important;overflow-y:auto !important;width: 700px !important;">
                                        ...
                                        <table>
                                            <tr>
                                                <td>
                                                    ...
                                                    <textarea id="TextArea2" class="form-control" style="display: none; resize: none; height: 80px; width: 420px;" cols="20" rows="2" runat="server"
                                                        placeholder="Enter Remark"></textarea></td>
                                            </tr>
                                        </table>
                                    </div>
                              ...
                              <!-- Modal footer -->
                              <div class="modal-footer">
                                  <asp:Button type="button" ID="Button2" runat="server" Text="Save" class="btn btn-primary" OnClick="btnCancelOrderSave_Click" Visible="false"/>
                                <button ID="cmodalClose" type="button" class="btn btn-danger" style="display:none;" >Close</button>
                              </div>
