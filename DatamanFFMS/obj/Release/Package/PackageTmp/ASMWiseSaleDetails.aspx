<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="ASMWiseSaleDetails.aspx.cs" Inherits="AstralFFMS.ASMWiseSaleDetails" %>
                    ...
                    <div id="InputWork">
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                               <%-- <h3 class="box-title">ASM Wise Secondary Sales Details</h3>   --%>  
                           ...
                           <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Report For ASM:</label>                                                
                                            <asp:Label ID="lblSalesperson" runat="server" Text='<%# Eval("smname")%>'></asp:Label>
                                        </div>
                                        <%-- </div>--%>
                                ...
                                <HeaderTemplate>
                                 ...
                                 <asp:Button Style="margin-right: 5px; margin-bottom:20px;" type="button" ID="btnExport" runat="server" Text="Export" ToolTip="Export To Excel" class="btn btn-primary" OnClick="btnExport"/>
                                    ...
                                    <ItemTemplate>
                                            ...
                                            <td><%# Eval("Product")%>
                                            <asp:Label ID="lblitemname" runat="server" Visible="false" Text='<%# Eval("Product")%>'></asp:Label></td>
