<%@ Page Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="RetailerProductWiseGrowthReport.aspx.cs" Inherits="AstralFFMS.RetailerProductWiseGrowthReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <style type="text/css">
        ...
        #itemsaleTable_wrapper thead > tr > th {
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <asp:ListBox ID="CityListbox" runat="server" SelectionMode="Multiple" OnSelectedIndexChanged="CityListbox_SelectedIndexChanged" AutoPostBack="true"></asp:ListBox>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Area:</label>
                                                <asp:ListBox ID="AreaListBox" runat="server" OnSelectedIndexChanged="AreaListBox_SelectedIndexChanged" AutoPostBack="true" SelectionMode="Multiple"></asp:ListBox>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <asp:DropDownList ID="monthDDL" runat="server" CssClass="form-control">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
