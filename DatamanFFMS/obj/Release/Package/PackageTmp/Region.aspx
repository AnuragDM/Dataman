                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" runat="server" class="form-control" maxlength="100" id="Location" placeholder="Enter Region Name" autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input id="chkIsActive" runat="server" type="checkbox" checked="checked" class="checkbox" autocomplete="off"/>
