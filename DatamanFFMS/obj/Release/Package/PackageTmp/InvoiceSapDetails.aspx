<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="InvoiceSapDetails.aspx.cs" Inherits="AstralFFMS.InvoiceSapDetails" %>
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 col-sm-3 col-xs-12" style="color: #169434; font-family: Arial; font-weight: bold;">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12" style="color: #169434; font-family: Arial; font-weight: bold;">
                                            Invoice No.
                                            <asp:Label ID="lblOrderSt" runat="server" Text=""></asp:Label>&nbsp; | &nbsp;
                                         Order No.
                                            <asp:Label ID="lblOrderNo" runat="server" Text=""></asp:Label>&nbsp; | &nbsp;
                                         Category
                                            <asp:Label ID="lblCategory" runat="server" Text="SAP"></asp:Label>&nbsp; | &nbsp;
                                        Branch Code
