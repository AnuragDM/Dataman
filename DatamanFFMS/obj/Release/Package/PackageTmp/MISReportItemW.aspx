<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="MISReportItemW.aspx.cs" Inherits="AstralFFMS.MISReportItemW" %>
                ...
                <div id="InputWork">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">MIS Report Item Wise</h3>
                        </div>
                        <div class="row">
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Party/Distributor :</label>&nbsp;&nbsp;
                                   <b> <asp:Label ID="lbldist" runat="server" Text='<%# Eval("PartyName")%>'></asp:Label></b>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="box-header with-border">
                            ...
                            <div class="col-md-3" style="float: right;">
                                <label></label>
                                &nbsp;&nbsp;&nbsp;<asp:Label ID="currDateLabel" Visible="false" runat="server" Text="Label"></asp:Label>
                                <br />
                            </div>
                        </div>
                        <div class="box-body">
                            ...
                            <div class="box-body table-responsive">
                                <asp:Repeater ID="rpt" runat="server">
                                        ...
                                        <table id="example1" class="table table-bordered table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th id="thArea" runat="server" style="text-align: right">Rate</th>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            <asp:HiddenField ID="hfAreaId" runat="server" Value='<%#Eval("ItemId") %>' />
                                            <td><%#Eval("ItemName") %></td>
                                            <asp:Label ID="lblItemName" runat="server" Visible="false" Text='<%# Eval("ItemName")%>'></asp:Label>
        ...
        $(function () {
            $('#example1').dataTable({
                ...
                "footerCallback": function (tfoot, data, start, end, display) {
                    ...
                    var costColumnIndex1 = $('th').filter(function (i) { return $(this).text() == 'Order Amount'; }).first().index();
