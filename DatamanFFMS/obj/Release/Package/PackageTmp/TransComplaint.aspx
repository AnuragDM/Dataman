<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="TransComplaint.aspx.cs" Inherits="AstralFFMS.TransComplaint" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        function validate() {
            ...
            // + $('#<%=ddlpartytype.ClientID%>').find("option:selected").text() + "
            if ($('#<%=ddlpartytypepersons.ClientID%>').val() == "0") {
...
<%--            if ($('#<%=txtDist.ClientID%>').val() != "") {
    ...
    <script type="text/javascript">
      <%--  function SetContextKey() {
            $find('<%=AutoCompleteExtender2.ClientID%>').set_contextKey($get("<%=DdlSalesPerson.ClientID %>").value);
        }--%>
    </script>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-default">
                        <div class="box-header">
                           <%-- <h3 class="box-title">Complaint Entry</h3>--%>
                                ...
                                <ContentTemplate>
                                    <div class="col-md-8">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <asp:DropDownList ID="DdlSalesPerson" Width="100%" CssClass="form-control" runat="server">
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <asp:DropDownList ID="ddlComplaintNature" CssClass="form-control" Width="100%" runat="server"></asp:DropDownList>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <%-- <input type="text" id="txtSearch" class="form-control autosuggest" onchange="GetItemDesc(this.value);" />--%>
                                                    ...
                                                    <%--  <asp:DropDownList ID="ddlproductlist" CssClass="form-control select2" runat="server" onchange="GetProductDesc(this.options[this.selectedIndex].value);"></asp:DropDownList>--%>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6">
                                                <div class="form-group">
                                                    <%--<label for="complaintNature">Distributor Name:</label>--%>
                                                    <label id="lblpartytypepersons"  runat="server">Party Name</label>
                                                   <%-- &nbsp;&nbsp;<label for="requiredFields" style="color: red;">*</label>--%>
                                                    <asp:DropDownList ID="ddlpartytypepersons" CssClass="form-control select2" runat="server"></asp:DropDownList>
                                                  <%--  <asp:TextBox ID="txtDist" runat="server" class="form-control" onkeyup="SetContextKey();" placeholder="Enter Distributor"></asp:TextBox>
                                                    <ajaxToolkit:AutoCompleteExtender ID="AutoCompleteExtender2" runat="server" CompletionListCssClass="completionList"
                                                        CompletionListItemCssClass="listItem" CompletionListHighlightedItemCssClass="itemHighlighted" UseContextKey="true"
                                                        FirstRowSelected="false" OnClientItemSelected="ClientPartySelected"
                                                        DelimiterCharacters="" ServiceMethod="SearchDist" ServicePath="~/TransComplaint.aspx" MinimumPrefixLength="3" EnableCaching="true"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="salesPersonDdl2" Width="100%" CssClass="form-control" runat="server"></asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-6 col-xs-12">
                                    <div class="form-group">
