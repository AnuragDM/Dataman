<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="DashboardPrimaryDetail.aspx.cs" Inherits="AstralFFMS.DashboardPrimaryDetail" EnableEventValidation="false" %>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="col-lg-9 col-md-9 col-sm-7 col-xs-9">
                                ...
                                <asp:Button Style="margin-right: 5px;" type="button" ID="btndiscussion" runat="server" Text="Export" ToolTip="Export To Excel" class="btn btn-primary" OnClick="btndiscussion_Click" />
                                <asp:Button Style="margin-right: 5px;" type="button" ID="btnprodutive" runat="server" Text="Export" ToolTip="Export To Excel" class="btn btn-primary" OnClick="btnproductive_Click" />
                                 </div>
                        ...
                        <div class="box-body table-responsive">
                            <asp:Repeater ID="rptDiscussion" runat="server">
                                ...
                                <ItemTemplate>
                                    <tr onclick="DoNav('<%#Eval("SMId") %>');">
                                        ...
                                        <asp:Label ID="lblsname" runat="server" Visible="false" Text='<%# Eval("smname")%>'></asp:Label></td>
                                        <td><%#Eval("partyname") %>
                                         <asp:Label ID="lblptyname" runat="server" Visible="false" Text='<%# Eval("partyname")%>'></asp:Label></td>                         <td><%#Eval("remarkdist") %>
                                         <asp:Label ID="lblremarkdist" runat="server" Visible="false" Text='<%# Eval("remarkdist")%>'></asp:Label></td>
                         ...
                         <div class="box-body table-responsive">
                            <asp:Repeater ID="rptProductive" runat="server">
                                <HeaderTemplate>
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
