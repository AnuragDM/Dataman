<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/FFMS.Master" CodeBehind="NewRptDailyWorkingApprovalL2.aspx.cs" Inherits="AstralFFMS.NewRptDailyWorkingApprovalL2" %>
        ...
        $(document).on('keyup', $('#example1 .imgButton'), function () {
            ...
            $('#example1 .imgButton').click(function () {
                ...
                $.ajax({
                    ...
                    url: "NewRptDailyWorkingApprovalL2.aspx/BindDatatable",
                    ...
                    buttons: {
                        Save: function () {
                            ...
                            if ($('#<%=TextArea1.ClientID%>').val() == "") {
                             ...
                             $.ajax({
                                 type: "POST",
                                 url: "NewRptDailyWorkingApprovalL2.aspx/UpdateDSR",
                                 data: JSON.stringify(obj),
                                 contentType: "application/json; charset=utf-8",
                                 dataType: "json",
                                 success: function (data) {
                                     ...
                                     window.location.href = 'NewRptDailyWorkingApprovalL2.aspx?hasval=' + setval + '&smIDStr=<%=ViewState["smIDStr"]%>&userid=<%=ViewState["UserId"]%>';
                                     alert("Record Updated Successfully");
                ...
                $("#popupWindow").dialog({
                    ...
                    buttons: {
                        Save: function () {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "RptDailyWorkingApprovalL2.aspx/UpdateDSR",
                                data: JSON.stringify(obj),
                                contentType: "application/json; charset=utf-8",
                                dataType: "json",
                                success: function (data) {
                        ...
                        <div id="InputWork">
                            ...
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                   <%-- <h3 class="box-title">Daily Working Approval L2</h3>--%>
                                ...
                                <asp:Repeater ID="rpt" runat="server" OnItemCommand="rpt_ItemCommand">
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:LinkButton CommandName="selectDate" ID="lnkEdit1"
