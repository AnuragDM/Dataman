<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/FFMS.Master" CodeBehind="NewRptDailyWorkingApprovalL1.aspx.cs" Inherits="AstralFFMS.NewRptDailyWorkingApprovalL1" %>
        ...
        $(document).on('keyup', $('#example1 .imgButton'), function () {
            ...
            $('#example1 .imgButton').click(function () {
                ...
                $.ajax({
                    ...
                    url: "NewRptDailyWorkingApprovalL1.aspx/BindDatatable",
                    ...
                    buttons: {
                        Save: function () {
                            ...
                            if ($('#<%=TextArea1.ClientID%>').val() == "") {
                             ...
                             $.ajax({
                                 type: "POST",
                                 url: "NewRptDailyWorkingApprovalL1.aspx/UpdateDSR",
                                 data: JSON.stringify(obj),
                                 contentType: "application/json; charset=utf-8",
                                 dataType: "json",
                                 success: function (data) {
                                     ...
                                     window.location.href = 'NewRptDailyWorkingApprovalL1.aspx?hasval=' + setval + '&smIDStr=<%=ViewState["smIDStr"]%>&userid=<%=ViewState["UserId"]%>';
                                     alert("Record Updated Successfully");
                ...
                $("#popupWindow").dialog({
                    ...
                    buttons: {
                        Save: function () {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "RptDailyWorkingApprovalL1.aspx/UpdateDSR",
                                data: JSON.stringify(obj),
                                contentType: "application/json; charset=utf-8",
                                dataType: "json",
                                success: function (data) {
                        ...
                        <div id="InputWork">
                            ...
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <%--<h3 class="box-title">Daily Working Approval L1</h3>--%>
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TreeView ID="trview" runat="server" CssClass="table-responsive" Width="100%" ExpandDepth="10" ShowCheckBoxes="All"></asp:TreeView>
                                                </div>
                                            </div>
                                        </div>                                      
                                    </div>
                                            ...
                                            <div class="liketable">
                                                ...
                                                <div class="col-md-4 col-sm-12 col-xs-12 no-padding">
                                                    <div class="col-md-12 col-sm-12 col-xs-12 no-padding">
                                                        ...
                                                        <div class="col-md-8 col-sm-6 col-xs-6">
                                                            <label class="">Dist. Non-Productive</label>
                                                        </div>
                                                    ...
                                                    <div class="col-md-12 col-sm-12 col-xs-12 no-padding">
                                                        ...
                                                        <div class="col-md-8 col-sm-6 col-xs-6">
                                                            <label class="">Non-Productive</label>
                                                        </div>
