<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="ProjectMaster.aspx.cs" Inherits="AstralFFMS.ProjectMaster" %>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <label for="exampleInputEmail1">Project Name:</label>&nbsp;&nbsp;<label for="requiredFields" style="color: red;">*</label>
                                        <asp:TextBox class="form-control" MaxLength="50" ID="Name" placeholder="Enter Project Name" runat="server" AutoCompleteType="Disabled"></asp:TextBox>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input runat="server" type="text" class="form-control" maxlength="20" id="SyncId" placeholder="Enter Sync Id" AutoCompleteType="Disabled">
                                    </div>
                                    </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
