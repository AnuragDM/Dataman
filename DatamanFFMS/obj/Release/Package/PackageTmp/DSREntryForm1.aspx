<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="DSREntryForm1.aspx.cs" EnableEventValidation="false" Inherits="AstralFFMS.DSREntryForm1" %>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-default">
                        <div class="box-header">
                            <h3 class="box-title">Distributor Screen L-1</h3>
                         ...
                         <div class="box-body">
                          ...
                          <div class="col-md-12 paddingleft0">
                            <div id="DIV1"   class="form-group col-md-4">
                              ...
                              <asp:Button type="button" ID="Button5" runat="server" style="padding: 3px 14px;" Text="Go" class="btn btn-primary" OnClick="Button5_Click" />
      ...
      <asp:Repeater ID="rpt" runat="server" OnItemCommand="rpt_ItemCommand" OnItemDataBound="rpt_ItemDataBound">
                                ...
                                <ItemTemplate>
                                   ...
                                   <td><%#Eval("SyncId") %></td>
                                        ...
                                        <td><%#Eval("CityName") %></td>
                                        <%--changes Nishu 07/09/2016 (for Seperate form )--%>
                                        ...
                                        <td id="colactivity" runat="server"> <asp:LinkButton ID="lnkactivity"  Text="Activity" runat="server"  CommandArgument=<%#Eval("PartyId")%> CommandName="Activity"></asp:LinkButton></td>
                                    </tr>
                                </ItemTemplate>
                                <FooterTemplate>
                                    </tbody>     </table>       
...
<%--<asp:GridView runat="server" ID="gvdetails" OnRowDataBound="gvdetails_RowDataBound"  OnRowCommand="gvdetails_RowCommand" CssClass="table table-bordered table-striped"  AutoGenerateColumns="false" Visible="false">
<Columns>
...
<asp:Panel ID="pnlpopup" runat="server" BackColor="White" Height="520px" Width="394px" style="display:none">
     <div  style="height:10%; background-color: #367FA9; color:white; font-weight:bold; font-size:larger" align="center">
        Discussion with Distributor
    </div>
    <div style="margin-left:10px;margin-right:10px">
<table style="padding-left:5px" width="100%" height:"80%" cellpadding="0" cellspacing="0">
...
<asp:Panel ID="Panel1" runat="server" BackColor="White" Height="360px" Width="300px" style="display:none">
    <div  style="height:10%; background-color: #367FA9; color:white; font-weight:bold; font-size:larger" align="center">
        Failed Visit
    </div>
    <div style="margin-left:10px;margin-right:10px">
<table style="padding-left:5px" width="100%" height:"80%" cellpadding="0" cellspacing="0">
<tr> <td colspan="2">
       <label class="hidden" id="lblerrorFV" runat="server" style="color:red;"></label> </td></tr>
...
<td align="left" colspan="2">
   <asp:DropDownList ID="ddlReason" width="100%" CssClass="form-control" runat="server"></asp:DropDownList>
</td>
...
<tr>
<td align="left">
<asp:TextBox ID="txtNextVisitdate" CssClass="form-control"  width="90%" runat="server"/>
 <ajaxToolkit:CalendarExtender ID="CalendarExtender3" runat="server"  CssClass="orange"  Format="dd/MMM/yyyy"   TargetControlID="txtNextVisitdate"/>
  ...
  <input type="text" data-scroll-default="6:00am" maxlength="7" width="90%" placeholder="--Select Time--" Class="form-control"  id="basicExample" runat="server" autocomplete="off" visible="false">
</td>
</tr>
    
  <tr><td><span style="color: white">,</span></td><span style="color: white">.</span><td></td></tr> 
    
<tr  align="left" style="padding:8px">
  <td height="50px" style="padding:8px" ><asp:Button ID="Button2" CommandName="Update" style="float: right;" runat="server" class="btn btn-primary" Text="Save" onclick="Button2_Click" OnClientClick="javascript:return validateFV();"/></td>  
