<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="DailySalesReportL3.aspx.cs" Inherits="AstralFFMS.DailySalesReportL3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <style type="text/css">
        ...
        #ContentPlaceHolder1_CheckBoxList1_0 {
        ...
        #ContentPlaceHolder1_CheckBoxList1_2 {
            margin-right: 5px !important;
            margin-top: 3px;
        }
                    ...
                    <div id="InputWork">
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Daily Sales Report (Level-3)</h3>
                            </div>
                            <!-- /.box-header -->
                            <!-- form start -->
