<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="DailySalesReportL2.aspx.cs" Inherits="AstralFFMS.DailySalesReportL2" %>
                    ...
                    <div id="InputWork">
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Daily Sales Report (Level-2)</h3>
                            </div>
                            <!-- /.box-header -->
                            <!-- form start -->
