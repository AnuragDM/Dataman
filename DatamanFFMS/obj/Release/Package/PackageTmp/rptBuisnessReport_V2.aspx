<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="rptBuisnessReport_V2.aspx.cs" Inherits="AstralFFMS.rptBuisnessReport_V2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content">
        ...
        <div id="spinner" runat="server" class="spinner" >
                        ...
                        <div id="InputWork">
                            ...
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                     <img src="img/Location/sale-report.png" />
                                ...
                                <div class="box-body">
                                  <%--  <asp:UpdatePanel ID="updatepnl" runat="server">
                                        <ContentTemplate>--%>
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 col-sm-4 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <asp:ListBox ID="LstType" runat="server" SelectionMode="Single" OnSelectedIndexChanged="LstType_SelectedIndexChanged" AutoPostBack="true" class="form-control"></asp:ListBox>
                                                ...
                                                <div class="col-md-4 col-sm-4 col-xs-12" id="trvw" runat="server" visible="false">
                                                    <div class="form-group">
                                            ...
                                            <div class="row" id="rwprm" runat="server" visible="false">

                                                <div class="col-md-4 col-sm-4 col-xs-12">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Area:</label>
                                                        &nbsp;&nbsp;<label for="requiredFields" style="color: red;">*</label>
                                                        <asp:ListBox ID="lstPrmAreaBox" runat="server" SelectionMode="Multiple" AutoPostBack="true" OnSelectedIndexChanged="lstPrmAreaBox_SelectedIndexChanged" class="form-control"></asp:ListBox>
                                                ...
                                                <div class="col-md-4 col-sm-4 col-xs-12">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Distributors:</label>
                                                        
                                                        <asp:ListBox ID="lstPrmPrsn" runat="server" SelectionMode="Multiple" AutoPostBack="true" class="form-control"></asp:ListBox>
                                            ...
                                            <div class="row" id="rwsec" runat="server" visible="false">

                                                <div class="col-md-4 col-sm-4 col-xs-12">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Area:</label>
                                                        &nbsp;&nbsp;<label for="requiredFields" style="color: red;">*</label>
                                                        <asp:ListBox ID="LstSecArea" runat="server" SelectionMode="Multiple" AutoPostBack="true" OnSelectedIndexChanged="LstSecArea_SelectedIndexChanged" class="form-control"></asp:ListBox>
                                                ...
                                                <div class="col-md-4 col-sm-4 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <asp:ListBox ID="LstSecBeat" runat="server" SelectionMode="Multiple" AutoPostBack="true" OnSelectedIndexChanged="LstSecBeat_SelectedIndexChanged" class="form-control"></asp:ListBox>
                                                ...
                                                <div class="col-md-4 col-sm-4 col-xs-12">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Retailers:</label>
                                                       
                                                        <asp:ListBox ID="LstSecPrsn" runat="server" SelectionMode="Multiple" AutoPostBack="true" class="form-control"></asp:ListBox>
                                ...
                                <asp:Repeater ID="TopRetailer" runat="server">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <tr>
                                            ...
                                            <td><%# Eval("EmpName")%></td>
                                            <asp:Label ID="lblEmpName" runat="server" Visible="false" Text='<%# Eval("EmpName")%>'></asp:Label>
                                            </td>      
                                                <td style="text-align: right"><%# Eval("Amt")%></td>
                                            <asp:Label ID="lblAmt" runat="server" Visible="false" Text='<%# Eval("Amt")%>'></asp:Label>
                                            </td>    
                                                <td style="text-align: right"><%# Eval("NewParties")%></td>
                                            <asp:Label ID="lblNewParties" runat="server" Visible="false" Text='<%# Eval("NewParties")%>'></asp:Label>
                                            </td>    
                                                <td style="text-align: right"><%# Eval("TotCallR")%></td>
                                            <asp:Label ID="lblTotCallR" runat="server" Visible="false" Text='<%# Eval("TotCallR")%>'></asp:Label>
                                            </td>  
                                                <td style="text-align: right"><%# Eval("ProdCallsR")%></td>
                                            <asp:Label ID="lblProdCallsR" runat="server" Visible="false" Text='<%# Eval("ProdCallsR")%>'></asp:Label>
                                            </td>                                                  
                                        </tr>
