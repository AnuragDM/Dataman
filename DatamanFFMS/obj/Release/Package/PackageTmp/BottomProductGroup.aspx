<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="BottomProductGroup.aspx.cs" Inherits="AstralFFMS.BottomProductGroup" %>
                        ...
                        <div id="InputWork">
                            ...
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Bottom Product Group</h3>                                 
                                </div>
                                <!-- /.box-header -->
                                <!-- form start -->
                                <div class="box-body">
                                ...
                                <asp:Repeater ID="Topsaleproduct" runat="server" OnItemCommand="Topsaleproduct_ItemCommand">     
                                    ...
                                    <ItemTemplate>
                                            ...
                                            <tr> 
                                             ...
                                             <asp:HiddenField ID="hdnitemid" runat="server" Value='<%#Eval("ProductGroupId")%>' />
                                                                           
                                            <td><%# Eval("ProductGroup")%>
                                            <asp:Label ID="lblProductGroup" runat="server" Visible="false" Text='<%# Eval("ProductGroup")%>'></asp:Label></td>
                                            <%--<td><%# Eval("Product")%>
