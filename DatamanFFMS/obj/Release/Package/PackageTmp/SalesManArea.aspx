   ...
   <%-- <script type="text/javascript">
    ...
    <script type="text/javascript">
        function Validate() {
            ...
            $("#<%=hidstate.ClientID%>").val(selectedValues);
                            ...
                            <div class="row">
                                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-9">
                                    <div class="row">
                                         ...
                                         <div class="col-md-3 col-sm-6 col-xs-12" id="divparent" runat="server" style="display: none;">
                                         ...
                                         <div class="col-md-3 col-sm-6 col-xs-12" id="div1" runat="server" style="display: none;">
                                ...
                                <%--    </div>
                                    <div class="row">--%>
                                         ...
                                         <div class="col-md-3 col-sm-6 col-xs-12" id="div2" runat="server" style="display: block;">
                                        ...
                                        <div class="col-md-3 col-sm-6 col-xs-12" >
                                            <div class="form-group">
                                                ...
                                                <asp:ListBox ID="lstCity" runat="server" SelectionMode="Multiple" OnSelectedIndexChanged="lstCity_SelectedIndexChanged"  AutoPostBack="true"></asp:ListBox>
                                            </div>
                                        </div>
                                         <div class="col-md-3 col-sm-6 col-xs-12" >
                                            <div class="form-group">
