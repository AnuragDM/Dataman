                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" runat="server" class="form-control" maxlength="50" id="MaterialGroup" placeholder="Enter Material Group" autocomplete="off">
                                    </div>
                                    </div>
                                 <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group" runat="server" visible="false">
                                        <label for="exampleInputEmail1">Item Code:</label>
                                        <input type="text" runat="server" class="form-control" maxlength="50" id="ItemCode" placeholder="Enter Item Code" autocomplete="off">
                                    </div>
                                    <div class="form-group">
