...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ddpartytypechange(e) {
            $('#<%=HiddenPartytypetext.ClientID%>').val(e.target.selectedOptions[0].text);
    ...
    <script type="text/javascript">
        function validate() {
            ...
            if ($('#<%=HiddenPartytypetext.ClientID%>').val() != "INSTITUTIONAL") {
        ...
        <%--    if ($('#<%=ddldistributor.ClientID%>').val() == "0" || $('#<%=ddldistributor.ClientID%>').val() == "") {
            ...
            //if ($('#<%=chkIsAdmin.ClientID%>').checked)
            if ($('#<%=chkIsAdmin.ClientID%>')[0].checked) {
                ...
                if ($('#<%=BlockReason.ClientID%>').val() == "") {
                        //   alert($('#<%=chkIsAdmin.ClientID%>').checked);
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-default">
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" runat="server" class="form-control" maxlength="50" id="PartyName" placeholder="Enter Party Name" autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Party Type:</label>&nbsp;&nbsp;<label for="requiredFields" style="color: red;">*</label>
                                        <asp:DropDownList ID="ddlpartytype" Width="100%" CssClass="form-control" runat="server" onchange="ddpartytypechange(event)">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12">
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddlArea" Width="100%" CssClass="form-control" runat="server" onchange="ddlAreaChange();"></asp:DropDownList>
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddldistributor" Width="100%" CssClass="form-control" runat="server"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="DdlIndustry" Width="100%" CssClass="form-control" runat="server"></asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Contact Person:</label>
                                        <input type="text" runat="server" class="form-control" maxlength="100" id="ContactPerson" placeholder="Enter Contact Person" autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Address Line 1:</label>&nbsp;&nbsp;<label for="requiredFields" style="color: red;">*</label>
                                        <input type="text" runat="server" class="form-control" maxlength="150" id="Address1" autocomplete="off" placeholder="Enter Address1">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    ...
                                    <input type="text" runat="server" class="form-control numeric text-right" maxlength="6" id="Pin" placeholder="Enter Pincode" onkeypress="javascript:return isNumber (event)" autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Mobile:</label>&nbsp;&nbsp;<label for="requiredFields" style="color: red;">*</label>
                                        <input type="text" runat="server" class="form-control numeric text-right" maxlength="10" id="Mobile" onkeypress="javascript:return isNumber (event)" placeholder="Enter Mobile" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" runat="server" class="form-control numeric text-right" maxlength="10" id="Phone" onkeypress="javascript:return isNumber (event)" placeholder="Enter Mobile" autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">GSTIN No:</label>
                                        <input type="text" runat="server" class="form-control" maxlength="50" id="GSTINNo" placeholder="Enter GSTIN No." autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">CST No:</label>
                                        <input type="text" runat="server" class="form-control" maxlength="50" id="CSTNo" placeholder="Enter CST No." autocomplete="off">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" runat="server" class="form-control" maxlength="50" id="VatTin" placeholder="Enter VATTIN" autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Service Tax Reg. No:</label>
                                        <input type="text" runat="server" class="form-control" maxlength="50" id="ServiceTax" placeholder="Enter Service Tax Reg. No." autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Potential:</label>
                                        <input type="text" runat="server" class="form-control numeric text-right" maxlength="8" id="Potential" placeholder="Enter Potential" autocomplete="off" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" runat="server" class="form-control" maxlength="50" id="PanNo" placeholder="Enter PAN No." autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Date of Anniversary:</label>
                                        <asp:TextBox ID="txtDOA" class="form-control" runat="server" Style="background-color: white;" AutoCompleteType="Disabled"></asp:TextBox>
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtDOB" class="form-control" runat="server" Style="background-color: white;" AutoCompleteType="Disabled"></asp:TextBox>
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Sync Id:</label><%--&nbsp;&nbsp;<label for="requiredFields" style="color: red;">*</label>--%><input type="text" runat="server" class="form-control" maxlength="50" id="SyncId" placeholder="Enter Sync Id" autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Remark:</label>
                                        <input type="text" runat="server" class="form-control" maxlength="500" id="Remark" placeholder="Enter Remark" autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12" id="imgdiv">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        <span id="divblock" runat="server" class="hidden">
                                            ...
                                            <input type="text" class="form-control" runat="server" maxlength="100" id="BlockReason" placeholder="Enter Block Reason" autocomplete="off"></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        <img id="imgpreview" width="200" src="" style="border-width: 0px; max-height: 132px !important; display: none; float: left;" runat="server" />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="box-footer">
                            ...
                            <asp:HiddenField ID="HiddenPartytypetext" runat="server" />
