<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="TopProductDetails.aspx.cs" Inherits="AstralFFMS.TopProductDetails" %>
                    ...
                    <div id="InputWork">
                        ...
                        <div class="box box-primary" style="margin-bottom:0px">
                            <div class="box-header with-border">
                                <h3 class="box-title">Top Product Details</h3>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                          ...
                                          <b>  <asp:Label ID="lblprodct" runat="server" Text='<%# Eval("ItemName")%>'></asp:Label> </b>
                                        </div>
                                    </div>
                                </div>
