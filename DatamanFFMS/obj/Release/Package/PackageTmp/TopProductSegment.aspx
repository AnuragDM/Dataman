<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="TopProductSegment.aspx.cs" Inherits="AstralFFMS.TopProductSegment" %>
                        ...
                        <div id="InputWork">
                            ...
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Products Segment Wise Sales</h3>
                                </div>
                                <!-- /.box-header -->
                                <!-- form start -->
                                <div class="box-body">
                                ...
                                <asp:Repeater ID="Topsaleproduct" runat="server" OnItemCommand="Topsaleproduct_ItemCommand">     
                                        ...
                                        <table id="itemsaleTable" class="table table-bordered table-striped">
                                            <thead>
                                                <tr>  
                                                    ...
                                                    <th style="text-align: left; width: 10%">Product Segment</th>
                                    ...
                                    <ItemTemplate>
                                            ...
                                            <tr> 
                                             ...
                                             <asp:HiddenField ID="hdnitemid" runat="server" Value='<%#Eval("ProductSegmentId")%>' />
                                                                           
                                            <td><%# Eval("ProductSegment")%>
                                            <asp:Label ID="lblProductGroup" runat="server" Visible="false" Text='<%# Eval("ProductSegment")%>'></asp:Label></td>
                                           <%-- <td><%# Eval("Product")%>
