<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="TotalCallsDetails.aspx.cs" Inherits="AstralFFMS.TotalCallsDetails" %>
                    ...
                    <div id="InputWork">
                        ...
                        <div class="box box-primary" style="margin-bottom: 0px">
                            <div class="box-header with-border">
                                <h3 class="box-title">Total Calls Details</h3>
                            </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Report For Total Calls :</label>&nbsp;&nbsp;
                                            <b>
                                                <asp:Label ID="lbltotalcalls" runat="server" Text='<%# Eval("SMName")%>'></asp:Label></b>
                                        </div>
                                        <%-- </div>--%>
                                    </div>
                                </div>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="box" style="border-top: 1px solid #f4f4f4;">
                        ...
                        <div class="box-body table-responsive">
                            ...
                            <asp:Repeater ID="Totalcalls" runat="server">
                                <HeaderTemplate>
                                ...
                                <ItemTemplate>
                                    ...
                                    <tr>
                                        ...
                                        <%--  --%>
                                        <td><%# Eval("PartyName")%>
                                            <asp:Label ID="lblName" runat="server" Visible="false" Text='<%# Eval("PartyName")%>'></asp:Label>
                                        </td>
                                        <td><%# Eval("Address1")%>
