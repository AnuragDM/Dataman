    ...
    ,
                          ...
                          <ajax:FilteredTextBoxExtender ID="txtaccu_FilteredTextBoxExtender" runat="server" Enabled="True" FilterType="Numbers" TargetControlID="txtaccu"></ajax:FilteredTextBoxExtender>
                               ...
                               <asp:GridView ID="gvData" runat="server" AutoGenerateColumns="False" BackColor="White" Visible="true"
                                    ...
                                    DataKeyNames="Id" EmptyDataText="No Records Found!!" CssClass="table table-responsive table-bordered" ClientIDMode="Static" Style=" overflow-x: scroll !important;">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Area" HeaderText="Location(Area)" ItemStyle-Width="450px" />
                                       <%-- <asp:BoundField DataField="image" HeaderText="Image" ItemStyle-Width="50px" />--%>
                                        <asp:TemplateField HeaderText="Image" ItemStyle-Width="20px">
                                            <ItemTemplate>
                                               
<%--                                                  <asp:Button Text="Show Image" ID="btnShow" runat="server" CssClass="btn btn-primary" OnClientClick="javascript:return openImage('Hello')" /> <button id='{0}' onclick='openImage(this.id)' > </button>--%>
                                                  <%--<asp:Button Text="Show Image" runat="server"  OnClientClick="javascript:return openImage('<%# Eval("image") %>')" /> --%>
       <%# Eval("image").ToString() == "N/A" ? "" : String.Format(" <a id='{0}'  class='fa fa-picture-o' style='color:#3C8DBC;width: 50px !important;cursor:pointer;' aria-hidden='true' onclick='openImage(this.id)' ></a>",Eval("image")) %>
                    ...
                    <!-- /.box -->
                       <div id="showImage" class="modal modal-dialog" style="height:99%;position: fixed !important;width: 100% !important;display: none;margin-top: 3px;">

                                <div class="modal-content"  style="height: 300px !important;overflow-x: auto !important;overflow-y: auto !important;width:300px !important;z-index: 999; margin-left: 37%;margin-top: 10%;"><%-- margin-left: 37%;--%>
                                    <div class="modal-header">
                                        <button id="ItemClose2" type="button" class="close" style="margin-top: -10px !important;color: #ec0404;">&times;</button>
                                    </div>
                                    <div id="showImage1" class="modal-body"></div>
