                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" runat="server" class="form-control" maxlength="100" id="Location" placeholder="Enter City Name" autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">STD Code:</label>&nbsp;&nbsp;
                                        <input type="text" runat="server" class="form-control numeric text-right" maxlength="5" id="StdCode" placeholder="Enter STD Code" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
