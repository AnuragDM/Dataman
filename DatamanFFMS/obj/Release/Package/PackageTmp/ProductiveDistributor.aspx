<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="ProductiveDistributor.aspx.cs" Inherits="AstralFFMS.ProductiveDistributor" %>
                        ...
                        <div id="InputWork">
                            ...
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Productive Distributor List</h3>
                                </div>
                                <!-- /.box-header -->
                                <!-- form start -->
                                <div class="box-body">
                            ...
                            <div class="box-header table-responsive">
                                <asp:Repeater ID="rptnewrtl" runat="server">
                                    ...
                                    <ItemTemplate>                                          
                                             <tr>                                        
                                                <td><%# Eval("Distributor")%>
                                                <asp:Label ID="lblName" runat="server" Visible="false" Text='<%# Eval("Distributor")%>'></asp:Label> </td>      
                                                <td><%# Eval("Address1")%>
