<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="CoupanAvailabilityReport.aspx.cs" Inherits="AstralFFMS.CoupanAvailabilityReport" %>
                                ...
                                <ItemTemplate>
                                    <tr>
                                      <td><%#Eval("SyncId") %></td>
                                          ...
                                          <td><%#Eval("AvailableCoupons") %></td>
                                       <%-- <td><asp:LinkButton ID="lnkedit"  runat="server" Text='<%#Eval("coupanissued") %>'  CommandName="coupanissued" CommandArgument='<%#Eval("coupanissued")%>'></asp:LinkButton></td>
                                        <td><asp:LinkButton ID="LinkButton1"  runat="server" Text='<%#Eval("COUPANAVAILABLE") %>'  CommandName="COUPANAVAILABLE" CommandArgument='<%#Eval("COUPANAVAILABLE")%>'></asp:LinkButton></td>--%>
                                    </tr>
                                </ItemTemplate>
                                <FooterTemplate>
                                    </tbody>     </table>       
