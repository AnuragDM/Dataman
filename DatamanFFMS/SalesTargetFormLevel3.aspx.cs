...
{
    public partial class SalesTargetFormLevel3 : System.Web.UI.Page
    {
        ...
        private void fillUserType()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                btnsave.Visible = false;
                // lblPartTypeName.Visible = false;
                GridView1.HeaderRow.Cells[2].Text = "Assign to Team";
                GridView1.HeaderRow.Cells[3].Text = "Assigned by State Head";
                GridView1.HeaderRow.Cells[4].Text = "Assigned by  District Head";
                GridView1.HeaderRow.Cells[5].Text = "Assigned by City Head";
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (lk != null)
                {
                    ...
                    {
                        s = @"select * from SalesTragetFromHO Where  PartyTypeId=" + hid.Value + " and SMID=" + Settings.Instance.UserID + " and SalesYear='" + txtcurrentyear.SelectedItem.Text + "'  and Isnull(Itemtype,'Group')='" + itemgroupRadioButtonlst.SelectedValue + "' and Isnull(TargetFor,'Amount')='" + targetRadioButtonList.SelectedValue + "'";
                    }
                    else
                    {
                        s = @"select * from SalesTragetFromHO Where  PartyTypeId=" + hid.Value + " and SMID=" + Settings.Instance.UserID + " and SalesYear='" + txtcurrentyear.SelectedItem.Text + "'  and Isnull(Itemtype,'Group')='" + itemgroupRadioButtonlst.SelectedValue + "' and Isnull(TargetFor,'Amount')='" + targetRadioButtonList.SelectedValue + "' and Unit='" + ddlunit.SelectedItem.Text + "'";
                    }
        ...
        protected void btnsave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    DbConnectionDAL.ExecuteNonQuery(CommandType.Text, s);
                    unittext = ddlunit.SelectedItem.Text;
               ...
               // string s = "delete from SalesTragetFromHO Where AssignedByID=" + Settings.DMInt32(Settings.Instance.UserID) + " and  PartyTypeId=" + Settings.DMInt32(lblPartTypeID.Text) + " and SalesYear='" + txtcurrentyear.SelectedItem.Text + "' and Isnull(Itemtype,'Group')='" + itemgroupRadioButtonlst.SelectedValue + "' and Isnull(TargetFor,'Amount')='" + targetRadioButtonList.SelectedValue + "'";
                ...
                for (int i = 0; i < GridView2.Rows.Count; i++)
                {
                    ...
                    int RetSave = MT.Insert(docID, Settings.DMInt32(lblPartTypeID.Text), Settings.DMDecimal(jan.Text), Settings.DMDecimal(feb.Text), Settings.DMDecimal(mar.Text), Settings.DMDecimal(apr.Text), Settings.DMDecimal(may.Text), Settings.DMDecimal(jun.Text), Settings.DMDecimal(jul.Text), Settings.DMDecimal(aug.Text), Settings.DMDecimal(spt.Text), Settings.DMDecimal(oct.Text), Settings.DMDecimal(nov.Text), Settings.DMDecimal(dec.Text), Settings.DMInt32(hidPartyId.Value), i + 1, Settings.DMInt32(Settings.Instance.UserID), txtcurrentyear.SelectedItem.Text, itemgroupRadioButtonlst.SelectedValue, targetRadioButtonList.SelectedValue, unittext);
                }
        ...
        {
            Response.Redirect("~/SalesTargetFormLevel3.aspx");
        }
        ...
        protected void GridView2_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
              ...
              //  string srty = "select * from SalesTragetFromHO where SMID=" + Settings.DMInt32(PartyId.Value) + " and PartyTypeId=" + lblPartTypeID.Text + " and SalesYear='" + txtcurrentyear.SelectedItem.Text + "' and Isnull(Itemtype,'Group')='" + itemgroupRadioButtonlst.SelectedValue + "' and Isnull(TargetFor,'Amount')='" + targetRadioButtonList.SelectedValue + "'";
