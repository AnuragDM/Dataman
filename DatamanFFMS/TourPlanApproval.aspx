<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="TourPlanApproval.aspx.cs" Inherits="AstralFFMS.TourPlanApproval" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        function DoNav(msgUrl) {
            if (msgUrl != "") {
                window.location.href = msgUrl + "&Page=" + 'TOURAPPROVAL';
            }
        }
    </script>
                    ...
                    <div id="InputWork">
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                               <%-- <h3 class="box-title">Tour Approval</h3>--%>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body table-responsive">
                            <asp:Repeater ID="rpt" runat="server">
                                ...
                                <ItemTemplate>
                                    <tr onclick="DoNav('<%#"TourPlan.aspx?SMId="+Eval("SMId")+"&DocId="+Eval("DocId") %>');">
