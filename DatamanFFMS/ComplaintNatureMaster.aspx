...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        function validate() {
            if ($('#<%=ComplNatName.ClientID%>').val() == "") {
                errormessage("Please enter Complaint Nature");
                return false;
            }

            if ($('#<%=ddldept.ClientID%>').val() == "0" || $('#<%=ddldept.ClientID%>').val() == "") {
                errormessage("Please Select Department");
                return false;
            }

            if ($('#<%=ddlNatreType.ClientID%>').val() == "0" || $('#<%=ddlNatreType.ClientID%>').val() == "") {
                errormessage("Please Select Nature Type");
                return false;
            }

             if ($('#<%=EmailTo.ClientID%>').val() == "") {
                errormessage("Please enter Email Id");
                return false;
            }
           
            //document.getElementById("<%=HiddenUnderID.ClientID%>").value = $('#<%=ddldept.ClientID%>').val();
        }
    </script>
    <script type="text/javascript">
        var V1 = "";
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input runat="server" type="text" class="form-control" maxlength="100" id="ComplNatName" placeholder="Enter Complaint Nature name" autocomplete="off">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" maxlength="50" id="EmailTo" placeholder="Enter Email To" runat="server" autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Email CC:</label>
                                        <input type="text" class="form-control" maxlength="50" id="EmailCC" placeholder="Enter Email CC" runat="server" autocomplete="off"/>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
