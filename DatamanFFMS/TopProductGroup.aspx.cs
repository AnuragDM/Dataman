...
{
    public partial class TopProductGroup : System.Web.UI.Page
    {
        string roleType = "";
        int cnt = 0;
        string orderType = "";
        ...
        protected void btnGo_Click(object sender, EventArgs e)
        {
            ...
            if (smIDStr1 != "")
            {
                ...
                string query = "SELECT TOP " + txt_noofrecords.Text + " ProductGroupId,ProductGroup,convert(int,sum(Qty)) [Qty],convert(Numeric(38, 2), sum(Amount)) [Amount] FROM(SELECT pg.ItemId as ProductGroupId,pg.ItemName [ProductGroup],convert(int,(os.Qty)) [Qty],convert(Numeric(38, 2), (os.Qty * os.Rate)) [Amount] From  TransOrder1 os left JOIN MastItem i ON os.ItemId = i.ItemId ";
                query = query + "left JOIN MastItem pg ON pg.ItemId = i.Underid " + Qrychk + " " + QueryMatGrp + " Union All SELECT pg.ItemId as ProductGroupId,pg.ItemName [ProductGroup],convert(int,(os.Qty)) [Qty],convert(Numeric(38, 2), (os.Qty * os.Rate)) [Amount] From Temp_TransOrder1 os left JOIN MastItem i ON os.ItemId = i.ItemId ";
        ...
        {
            Response.Redirect("~/TopProductGroup.aspx");
        }
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=TopProductGroup.csv");
        ...
        protected void Topsaleproduct_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            if (e.CommandName == "select")
            {
                ...
                Response.Redirect("TopProductGroupDetails.aspx?itemid=" + hdnitemid.Value + "&FromDate=" + ViewState["Fromdate"] + "&ToDate=" + ViewState["Todate"] + "&smidstr='" + ViewState["smIDStr1"].ToString() + "'");
            }
        }
    }
}