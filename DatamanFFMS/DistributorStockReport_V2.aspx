<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" EnableEventValidation="false"CodeBehind="DistributorStockReport_V2.aspx.cs" Inherits="AstralFFMS.DistributorStockReport_V2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function BindGridViewDistwise() {
            $.post('<%=ResolveUrl("DistributorStockReport_V2.aspx/getdistWisestock1")%>', { "DistId": $("#<%=hiddistributor.ClientID%>").val(), "Date": $('#<%=txtfmDate.ClientID%>').val() }, function (response) {
        ...
        function BindGridView() {
            $.post('<%=ResolveUrl("DistributorStockReport_V2.aspx/getdiststock1")%>', { "DistId": $("#<%=hiddistributor.ClientID%>").val(), "Fromdate": $('#<%=txtfmDate.ClientID%>').val(), "Todate": $('#<%=txttodate.ClientID%>').val() }
                , function (result) {
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12" id="todate" runat="server">
                                    <div class="form-group">
                          ...
                          <div class="clearfix"></div>
                            <div class="box-footer">
                                <div class="form-group">
                                    ...
                                    <asp:Button ID="Cancel" CssClass="btn btn-primary button1" Text="Cancel" OnClick="Cancel_Click" runat="server" />
