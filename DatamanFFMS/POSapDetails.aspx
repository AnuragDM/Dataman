<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="POSapDetails.aspx.cs" Inherits="AstralFFMS.POSapDetails" %>
                               ...
                               <%-- <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-12" style="color: #169434; font-family: Arial; font-weight: bold;">
                                         Order No. <asp:Label ID="lblOrderSt" runat="server" Text=""></asp:Label> | 
                                         Ref No. <asp:Label ID="lblRefNo" runat="server" Text=""></asp:Label> |
                                        ...
                                        <asp:GridView ID="gvDetails" ShowFooter="True" runat="server" class="table table-bordered table-striped" AutoGenerateColumns="False">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Pending Quantity">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtRemarks" TabIndex="4" runat="server" Width="280px" Enabled="false" MaxLength="255" class="form-control" Text='<%#Eval("PendingQty") %>'></asp:TextBox>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div style="float: left;">
                                            <asp:Button ID="Add" runat="server" Text="Add New Product" class="btn btn-primary" Enabled="false" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <asp:TextBox ID="Remarks" TabIndex="8" Width="100%" runat="server" class="form-control" TextMode="MultiLine" Enabled="false"
                                            placeholder="Enter Remarks" Height="180px"></asp:TextBox>
