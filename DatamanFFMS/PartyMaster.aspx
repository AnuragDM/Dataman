<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="PartyMaster.aspx.cs" Inherits="AstralFFMS.PartyMaster" EnableEventValidation="false" %>
                        ...
                        <div class="box-body">
                            <div class="col-md-12">
                                ...
                                <div class="form-group formlay">
                                    ...
                                    <asp:DropDownList ID="ddlBeat" Width="100%" CssClass="form-control" runat="server" TabIndex="10"></asp:DropDownList>
                                </div>
                                <div class="form-group formlay">
                                    <label for="exampleInputEmail1">Distributor Name:</label>&nbsp;&nbsp;<label for="requiredFields" style="color: red;">*</label>
                                    <asp:DropDownList ID="ddldistributor" Width="100%" CssClass="form-control" runat="server" TabIndex="14"></asp:DropDownList>
                                </div>
                                <div class="form-group formlay">
                                    <label for="exampleInputEmail1">Industry:</label>&nbsp;&nbsp;<label for="requiredFields" style="color: red;">*</label>
                                    <asp:DropDownList ID="DdlIndustry" Width="100%" CssClass="form-control" runat="server" TabIndex="16"></asp:DropDownList>
                                </div>
                                <div class="form-group formlay">
                                    <label for="exampleInputEmail1">Contact Person:</label>
                                    <input type="text" runat="server" class="form-control" maxlength="100" id="ContactPerson" placeholder="Enter Contact Person" tabindex="18">
                                </div>
                                <div class="form-group formlay">
                                    <label for="exampleInputEmail1">Address Line 1:</label>&nbsp;&nbsp;<label for="requiredFields" style="color: red;">*</label>
                                    <input type="text" runat="server" class="form-control" maxlength="150" id="Address1" tabindex="22" placeholder="Enter Address1">
                                </div>
                                <div class="form-group formlay">
                                    <label for="exampleInputEmail1">Address Line 2:</label>
                                    <input type="text" runat="server" class="form-control" maxlength="150" id="Address2" placeholder="Enter Address2" tabindex="24">
                                </div>
                                <div class="form-group formlay">
                                    <label for="exampleInputEmail1">Pincode:</label>&nbsp;&nbsp;<label for="requiredFields" style="color: red;">*</label>
                                    <input type="text" runat="server" class="form-control numeric text-right" maxlength="6" id="Pin" placeholder="Enter Pincode" onkeypress="javascript:return isNumber (event)" tabindex="26">
                                </div>
                                <div class="form-group formlay">
                                    <label for="exampleInputEmail1">Mobile:</label>&nbsp;&nbsp;<label for="requiredFields" style="color: red;">*</label>
                                    <input type="text" runat="server" class="form-control numeric text-right" maxlength="10" id="Mobile" onkeypress="javascript:return isNumber (event)" placeholder="Enter Mobile" tabindex="28">
                                </div>
                                <div class="form-group formlay">
                                    <label for="exampleInputEmail1">Phone:</label>&nbsp;&nbsp;<label for="requiredFields" style="color: red;"></label>
                                    <input type="text" runat="server" class="form-control numeric text-right" maxlength="10" id="Phone" onkeypress="javascript:return isNumber (event)" placeholder="Enter Mobile" tabindex="30">
                                </div>
                                <div class="form-group formlay">
                                    <label for="exampleInputEmail1">CST No:</label>
                                    <input type="text" runat="server" class="form-control" maxlength="50" id="CSTNo" placeholder="Enter CST No." tabindex="33">
                                </div>
                                <div class="form-group formlay">
                                    <label for="exampleInputEmail1">VAT TIN No.:</label>
                                    <input type="text" runat="server" class="form-control" maxlength="50" id="VatTin" placeholder="Enter VATTIN" tabindex="36">
                                </div>

                                <div class="form-group formlay">
                                    <label for="exampleInputEmail1">Service Tax Reg. No:</label>
                                    <input type="text" runat="server" class="form-control" maxlength="50" id="ServiceTax" placeholder="Enter Service Tax Reg. No." tabindex="38">
                                </div>
                                <div class="form-group formlay">
                                    <label for="exampleInputEmail1">Potential:</label>
                                    <input type="text" runat="server" class="form-control numeric text-right" maxlength="8" id="Potential" placeholder="Enter Potential" tabindex="40" />
                                </div>
                                <div class="form-group formlay">
                                    <label for="exampleInputEmail1">PAN No:</label>
                                    <input type="text" runat="server" class="form-control" maxlength="50" id="PanNo" placeholder="Enter PAN No." tabindex="42">
                                </div>
                                <div class="form-group formlay">
                                ...
                                <div class="form-group formlay">
                                    ...
                                    <input type="text" runat="server" class="form-control" maxlength="500" id="Remark" placeholder="Enter Remark" tabindex="46">
                                </div>
                                 <div class="form-group formlay">
                                ...
                                <div class="form-group formlay">
                                    ...
                                    <input id="chkIsAdmin" runat="server" type="checkbox" checked="checked" class="checkbox" tabindex="48" />
