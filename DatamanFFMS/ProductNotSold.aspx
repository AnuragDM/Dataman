<%@ Page Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="ProductNotSold.aspx.cs" Inherits="AstralFFMS.ProductNotSold" %>
                    ...
                    <div class="col-md-12">
                        <div id="InputWork">
                            ...
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <%--  <h3 class="box-title">Product Not Sold</h3>--%>
                                    <h3 class="box-title">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-sm-4 col-xs-12" style="display: none">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="txt_noofdays" runat="server" Width="100%" CssClass="form-control" Style="background-color: white;">99</asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <div id="1" class="form-group">
                                                <label for="exampleInputEmail1">From Date:</label>
                                                <asp:TextBox ID="txtfromdate" runat="server" Width="100%" CssClass="form-control" Style="background-color: white;"></asp:TextBox>
                                                <ajaxToolkit:CalendarExtender ID="CalendarExtender2" CssClass="orange" Format="dd/MMM/yyyy" TargetControlID="txtfromdate" runat="server" />
                                            </div>
                                        </div>
                                        <%-- <div class="col-md-1"></div>--%>
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <div id="DIV1" class="form-group">
                                                ...
                                                <asp:TextBox ID="txtasondate" runat="server" Width="100%" CssClass="form-control" Style="background-color: white;"></asp:TextBox>
                                                <ajaxToolkit:CalendarExtender ID="CalendarExtender1" CssClass="orange" Format="dd/MMM/yyyy" TargetControlID="txtasondate" runat="server" />
                                            </div>
                                        </div>
                        ...
                        <div id="rptmain" runat="server">
                            <div class="box-header table-responsive">
                                <asp:Repeater ID="rptPNotSold" runat="server">
                                    <HeaderTemplate>
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <tr>
                                            ...
                                            <td><%# Eval("Group")%>
                                                <asp:Label ID="lblGroup" runat="server" Visible="false" Text='<%# Eval("Group")%>'></asp:Label></td>
                                            <td><%# System.Convert.ToDateTime(Eval("LastSoldOn")).ToString("dd/MMM/yyyy")%>
                                                <%--<asp:Label ID="lblLSoldOn" runat="server" Visible="false" Text='<%# Eval("LastSoldOn")%>'></asp:Label></td>--%>
                                                <asp:Label ID="lblLSoldOn" Visible="false" runat="server" Text='<%# System.Convert.ToDateTime(Eval("LastSoldOn")).ToString("dd/MMM/yyyy")%>'></asp:Label></td>
                                        </tr>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        </tbody>     </table>       
