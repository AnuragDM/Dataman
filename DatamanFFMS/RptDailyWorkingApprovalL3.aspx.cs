...
{
    public partial class RptDailyWorkingApprovalL3 : System.Web.UI.Page
    {
         int smID = 0;
         int msg = 0;
        ...
        {
            Response.Redirect("~/RptDailyWorkingApprovalL3.aspx");
        }
