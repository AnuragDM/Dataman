<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="AttendanceReport.aspx.cs" Inherits="AstralFFMS.AttendanceReport" %>
                ...
                <div class="col-md-12">
                    <div id="InputWork">
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body" id="div1">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12" style="margin-top: 15px;">
                                        <label for="exampleInputEmail1">Consider Approval System:</label><br />
                            ...
                            <div id="noteDiv" runat="server" style="display: none; padding: 10px;">
