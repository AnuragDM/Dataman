<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="DepartmentMaster.aspx.cs" Inherits="AstralFFMS.DepartmentMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        function validate() {
            if ($('#<%=DepName.ClientID%>').val() == "") {
                errormessage("Please enter Department Name.");
                return false;
            }

            var value = ($('#<%=DepName.ClientID%>').val().charAt(0));
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var valLength = "";
            $('#<%=DepName.ClientID%>').keypress(function (key) {

                valLength = ($('#<%=DepName.ClientID%>').val().length + 1);
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <label for="exampleInputEmail1">Department Name:</label>&nbsp;&nbsp;<label for="requiredFields" style="color: red;">*</label>
                                        <input runat="server" type="text" class="form-control" maxlength="100" id="DepName" placeholder="Enter Department Name" autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
