...
{
    public partial class NewRetailerReport : System.Web.UI.Page
    {
        string roleType = "";
        int cnt = 0;
        ...
        {
            Response.Redirect("~/NewRetailerReport.aspx");
        }
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=NewRetailers.csv");
