<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="rptBrandwiseSecondarySales.aspx.cs" Inherits="AstralFFMS.rptBrandwiseSecondarySales" %>
                    ...
                    <div class="col-md-12">
                        <div id="InputWork">
                            ...
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                   <%-- <h3 class="box-title">Brandwise Secondary Sales Report</h3>--%>
                        ...
                        <div id="rptmain" runat="server">
                            <div class="box-header table-responsive">                              
                                ...
                                <asp:Repeater ID="TopRetailer" runat="server" OnItemDataBound="TopRetailer_ItemDataBound">        
                                    <HeaderTemplate>
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="text-align:right">
                                                        <asp:Label ID="lblMonth1" runat="server" Font-Bold = "true" />
                                                    </th>  
                                                    <th style="text-align:right">
                                                        <asp:Label ID="lblMonth2" runat="server" Font-Bold = "true" />
                                                    </th>
                                                    <th style="text-align:right">
                                                        <asp:Label ID="lblMonth3" runat="server" Font-Bold = "true" />
                                                    </th>    
                                                    <th style="text-align:right">
                                                        <asp:Label ID="lblMonth4" runat="server" Font-Bold = "true" />
                                                    </th>    
                                                    <th style="text-align:right">
                                                        <asp:Label ID="lblMonth5" runat="server" Font-Bold = "true" />
                                                    </th>    
                                                    <th style="text-align:right">
                                                        <asp:Label ID="lblMonth6" runat="server" Font-Bold = "true" />
                                                    </th>    
                                                    <th style="text-align:right">
                                                        <asp:Label ID="lblMonth7" runat="server" Font-Bold = "true" />
                                                    </th>                                                     
         ...
         $(function () {
             $('#itemsaleTable').dataTable({
                 ...
                 "footerCallback": function (tfoot, data, start, end, display) {
                     ...
                     debugger;                                 
                     var costColumnIndex = $('th').filter(function (i) { return $(this).text() == 'Dec'; }).first().index();                    
