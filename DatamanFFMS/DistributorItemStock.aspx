<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="DistributorItemStock.aspx.cs" Inherits="AstralFFMS.DItemStock" %>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="col-lg-2 col-md-1 col-sm-8 paddingleft0" style="float: right">
                                               <%--<asp:Button ID="btnBack" runat="server" Text="Back" Style="margin-right: 5px; margin-bottom: 5px;" class="btn btn-primary"  OnClick="btnBack_Click" />--%>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body" style="display:none;">
                            <div class="col-lg-9 col-md-9 col-sm-7 col-xs-9">
                                <div class="col-md-12 paddingleft0" style="display:none;">
                                    <div id="DIV1" class="form-group col-md-3"  hidden="hidden">
                                        <label for="exampleInputEmail1">Visit Date:</label>
                                        <asp:TextBox ID="txtmDate" runat="server" Style="background: white;" CssClass="form-control" Enabled="false"></asp:TextBox>
                                     ...
                                     <Columns>
                                         <asp:TemplateField HeaderText="S No" ItemStyle-Width="3%">
                                            <ItemTemplate>
                                             ...
                                             <asp:TemplateField HeaderText="Case" ItemStyle-Width="10%">
                                                    <ItemTemplate>
                                                    <asp:TextBox runat="server" ID="txtquantity" placeholder="Enter Case Quantity" AutoPostBack="true"   Text='<%#Eval("Cases") %>' CssClass="form-control numeric text-right" OnTextChanged="txtquantity_TextChanged"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                               <asp:TemplateField HeaderText="Unit" ItemStyle-Width="10%">
                                                    <ItemTemplate>
                                                        <asp:TextBox runat="server" ID="txtLooseQty" placeholder="Enter Loose Qty"  AutoPostBack="true"  CssClass="form-control numeric text-right" Text='<%#Eval("unit") %>' OnTextChanged="txtCaseQty_TextChanged"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Stock" ItemStyle-Width="10%">
                                                    <ItemTemplate>
