                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtDate" runat="server" CssClass="form-control" Style="background-color: white;" AutoCompleteType="Disabled"></asp:TextBox>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" runat="server" class="form-control" maxlength="50" id="description" placeholder="Enter description" autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Geo Type:</label>&nbsp;&nbsp;<label for="requiredFields" style="color: red;">*</label>
                                        <asp:DropDownList ID="ddlGeoType" Width="100%" CssClass="form-control" runat="server" onchange="BindGeoName();">
                                            <%--//AutoPostBack="true"  OnSelectedIndexChanged="ddlGeoType_SelectedIndexChanged"--%>
