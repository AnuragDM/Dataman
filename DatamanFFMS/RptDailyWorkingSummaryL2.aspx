<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="RptDailyWorkingSummaryL2.aspx.cs" Inherits="AstralFFMS.RptDailyWorkingSummaryL2" %>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box-header with-border">
                            <%-- <h3 class="box-title">Daily Working Summary L2</h3>--%>
                            <h3 class="box-title">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlDsrType" runat="server" Width="99%" class="form-control">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlType" runat="server" Width="99%" class="form-control">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlStatus" runat="server" Width="99%" class="form-control">
                                                <asp:ListItem Text="All" Value="3"></asp:ListItem>
                        ...
                        <asp:Repeater ID="rpt" runat="server" OnItemDataBound="rpt_ItemDataBound" OnItemCommand="rpt_ItemCommand">
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="max-width: 200px !important; overflow-x: hidden;">City</th>
                                            <th style="max-width: 200px !important; overflow-x: hidden;">Beat</th>
                                            <th style="text-align: right">Total Retailer</th>
                                            <th style="text-align: right">Retailer Visited</th>
                                            <th style="text-align: right">Retailer Productive Calls</th>
                                            <th style="text-align: right">Total Order</th>
                                            <th style="text-align: right">Demo</th>
                                            <th style="text-align: right">Non-Productive</th>
                                            <th style="text-align: right">Competitor</th>
                                            <th style="text-align: right">Ret. Discuss</th>
                                            <th style="text-align: right">Retailer Collection</th>
                                            <th style="text-align: right">New Retailer</th>
                                            <th style="text-align: right">Productive Retailer Avg Call Sale</th>
                                            <th style="text-align: right">Claim Exp.</th>
                                            <th style="text-align: right">Approved Exp.</th>

                                            <th style="text-align: right">Dist. Discuss</th>
                                            <th style="text-align: right">Dist. Non-Productive</th>
                                            <th style="text-align: right">Dist. Collection</th>
                                            <th>Prospect Distributor</th>
                                            <th>Start DSR Time</th>
                                            <th>First Call</th>
                                            <th>Last Call</th>
                                            <th>Status</th>
                                            <th>DSR Type</th>
                                            ...
                                            <th style="display: none;">Sync Id</th>
                                            ...
                                            <%--<th style="text-align: right">Total Distance Travelled</th>--%>
                                            <th>With Whom</th>
                                        </tr>
                                    </thead>
                                    <tfoot>
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <asp:HiddenField ID="hdncityname" runat="server" Value='<%#Eval("cityname")%>' />
                                    <td style="display: none;"><%# System.Convert.ToDateTime(Eval("VDate")).ToString("dd/MMM/yyyy")%>
                                    ...
                                    <td style="display: none;"><%# Eval("EmpName")%>
                                        <%-- Added 06-06-2016 - Abhishek --%>
                                    ...
                                    <td style="max-width: 200px !important; overflow-x: hidden;">
                                        ...
                                        <asp:LinkButton CssClass="ShortDesc1" runat="server" ToolTip="Show Full City Name" Text='<%# Eval("cityname")%>'></asp:LinkButton>

                                    </td>
                                    <td style="max-width: 200px !important; overflow-x: hidden;">
                                        <asp:Label ID="lblbeat" runat="server" Text='<%# Eval("beatname")%>' CssClass="aVis"></asp:Label>
                                        <asp:LinkButton Class="ShortDesc2" runat="server" ToolTip="Show Full Beat Name" Text='<%# Eval("beatname")%>'></asp:LinkButton>
                                    ...
                                    <td style="text-align: right"><%# Eval("RetailerProCalls")%>
                                        <asp:Label ID="lblRetailerProCalls" runat="server" Visible="false" Text='<%# Eval("RetailerProCalls")%>'></asp:Label>
                                    ...
                                    <td><%# Eval("ProsDist")%>
                                        <%-- Added 06-06-2016 - Abhishek --%>
                                        <asp:Label ID="lblpros" runat="server" Visible="false" Text='<%# Eval("ProsDist")%>'></asp:Label>
                                        <%-- End --%>
                                    </td>
                                    <td><%# Eval("Dsr_Time")%>
                                        <asp:Label ID="lbldsrtme" runat="server" Visible="false" Text='<%# Eval("Dsr_Time")%>'></asp:Label></td>
                                    <td><%# Eval("FirstCall")%>
                                        <asp:Label ID="lblFirstCall" runat="server" Visible="false" Text='<%# Eval("FirstCall")%>'></asp:Label></td>
                                    <td><%# Eval("LastCall")%>
                                        <asp:Label ID="lblLastCall" runat="server" Visible="false" Text='<%# Eval("LastCall")%>'></asp:Label></td>
                                    ...
                                    <td style="display: none;"><%# Eval("SyncId")%>
                                        <%-- Added 06-06-2016 - Abhishek --%>
...
HttpUtility.UrlEncode(Eval("Id").ToString()), HttpUtility.UrlEncode(Eval("VDate").ToString())) %>'
                                        ...
                                        <%--<asp:HyperLink ID="hpl" runat="server" NavigateUrl="~/LastLivePosition.aspx" Text="Details" Target="_blank" ToolTip="Live Map"></asp:HyperLink>--%>
                                        <asp:HyperLink ID="hpl" runat="server" NavigateUrl='<%# string.Format("~/LastLivePosition.aspx?Smid={0}&VDate={1}",HttpUtility.UrlEncode(Eval("Id").ToString()), HttpUtility.UrlEncode(Eval("VDate").ToString())) %>'
                                            Text="Details" Target="_blank" ToolTip="Live Map"></asp:HyperLink>
                                    </td>
                                   ...
                                   <%-- <td><%# Eval("NewColumn")%>
                                        <asp:Label ID="lblNewColumn" runat="server" Visible="false" Text='<%# Eval("NewColumn")%>'></asp:Label>
                                    </td>--%>
                                    <td><%# Eval("WithWhom")%>
                                        <asp:Label ID="lblWithWhom" runat="server" Visible="false" Text='<%# Eval("WithWhom")%>'></asp:Label>
                                    </td>
    ...
    <div id="popupdivbeatname" style="display: none">
        <table style="width: 100%;">
            <tbody>
                <tr>
                    <td>
                        <label class="">Beat Name:</label>

                    </td>
                    <td>
                        <label style="font-size: small; align-content: stretch;" id="lblshowbeatname"></label>
                    </td>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#example1 .ShortDesc2').click(function () {
                var currentRow = $(this).parents("tr");
                var Cityname = currentRow.find("span[id*='lblbeat']").text();
                $("#lblshowbeatname").text(Cityname);
                $("#popupdivbeatname").dialog({
                    title: "Beat Name",
                    width: 500,
                    height: 200,
                    modal: true,
        ...
        $(function () {
            $('#example1').dataTable({
                ...
                "footerCallback": function (tfoot, data, start, end, display) {
                    ...
                    var costColumnIndex = $('th').filter(function (i) { return $(this).text() == 'Total Retailer'; }).first().index();
                    ...
                    var RCVColumnIndex = $('th').filter(function (i) { return $(this).text() == 'Retailer Productive Calls'; }).first().index();
                    var totalDataRCV = api.column(RCVColumnIndex).data();
                    var totalRCV = totalDataRCV.reduce(function (a, b) { return intVal(a) + intVal(b); }, 0).toFixed(2);
                    var pageTotalDataRCV = api.column(RCVColumnIndex, { page: 'current' }).data();
                    var pageTotalRCV = pageTotalDataRCV.reduce(function (a, b) { return intVal(a) + intVal(b); }, 0).toFixed(2);
                    var searchTotalDataRCV = api.column(RCVColumnIndex, { 'filter': 'applied' }).data();
                    var searchTotalRCV = searchTotalDataRCV.reduce(function (a, b) { return intVal(a) + intVal(b); }, 0).toFixed(2);
                    $(api.column(8).footer()).html(searchTotalRCV);
                    ...
                    $(api.column(9).footer()).html(searchTotalTO);
                    ...
                    var costColumnIndex1 = $('th').filter(function (i) { return $(this).text() == 'Non-Productive'; }).first().index();
                    var totalData1 = api.column(costColumnIndex1).data();
                    var total1 = totalData1.reduce(function (a, b) { return intVal(a) + intVal(b); }, 0).toFixed(2);
                    var pageTotalData1 = api.column(costColumnIndex1, { page: 'current' }).data();
                    var pageTotal1 = pageTotalData1.reduce(function (a, b) { return intVal(a) + intVal(b); }, 0).toFixed(2);
                    var searchTotalData1 = api.column(costColumnIndex1, { 'filter': 'applied' }).data();
                    var searchTotal1 = searchTotalData1.reduce(function (a, b) { return intVal(a) + intVal(b); }, 0).toFixed(2);
                    $(api.column(11).footer()).html(searchTotal1);
                    ...
                    var costColumnIndex1 = $('th').filter(function (i) { return $(this).text() == 'Ret. Discuss'; }).first().index();
                    var totalData1 = api.column(costColumnIndex1).data();
                    var total1 = totalData1.reduce(function (a, b) { return intVal(a) + intVal(b); }, 0).toFixed(2);
                    var pageTotalData1 = api.column(costColumnIndex1, { page: 'current' }).data();
                    var pageTotal1 = pageTotalData1.reduce(function (a, b) { return intVal(a) + intVal(b); }, 0).toFixed(2);
                    ...
                    var costColumnIndex1 = $('th').filter(function (i) { return $(this).text() == 'Retailer Collection'; }).first().index();
                    var totalData1 = api.column(costColumnIndex1).data();
                    var total1 = totalData1.reduce(function (a, b) { return intVal(a) + intVal(b); }, 0).toFixed(2);
                    var pageTotalData1 = api.column(costColumnIndex1, { page: 'current' }).data();
                    var pageTotal1 = pageTotalData1.reduce(function (a, b) { return intVal(a) + intVal(b); }, 0).toFixed(2);
                    ...
                    var costColumnIndex1 = $('th').filter(function (i) { return $(this).text() == 'New Retailer'; }).first().index();
                    var totalData1 = api.column(costColumnIndex1).data();
                    var total1 = totalData1.reduce(function (a, b) { return intVal(a) + intVal(b); }, 0).toFixed(2);
                    var pageTotalData1 = api.column(costColumnIndex1, { page: 'current' }).data();
                    var pageTotal1 = pageTotalData1.reduce(function (a, b) { return intVal(a) + intVal(b); }, 0).toFixed(2);
                    ...
                    var costColumnIndex1 = $('th').filter(function (i) { return $(this).text() == 'Dist. Non-Productive'; }).first().index();
                    var totalData1 = api.column(costColumnIndex1).data();
                    var total1 = totalData1.reduce(function (a, b) { return intVal(a) + intVal(b); }, 0).toFixed(2);
                    var pageTotalData1 = api.column(costColumnIndex1, { page: 'current' }).data();
                    var pageTotal1 = pageTotalData1.reduce(function (a, b) { return intVal(a) + intVal(b); }, 0).toFixed(2);
                    var searchTotalData1 = api.column(costColumnIndex1, { 'filter': 'applied' }).data();
                    var searchTotal1 = searchTotalData1.reduce(function (a, b) { return intVal(a) + intVal(b); }, 0).toFixed(2);
                    $(api.column(20).footer()).html(searchTotal1);
                    ...
                    var searchTotalData1 = api.column(costColumnIndex1, { 'filter': 'applied' }).data();
                    var searchTotal1 = searchTotalData1.reduce(function (a, b) { return intVal(a) + intVal(b); }, 0).toFixed(2);
                    $(api.column(21).footer()).html(searchTotal1);
                    ...
                    //var searchTotalData1 = api.column(costColumnIndex1, { 'filter': 'applied' }).data();
                    //var searchTotal1 = searchTotalData1.reduce(function (a, b) { return intVal(a) + intVal(b); }, 0).toFixed(2);
                    //$(api.column(16).footer()).html(searchTotal1);
                    ...
                    //var searchTotalDataTO = api.column(TOColumnIndex, { 'filter': 'applied' }).data();
                    //var searchTotalTO = searchTotalDataTO.reduce(function (a, b) { return intVal(a) + intVal(b); }, 0).toFixed(2);
                    //$(api.column(12).footer()).html(searchTotalTO);
                    ...
                    //var searchTotalDataPCA = api.column(PCAColumnIndex, { 'filter': 'applied' }).data();
                    //var searchTotalPCA = searchTotalDataPCA.reduce(function (a, b) { return intVal(a) + intVal(b); }, 0).toFixed(2);
                    //$(api.column(17).footer()).html(searchTotalPCA);

                    //var PCAColumnIndex = $('th').filter(function (i) { return $(this).text() == 'OrdBymail'; }).first().index();
                    //var totalDataPCA = api.column(PCAColumnIndex).data();
                    //var totalPCA = totalDataPCA.reduce(function (a, b) { return intVal(a) + intVal(b); }, 0).toFixed(2);
                    //var pageTotalDataPCA = api.column(PCAColumnIndex, { page: 'current' }).data();
                    //var pageTotalPCA = pageTotalDataPCA.reduce(function (a, b) { return intVal(a) + intVal(b); }, 0).toFixed(2);
                    //var searchTotalDataPCA = api.column(PCAColumnIndex, { 'filter': 'applied' }).data();
                    //var searchTotalPCA = searchTotalDataPCA.reduce(function (a, b) { return intVal(a) + intVal(b); }, 0).toFixed(2);
                    //$(api.column(13).footer()).html(searchTotalPCA);

                    //var PCAColumnIndex = $('th').filter(function (i) { return $(this).text() == 'OrdByPhn'; }).first().index();
                    //var totalDataPCA = api.column(PCAColumnIndex).data();
                    //var totalPCA = totalDataPCA.reduce(function (a, b) { return intVal(a) + intVal(b); }, 0).toFixed(2);
                    //var pageTotalDataPCA = api.column(PCAColumnIndex, { page: 'current' }).data();
                    //var pageTotalPCA = pageTotalDataPCA.reduce(function (a, b) { return intVal(a) + intVal(b); }, 0).toFixed(2);
                    //var searchTotalDataPCA = api.column(PCAColumnIndex, { 'filter': 'applied' }).data();
                    //var searchTotalPCA = searchTotalDataPCA.reduce(function (a, b) { return intVal(a) + intVal(b); }, 0).toFixed(2);
                    //$(api.column(14).footer()).html(searchTotalPCA);
