<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="CityType.aspx.cs" Inherits="AstralFFMS.CityType" EnableEventValidation="false" %>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        function validate() {
            if ($('#<%=CityTypeName.ClientID%>').val() == "") {
                errormessage("Please enter City Type.");
                return false;
            }

            var value = ($('#<%=CityTypeName.ClientID%>').val().charAt(0));
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var valLength = "";
            $('#<%=CityTypeName.ClientID%>').keypress(function (key) {

                valLength = ($('#<%=CityTypeName.ClientID%>').val().length + 1);
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-default">
                        <div class="box-header">
                            <%--<h3 class="box-title">City Type Master</h3>--%>
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-lg-5 col-md-6 col-sm-8 col-xs-10">
                                <div class="form-group">
                                    ...
                                    <input runat="server" type="text" class="form-control" maxlength="100" id="CityTypeName" placeholder="Enter City Type Name">
                                </div>

                                 <div class="form-group">
                           
                                    <label for="exampleInputEmail1">Fare Amount Rate Per Km:</label>&nbsp;&nbsp;
                                    <input runat="server" type="text" class="form-control numeric" maxlength="10" id="txtFareAmt" placeholder="Enter Fare Amount">
                                </div>
                            </div></div>
                        </div>
        ...
        <div class="box-body" id="rptmain" runat="server" style="display: none;">
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">City Type List</h3>
                            <div style="float: right">
