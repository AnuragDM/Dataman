...
{
    public partial class DailySalesReportL3 : System.Web.UI.Page
    {
   ...
   //             dv.RowFilter = "RoleName='Level 3' and SMName<>.";
                dv.RowFilter = "RoleType='StateHead' or RoleType='RegionHead' and SMName<>.";
        ...
        protected void btnGo_Click(object sender, EventArgs e)
        {
            ...
            {
                string smIDStr = "";
                string smIDStr1 = "", Qrychk = "", Query = "", QryDemo = "", QryFv = "", QryOrder = "", beat = "", QryMain = "";
                //         string message = "";
        ...
        {
            Response.Redirect("~/DailySalesReportL3.aspx");
        }
