<%@ Page Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="OrderReturnEntryItemWise.aspx.cs" Inherits="AstralFFMS.OrderReturnEntryItemWise" %>
                ...
                <div class="col-md-12">
                    <div id="InputWork">
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="form-group paddingleft0" style="margin-left:8px;">
                                             ...
                                             <asp:TemplateField HeaderText="Item Name" ItemStyle-Width="30%">
                                                    <ItemTemplate>
                                                       <asp:Label runat="server" ID="lblitemname" Text='<%#Eval("itemname") %>'></asp:Label>
                                                        <asp:HiddenField ID="HiddenField3" runat="server" Value='<%#Eval("itemid") %>' />
                                                           <asp:HiddenField ID="hidord1id" runat="server" Value='<%#Eval("SRet1Id") %>' />
                                                         <asp:HiddenField ID="Hidtype" runat="server" Value='<%#Eval("type") %>' />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                         
                                         <asp:TemplateField HeaderText="Std. Pack" ItemStyle-Width="6%">
                                                    <ItemTemplate>
                                                       <asp:Label runat="server" ID="lblstdpack" Text='<%#Eval("stdpack") %>' CssClass="form-control numeric text-right"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                         <asp:TemplateField HeaderText="Cases" ItemStyle-Width="6%">
                                                    <ItemTemplate>
                                             ...
                                             <asp:TemplateField HeaderText="Unit" ItemStyle-Width="6%">
                                                    <ItemTemplate>
                                          ...
                                          <asp:TemplateField HeaderText="Batch No.">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtBatch" TabIndex="4" runat="server"  MaxLength="255" class="form-control" Text='<%#Eval("BatchNo") %>'></asp:TextBox>
                   ...
                   <%--                                <asp:TemplateField HeaderText="MFD" 
                SortExpression="EFF_DATE" >
                <ItemTemplate>
                    <asp:Label ID="lblEffDate" runat="server" Text='<%#String.Format("{0:dd/MMM/yyyy}", Eval("MFD"))%>' />
                </ItemTemplate>
                <EditItemTemplate>Text='<%#String.Format("{0:dd/MMM/yyyy}", Eval("MFD"))%>' 
                    <asp:TextBox ClientIDMode="Static" ID="txtMFD" runat="server" Text='<%#String.Format("{0:dd/MMM/yyyy}", Eval("MFD"))%>' />
                    <img alt="Calendar" src="jqwidgets/styles/images/icon-calendar-white.png"  style="cursor: pointer;" onclick="javascript: NewCssCal('txtEffDate')" />
                </EditItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="MFD">
                                                    <ItemTemplate>
                                             <asp:TextBox ID="txtMFD" runat="server" CssClass="form-control" Style="background-color: white;" Text='<%#String.Format("{0:dd/MMM/yyyy}", Eval("MFD"))%>'  ClientIDMode="AutoID" ></asp:TextBox>
                                            <ajaxToolkit:CalendarExtender ID="CalendarExtender1" CssClass="orange"  Format="dd/MMM/yyyy" runat="server" TargetControlID="txtMFD" EndDate="<%# BusinessLayer.Settings.GetUTCTime() %>"  />
                                         ...
                                         <asp:TemplateField>
                                             <ItemTemplate>
                                                 <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%#Eval("SRet1Id") + ";" + Eval("SRetId")%>'  OnCommand="LinkButton1_Command"><img src="img/delete.png" alt="Delete" height="22" width="22"></asp:LinkButton>
                                             </ItemTemplate>
                                         </asp:TemplateField>
                                     </Columns>
                                  </asp:GridView>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Sales Order Return List</h3>
                        ...
                        <div class="box-body table-responsive">
                            <asp:Repeater ID="rpt" runat="server">
                                ...
                                <ItemTemplate>
                                    <tr onclick="DoNav('<%#Eval("SRet1Id") %>');">
                                        <asp:HiddenField ID="HiddenField4" runat="server" Value='<%#Eval("SRetId") %>' />
                                        <td><%#String.Format("{0:dd/MMM/yyyy}", Eval("VDate"))%></td>
                                        <td><%#Eval("SRetDocId") %></td>
                                         <td><%#Eval("ItemName") %></td>
                                         <td><%#Eval("rate") %></td>
                                         <td><%#Eval("qty") %></td>
                                        <td style="text-align:right;"><%#Eval("amount") %></td>
                                        <td><%#Eval("BatchNo") %></td>
                                        <td><%#String.Format("{0:dd/MMM/yyyy}", Eval("MFD"))%></td>
                                    </tr>
                                </ItemTemplate>
                                <FooterTemplate>
                                    </tbody>     </table>       
