...
{
    public partial class SalesTargetFormLevel2 : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (lk != null)
                {
                    string s = @"select * from SalesTragetFromHO Where  PartyTypeId=" + hid.Value + " and SMID=" + Settings.Instance.SMID + " and SalesYear='" + txtcurrentyear.SelectedItem.Text + "'";
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "HO")
            {
                string str1 = "select Name,Id from MastItemClass where Id=" + e.CommandArgument.ToString();
        ...
        protected void btnsave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string s = "delete from SalesTragetFromHO Where AssignedByID=" + Settings.DMInt32(Settings.Instance.UserID) + " and  PartyTypeId=" + Settings.DMInt32(lblPartTypeID.Text) + " and SalesYear='" + txtcurrentyear.SelectedItem.Text + "'";
                ...
                for (int i = 0; i < GridView2.Rows.Count; i++)
                {
                    ...
                    int RetSave = MT.Insert(docID, Settings.DMInt32(lblPartTypeID.Text), Settings.DMDecimal(jan.Text), Settings.DMDecimal(feb.Text), Settings.DMDecimal(mar.Text), Settings.DMDecimal(apr.Text), Settings.DMDecimal(may.Text), Settings.DMDecimal(jun.Text), Settings.DMDecimal(jul.Text), Settings.DMDecimal(aug.Text), Settings.DMDecimal(spt.Text), Settings.DMDecimal(oct.Text), Settings.DMDecimal(nov.Text), Settings.DMDecimal(dec.Text), Settings.DMInt32(hidPartyId.Value), i + 1, Settings.DMInt32(Settings.Instance.UserID), txtcurrentyear.SelectedItem.Text,"","","");
                }
        ...
        protected void GridView2_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                string srty = "select * from SalesTragetFromHO where SMID=" + Settings.DMInt32(PartyId.Value) + " and PartyTypeId=" + lblPartTypeID.Text + " and SalesYear='" + txtcurrentyear.SelectedItem.Text + "'";
        ...
        protected void GridView3_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (lk != null)
                {
                    string s = @"select * from SalesTragetFromHO Where  PartyTypeId=" + lblPartTypeID.Text + " and SMId=" + hid.Value + " and SalesYear='" + txtcurrentyear.SelectedItem.Text + "'";
                    DataTable dtr = new DataTable();
                    dtr = DbConnectionDAL.GetDataTable(CommandType.Text, s);
                    if (dtr.Rows.Count > 0)
                    {
                ...
                if (lblAllocatetoTeam != null)
                {
                    ...
                    string s = @"select * from SalesTragetFromHO Where  PartyTypeId=" + lblPartTypeID.Text + " and AssignedByID=" + hidUid.Value + " and SalesYear='" + txtcurrentyear.SelectedItem.Text + "'";
                    DataTable dtr = new DataTable();
                    dtr = DbConnectionDAL.GetDataTable(CommandType.Text, s);
                    if (dtr.Rows.Count > 0)
                    {
                ...
                lblpending.Text = Convert.ToString(Settings.DMDecimal(lk.Text) - Settings.DMDecimal(lblAllocatetoTeam.Text));
            }
        }
    }
}