<%@ Page Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="DistributerDispatchOrderViewForm_V2.aspx.cs" Inherits="AstralFFMS.DistributerDispatchOrderViewForm_V2" %>
                        ...
                        <div id="InputWork">
                            ...
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <img id="img-Header" src="img/note.png" style="width: 45px; height: 45px;" />
                                        ...
                                        <td><%#Eval("VDate","{0:dd/MMM/yyyy}")%></td>
                                         <td><%# Eval("SyncId")%></td>
                                            ...
                                            <td><asp:LinkButton CommandName="selectDate" ID="LinkButton1"
                                                    ...
                                                    Text="Dispatch" 
                                                    Width="80px" Visible="false" Font-Underline="True"/> &nbsp;&nbsp; <asp:LinkButton CommandName="selectDate1" ID="LinkButton2"
                                                    CausesValidation="False" runat="server" OnClientClick="window.document.forms[0].target='_self'; setTimeout(function(){window.document.forms[0].target='';}, 500);" 
                                                    Text="Order Cancel" 
                            ...
                            <div class="row">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td><asp:Label ID="lblRemarkViwPunch" runat="server" Text="" ></asp:Label>&nbsp;&nbsp; </td>
                                    </tr>
                                 ...
                                 <div id="Div2" runat="server" style="display:none;">
                                   <%-- <div class="col-lg-5 col-md-6 col-sm-8 col-xs-10">
                                       ...
                                       <%-- <asp:HiddenField ID="HiddenField2" runat="server"  />       
                                        <asp:Button Style="margin-right: 5px;" type="button" ID="btnEdit" runat="server" Text="Save" class="btn btn-primary" OnClick="btnEdit_Click" OnClientClick="return editBtn();"/>-</div>
                                </div>
                            </div>
                            <br />
                            <div class="row">
                            ...
                            <div class="box-body">
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <th>Distributor Name: &nbsp;&nbsp;</th>
                                        <td><asp:Label ID="Label3" runat="server" Text="" ></asp:Label> &nbsp;&nbsp;  ( <asp:Label ID="Label4" runat="server" Text="" ></asp:Label>)  &nbsp;&nbsp; </td>
                                    </tr>
                                     <tr>

                                        <th>Remark While Punch Order: &nbsp;&nbsp;</th>
                                        <td><asp:Label ID="lblRemarkViewItem" runat="server" Text="" ></asp:Label></td>
                                    </tr>
                                </table>
                                            </div>
                                </div>
                                ...
                                <table>
                                    <tr>
                                     ...
                                     <tr>
                                        ...
                                        <th>Remark While Punch Order: 
                                        <td><asp:Label ID="lblRemarkViewOrderCancel" runat="server" Text="" ></asp:Label></td>
                                    </tr>
                                </table>
                                            </div>
                                </div>
