<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="ClassMaster.aspx.cs" Inherits="AstralFFMS.ClassMaster" %>
    ...
    <script type="text/javascript">
        function validate() {
            if ($('#<%=Name.ClientID%>').val() == "") {
                errormessage("Please enter Item Class.");
                return false;
            }
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-default">
                        <div class="box-header">
                            <%-- <h3 class="box-title">Product Class </h3>--%>
                            <h3 class="box-title">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox class="form-control" MaxLength="50" ID="Name" TextMode="MultiLine" placeholder="Enter Item Class" runat="server" AutoCompleteType="Disabled"></asp:TextBox>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input runat="server" type="text" class="form-control" maxlength="20" id="SyncId" placeholder="Enter Sync Id" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
        ...
        <div class="box-body" id="rptmain" runat="server" style="display: none;">
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Product Class List</h3>
                            <div style="float: right">
