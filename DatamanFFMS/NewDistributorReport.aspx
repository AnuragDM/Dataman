<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="NewDistributorReport.aspx.cs" Inherits="AstralFFMS.NewDistributorReport" %>
                                ...
                                <asp:Repeater ID="rptnewrtl" runat="server">
                                    ...
                                    <ItemTemplate>                                          
                                             <tr>                                        
                                                ...
                                                <td><%# Eval("DistType")%>
                                                <asp:Label ID="lbldtype" runat="server" Visible="false" Text='<%# Eval("DistType")%>'></asp:Label></td> 
         ...
         $(function () {
             $('#itemsaleTable').dataTable({
                 ...
                 "footerCallback": function (tfoot, data, start, end, display) {
                     ...
                     debugger;
                     //var costColumnIndex = $('th').filter(function (i) { return $(this).text() == 'By'; }).first().index();
