<%@ Page Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="SalesTargetFormDist.aspx.cs" Inherits="AstralFFMS.SalesTargetFormDist" %>
                ...
                <div id="InputWork">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <%--<h3 class="box-title">Distributor Target Entry <b>(In Lakhs/In Qty)</b></h3>--%>
                        ...
                        <div class="box-body">
                         ...
                         <%--   <div class="clearfix"></div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="table table-responsive">
                                        ...
                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" HeaderStyle-BackColor="#3c8dbc" Width="100%" HeaderStyle-ForeColor="White" OnRowDataBound="GridView1_RowDataBound" OnRowCommand="GridView1_RowCommand">
                                            <Columns>
                                                <asp:TemplateField HeaderText="Product /Product Group">
                                                    <ItemTemplate>
                                ...
                                <div class="clearfix"></div>
                                 <div class="col-md-12">
                                <div id="divarea" runat="server" style="display:none;" class="col-lg-3 col-md-4 col-sm-4 col-xs-9">
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="Distributor">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:HiddenField ID="PartyId" runat="server" Value='<%#Eval("PartyId") %>' />
                                                    <asp:Label ID="lblUserType" runat="server" Text='<%#Eval("PartyName") %>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
