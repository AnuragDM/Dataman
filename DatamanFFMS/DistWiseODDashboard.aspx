<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="DistWiseODDashboard.aspx.cs" Inherits="AstralFFMS.DistWiseODDashboard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <%-- <script>
     ...
     <script>
         function GetOrder() {
           //  debugger;
             var fDate = document.getElementById("ContentPlaceHolder1_txtFDate");
             var tDate = document.getElementById("ContentPlaceHolder1_txtTDate");
             var fromDate = fDate.value;
             var toDate = tDate.value;
                 $.ajax({
                     type: "POST",
                     url: "DistWiseODDashboard.aspx/GetDist",
                     data: "{FromDate: '" + fromDate + "', ToDate: '" + toDate + "', chartselector: '" + $(<%= chartselector.ClientID %>).val() + "'}",
                     contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (response) {
                        var t = JSON.parse(response.d);
       ...
       <div class="box-body" id="TransStateDiv" runat="server">
           <div style="float: right">
            ...
            <div class="row">
                    ...
                    <ContentTemplate>
                            ...
                            <div class="col-md-4  col-lg-4" style="float: left">
                                <div class="panel panel-default">
                                    <div class="panel-heading">Order Status DashBoard</div>
                                    <div class="panel-body">

                                        <ul class="colornote" style="list-style-type: none;">
                                            <li>From Date:
                                             <asp:TextBox ID="txtFDate" runat="server" CssClass="form-control" Style="background-color: white;"></asp:TextBox>
                                                <ajaxToolkit:CalendarExtender ID="CalendarExtender2" OnClientDateSelectionChanged="dateSelectionChanged" CssClass="orange" Format="dd/MMM/yyyy" runat="server" BehaviorID="calendarTextBox_CalendarExtender2" TargetControlID="txtFDate"></ajaxToolkit:CalendarExtender>
                                            </li>
                                            <asp:DropDownList ID="cmbPerson" runat="server" DataValueField="SMId" DataTextField="SMName" Visible="false" CssClass="form-control" OnClientSelectedIndexChanged="OnClientSelectedIndexChanged" DataSourceID="SqlDataSource1"></asp:DropDownList>
                                            <li>To: 
                                      <asp:TextBox ID="txtTDate" runat="server" CssClass="form-control" Style="background-color: white;"></asp:TextBox>
                                                <ajaxToolkit:CalendarExtender ID="CalendarExtender3" OnClientDateSelectionChanged="dateSelectionChanged" CssClass="orange" Format="dd/MMM/yyyy" runat="server" BehaviorID="calendarTextBox_CalendarExtender8" TargetControlID="txtTDate"></ajaxToolkit:CalendarExtender>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-8  col-lg-8" runat="server" id="CWSD" >
                                <div class="demo-container no-bg size-wide" runat="server">
                                        ...
                                        <telerik:RadHtmlChart OnClientSeriesClicked="test" runat="server" ID="PieChart1" Height="500" Transitions="false">
                                            ...
                                            <Legend>
                                                <Appearance Position="Right" Visible="true">
                                                    <TextStyle FontSize="10" Color="#660066" />
                    ...
                    <Triggers>
                   <asp:AsyncPostBackTrigger ControlID="txtFDate" EventName="TextChanged" />
               <%--    <asp:AsyncPostBackTrigger ControlID="CalendarExtender3" EventName="dateSelectionChanged" />--%>
                    </Triggers>
                </asp:UpdatePanel>
                   </div>
                  <div >
                                            ...
                                            <div class="form-group">
                                                <div class="box-body table-responsive" id="maingrid" runat="server">
                                                    <telerik:RadGrid ID="levelGrid1" EnableEmbeddedSkins="false" Skin="MySkin"
                                                        ...
                                                        AutoGenerateColumns="false" runat="server"  OnDetailTableDataBind="levelGrid1_DetailTableDataBind"  OnPageIndexChanged="levelGrid1_PageIndexChanged" DataSourceID="SqlDataSource3" PageSize="10" AllowPaging="True">
                                                        <PagerStyle Mode="NumericPages" AlwaysVisible="true" Position="Bottom"></PagerStyle>
                                                        <MasterTableView DataKeyNames="OrdDocId" OverrideDataSourceControlSorting="true" TableLayout="Fixed">
                                                            <DetailTables>
                                                                <telerik:GridTableView DataKeyNames="OrdDocId" Name="OrderDetails" Width="100%">
                                                                    <Columns>
                                                                         <telerik:GridBoundColumn SortExpression="OrdDocId" HeaderText="OrdDocId" Display="false"  HeaderButtonType="TextButton" DataField="OrdDocId"></telerik:GridBoundColumn>
                                                                         <telerik:GridBoundColumn SortExpression="ItemName" HeaderText="ItemName" HeaderButtonType="TextButton"  DataField="ItemName"></telerik:GridBoundColumn>
                                                                         <telerik:GridBoundColumn SortExpression="Qty" HeaderText="Qty" HeaderButtonType="TextButton"  DataField="Qty"></telerik:GridBoundColumn>
                                                                         <telerik:GridBoundColumn SortExpression="Rate" HeaderText="Rate" HeaderButtonType="TextButton" DataField="Rate"></telerik:GridBoundColumn>
                                                                         <telerik:GridBoundColumn SortExpression="Discount" HeaderText="Discount" HeaderButtonType="TextButton"  DataField="Discount"></telerik:GridBoundColumn>
                                                                          <telerik:GridBoundColumn SortExpression="Amount" HeaderText="Amount" HeaderButtonType="TextButton"  DataField="Amount"></telerik:GridBoundColumn>
                                                                         <telerik:GridBoundColumn SortExpression="Remarks" HeaderText="Remarks" HeaderButtonType="TextButton"  DataField="Remarks"></telerik:GridBoundColumn>
                                                                    </Columns>
                                                                </telerik:GridTableView>
                                                            </DetailTables>
                                                            <Columns>
                                                                <telerik:GridBoundColumn SortExpression="OrdDocId" HeaderText="OrdDocId" Display="false"  HeaderButtonType="TextButton" DataField="OrdDocId"></telerik:GridBoundColumn>
                                                                <telerik:GridBoundColumn SortExpression="VDate" HeaderText="Visit Date" HeaderButtonType="TextButton" DataField="VDate" DataFormatString="{0:dd/MM/yyyy}"></telerik:GridBoundColumn>
                                                                 <telerik:GridBoundColumn SortExpression="PartyName" HeaderText="Party" HeaderButtonType="TextButton" DataField="PartyName"></telerik:GridBoundColumn>
                                                                <telerik:GridBoundColumn SortExpression="AreaName" HeaderText="Area" HeaderButtonType="TextButton" DataField="AreaName"></telerik:GridBoundColumn>
                                                                <telerik:GridBoundColumn SortExpression="OrderAmount" HeaderText="Amount" HeaderButtonType="TextButton" DataField="OrderAmount"></telerik:GridBoundColumn>
                                                                 <telerik:GridBoundColumn SortExpression="Remarks" HeaderText="Remarks" HeaderButtonType="TextButton" DataField="Remarks"></telerik:GridBoundColumn>
                                                            </Columns>
                                                        </MasterTableView>
                                                    </telerik:RadGrid>
    ...
    <telerik:RadAjaxManager ID="ajaxMgr" runat="server">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="levelGrid1">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="levelGrid1" LoadingPanelID="RadAjaxLoadingPanel1" />
                </UpdatedControls>
            </telerik:AjaxSetting>
    ...
    <asp:Button runat="server" ID="btn1" ClientIDMode="Static" OnClick="btn1_Click" Style="border: medium none; background: transparent none repeat scroll 0% 0%; color: transparent;" />
     <asp:Button runat="server" ID="btnGet" ClientIDMode="Static" OnClick="dummybtn_Click" Style="border: medium none; background: transparent none repeat scroll 0% 0%; color: transparent;" />
