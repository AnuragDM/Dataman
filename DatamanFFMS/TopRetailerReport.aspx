<%@ Page Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="TopRetailerReport.aspx.cs" Inherits="AstralFFMS.TopRetailerReport" EnableEventValidation="true" %>
                    ...
                    <div class="col-md-12">
                        <div id="InputWork">
                            ...
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <%--<h3 class="box-title">Top Retailer</h3>--%>
                                    <h3 class="box-title">
                        ...
                        <div id="rptmain" runat="server">
                            <div class="box-header table-responsive">
                                <asp:Repeater ID="TopRetailer" runat="server" OnItemCommand="Topsaleproduct_ItemCommand">
                                    <HeaderTemplate>
                                        <table id="itemsaleTable" class="table table-bordered table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="text-align: right; width: 10%">View Details</th>
                                                </tr>
                                            </thead>
                                            <tfoot>
                                                <tr>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td><%# Eval("Address1")%>
                                                <asp:Label ID="lblAddress1" runat="server" Visible="false" Text='<%# Eval("Address1")%>'></asp:Label></td>
                                            <td><%# Eval("PartyTypeName")%>
                                                <asp:Label ID="lblPartyTypeName" runat="server" Visible="false" Text='<%# Eval("PartyTypeName")%>'></asp:Label></td>
                                            <td><%# Eval("Beat")%>
                                                <asp:Label ID="lblBeat" runat="server" Visible="false" Text='<%# Eval("Beat")%>'></asp:Label></td>
                                            <td style="text-align: right"><%# string.Format("{0:n2}",Eval("Amount"))%>
                                                <asp:Label ID="lblAmount" runat="server" Visible="false" Text='<%# string.Format("{0:n2}",Eval("Amount"))%>'></asp:Label></td>
                                            <td>
