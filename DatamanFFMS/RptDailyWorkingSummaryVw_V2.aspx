<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="RptDailyWorkingSummaryVw_V2.aspx.cs" Inherits="AstralFFMS.RptDailyWorkingSummaryVw_V2" %>
                    ...
                    <div class="col-md-12">
                        <div class="box-header with-border">
                            <%-- <h3 class="box-title">Daily Working Summary L1</h3>--%>
                               <img id="img-Header" src="img/Location/schedule(1).png" />
                            <h2 class="box-title">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlDsrType" runat="server" class="form-control">
                        ...
                        <div class="box-footer">
                            <asp:Button type="button" ID="btnGo" runat="server" Text="Go" class="btn btn-primary button1" OnClientClick="GetReport();"
                                OnClick="btnGo_Click" />
                            <asp:Button type="button" ID="btnCancel" runat="server" Text="Cancel" class="btn btn-primary button1" OnClick="btnCancel_Click" />
                            <asp:Button type="button" ID="btnExport" runat="server" Text="Export" ToolTip="Export To CSV" class="btn btn-primary button1"
                                ...
                                <tr>
                                    ...
                                    <td><%# Eval("lock")%>
                                      ...
                                      <td><%# Eval("Dsr_Status")%>
                                           ...
                                           <asp:Label ID="lbldsrstat" runat="server" Visible="false" Text='<%# Eval("Dsr_Status")%>'></asp:Label>
                                      </td>
                                    <td style="max-width: 200px !important; overflow-x: hidden;">
                                   ...
                                   <%-- <td><%# Eval("NewColumn")%>
                                    ...
                                    <td><%# Eval("logintime")%>
                                          <asp:Label ID="lgntme" runat="server" Visible="false" Text='<%# Eval("logintime")%>'></asp:Label>
                                    </td>
                                    <td><%# Eval("logouttime")%>
                                         <asp:Label ID="lgottme" runat="server" Visible="false" Text='<%# Eval("logouttime")%>'></asp:Label>
                                    </td>
                                    <td><%# Eval("EndRemark")%>
                                        <asp:Label ID="endrm" runat="server" Visible="false" Text='<%# Eval("EndRemark")%>'></asp:Label>
                                    </td>
                                     <td>
                                        <asp:HyperLink ID="hpl" runat="server" NavigateUrl='<%# string.Format("~/Live_Map_V2.aspx?Smid={0}&VDate={1}",HttpUtility.UrlEncode(Eval("Id").ToString()), HttpUtility.UrlEncode(Eval("VDate").ToString())) %>'
        ...
        $(function () {
            $('#example1').dataTable({
                ...
                "footerCallback": function (tfoot, data, start, end, display) {
                    ...
                    var searchTotalDataRCV = api.column(RCVColumnIndex, { 'filter': 'applied' }).data();
                    var searchTotalRCV = searchTotalDataRCV.reduce(function (a, b) { return intVal(a) + intVal(b); }, 0).toFixed(2);
                    $(api.column(11).footer()).html(searchTotalRCV);
                    ...
                    $(api.column(19).footer()).html(searchTotalPCA);
                    ...
                    var searchTotalData1 = api.column(costColumnIndex1, { 'filter': 'applied' }).data();
                    var searchTotal1 = searchTotalData1.reduce(function (a, b) { return intVal(a) + intVal(b); }, 0).toFixed(2);
                    $(api.column(22).footer()).html(searchTotal1);
                    ...
                    var searchTotalData1 = api.column(costColumnIndex1, { 'filter': 'applied' }).data();
                    var searchTotal1 = searchTotalData1.reduce(function (a, b) { return intVal(a) + intVal(b); }, 0).toFixed(2);
                    $(api.column(23).footer()).html(searchTotal1);
                    ...
                    var searchTotalData1 = api.column(costColumnIndex1, { 'filter': 'applied' }).data();
                    var searchTotal1 = searchTotalData1.reduce(function (a, b) { return intVal(a) + intVal(b); }, 0).toFixed(2);
                    $(api.column(24).footer()).html(searchTotal1);
