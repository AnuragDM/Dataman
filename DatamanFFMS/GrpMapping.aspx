<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.master" AutoEventWireup="true" Inherits="GrpMapping" Codebehind="GrpMapping.aspx.cs" %>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <%--<h3 class="box-title">Group Mapping</h3>--%>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="row">
              <div class="form-group col-md-4 col-sm-4 col-xs-12 paddingleft0" >
                    ...
                    <label for="User Name" >Group Name :</label>
                  <asp:DropDownList ID="ddlType" runat="server"  CssClass="textbox form-control" Width="100%">
                    </asp:DropDownList>
            </div>
                <div class="form-group col-md-4 col-xs-4 col-xs-12" style="margin-top:20px;" >
        ...
        <div class="table-responsive">
            <table class="table">
                ...
                <tr>
                    <td colspan="5">
                        <asp:GridView ID="gvData" runat="server" class="table" AutoGenerateColumns="False" BackColor="White" OnPageIndexChanging="gvData_PageIndexChanging"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Device" HeaderText="Device No" />
