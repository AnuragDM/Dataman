<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="VarianceReportL2.aspx.cs" Inherits="AstralFFMS.VarianceReportL2" %>
                    ...
                    <div id="InputWork">
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                               <%-- <h3 class="box-title">Daily Variance Report L2</h3>--%>
                                ...
                                <div class="row">
                                    <div class="col-md-2 col-sm-5 col-xs-9" hidden>
                                     ...
                                     <div class="col-md-2 col-sm-5 col-xs-9">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Sales Person:</label>
                                           <asp:TreeView ID="trview" runat="server" CssClass="table-responsive" ExpandDepth="10" ShowCheckBoxes="All" Width="776px"></asp:TreeView>                                           
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
