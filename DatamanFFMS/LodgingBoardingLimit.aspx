<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="LodgingBoardingLimit.aspx.cs" Inherits="AstralFFMS.LodgingBoardingLimit" %>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-default">
                        <div class="box-header">
                            <%--<h3 class="box-title">Lodging/Boarding Limit Master</h3>--%>
                        ...
                        <input type="text" runat="server" class="form-control numeric text-right" onkeypress="javascript:return isNumber (event)" maxlength="15" id="Amount" placeholder="Enter Amount" tabindex="6">
                                ...
                                <input type="text" runat="server" class="form-control" maxlength="500" id="Remarks" placeholder="Enter Remarks" tabindex="8">
                            </div>
                            <div class="form-group">
        ...
        <div class="box-body" id="rptmain" runat="server" style="display: none;">
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Lodging/Boarding Limit List</h3>
                            <div style="float: right">
