...
namespace AstralFFMS
{
    public partial class ActivityCompareRpt : System.Web.UI.Page
    {
        ...
        private void BindPerson()
        {
            ...
            ddlfirstperson.DataSource = dv.ToTable();
            ddlfirstperson.DataTextField = "SMName";
            ddlfirstperson.DataValueField = "DeviceNo";
            ddlfirstperson.DataBind();
            //Add Default Item in the DropDownList
            ddlfirstperson.Items.Insert(0, new ListItem("--Please select--"));
        }
        private void BindPerson2()
        {
            DataTable dt = Settings.UnderUsers(Settings.Instance.SMID);
            DataView dv = new DataView(dt);
            dv.RowFilter = "SMId<>" + Convert.ToInt32(Settings.Instance.SMID) + "";
            ddlsecondperson.DataSource = dv.ToTable();
            ddlsecondperson.DataTextField = "SMName";
            ddlsecondperson.DataValueField = "DeviceNo";
            ddlsecondperson.DataBind();
            //Add Default Item in the DropDownList
            ddlsecondperson.Items.Insert(0, new ListItem("--Please select--"));
        }
        private void BindPerson3()
        {
            DataTable dt = Settings.UnderUsers(Settings.Instance.SMID);
            DataView dv = new DataView(dt);
            dv.RowFilter = "SMId<>" + Convert.ToInt32(Settings.Instance.SMID) + "";
            ddlthirdperson.DataSource = dv.ToTable();
            ddlthirdperson.DataTextField = "SMName";
            ddlthirdperson.DataValueField = "DeviceNo";
            ddlthirdperson.DataBind();
            //Add Default Item in the DropDownList
            ddlthirdperson.Items.Insert(0, new ListItem("--Please select--"));
        }
