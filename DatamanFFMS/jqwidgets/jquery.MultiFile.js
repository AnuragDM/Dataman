	...
	$.fn.MultiFile = function(options){
        ...
        slave.change(function(){
          ...
          if(MultiFile.accept && v && !v.match(MultiFile.rxAccept))//{
           ...
           //}
            //};
          debugger;
          var fileExtension = ['jpeg', 'jpg', 'png', 'gif', 'doc','docx','pdf','xlsx','xls','txt','exe'];
        
          if ($.inArray($(this).val().split('.').pop().toLowerCase(), fileExtension) == -1) {
              ERROR = MultiFile.STRING.check;
          }
          ...
          for (var f in MultiFile.slaves)//
          {
              ...
              if (MultiFile.slaves[f] && MultiFile.slaves[f] != this)//{&& MultiFile.slaves[f]!
       ...
       MultiFile.addToList = function( slave, slave_count ){
        ...
        var
         ...
         b = $('<a class="MultiFile-remove" href="#' + MultiFile.wrapID + '"><img src="img/delete.png" /></a>');
	...
	*/
	$.fn.MultiFile.options = { //$.extend($.fn.MultiFile, { options: {
		...
		STRING: {
			...
			check:'Please select a valid Word,PDF,Excel,Images File.'
		},
