<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="OrderAmountDetails.aspx.cs" Inherits="AstralFFMS.OrderAmountDetails" %>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <label for="exampleInputEmail1" id="lblcaption" runat="server"></label>&nbsp;&nbsp;
                                            <b><asp:Label ID="lblorderamount" runat="server" Text='<%# Eval("SMName")%>'></asp:Label></b>
                                        </div>
                                        <%-- </div>--%>
                                    </div>
                                </div>
                    ...
                    <div class="box" style="border-top: 1px solid #f4f4f4;">
                       <%-- <div class="box-header">
                        ...
                        <div class="box-body table-responsive">
                            ...
                            <asp:Repeater ID="orderamount" runat="server">
                                <HeaderTemplate>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th style="text-align: left; width: 14%">Distributor/Retailer</th>
