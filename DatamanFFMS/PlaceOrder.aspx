<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="PlaceOrder.aspx.cs" Inherits="AstralFFMS.PlaceOrder" EnableEventValidation="false" %>
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <div style="float: right">
                            <asp:Button Style="margin-right: 5px;" Visible="false" type="button" ID="btnFind" runat="server" Text="Find" class="btn btn-primary" OnClick="btnFind_Click" />
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                       <label>Agt Form:</label>&nbsp;&nbsp;<label for="requiredFields" style="color: red;">*</label>
                                                <asp:DropDownList ID="ddltaxform" CssClass="form-control" Width="100%" runat="server" TabIndex="14"></asp:DropDownList>
                                                    </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <asp:DropDownList ID="ddlCity" CssClass="form-control" Width="100%" runat="server" TabIndex="14" AutoPostBack="True" OnSelectedIndexChanged="ddlCity_SelectedIndexChanged"></asp:DropDownList>
                                            </div>
                                            <div class="col-md-6">
                                                <label>Pincode:</label>&nbsp;
                                ...
                                <div class="col-md-12 paddingleft0">
                                    ...
                                    <div class="form-group col-md-3 ">
                                        ...
                                        <asp:DropDownList ID="ddlStatus" runat="server" Width="100%" CssClass="form-control">
                                            ...
                                            <asp:ListItem Text="Confirmed" Value="M"></asp:ListItem>
                                            <asp:ListItem Text="Canceled by company" Value="C"></asp:ListItem>
                                            <asp:ListItem Text="Canceled by customer" Value="R"></asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                    <div class="form-group col-md-3">
