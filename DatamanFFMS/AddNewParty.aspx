<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="AddNewParty.aspx.cs" Inherits="AstralFFMS.AddNewParty" %>
                        ...
                        <div class="box-body">
                            <div class="col-md-12">
                                ...
                                <div class="form-group formlay">
                                    ...
                                    <asp:DropDownList ID="ddlCity" Width="100%"  CssClass="form-control" runat="server" TabIndex="3" Enabled="false"></asp:DropDownList>
                                </div>
                                <div class="form-group formlay">
                                    <label for="exampleInputEmail1">Area:</label>&nbsp;&nbsp;<label for="requiredFields" style="color: red;">*</label>
                                    <asp:DropDownList ID="ddlArea" Width="100%" AutoPostBack="true" OnSelectedIndexChanged="ddlArea_SelectedIndexChanged" Enabled="false" CssClass="form-control" runat="server" TabIndex="4"></asp:DropDownList>
                                </div>
                                <div class="form-group formlay">
                                    <label for="exampleInputEmail1">Beat:</label>&nbsp;&nbsp;<label for="requiredFields" style="color: red;">*</label>
                                    <asp:DropDownList ID="ddlBeat" Width="100%" CssClass="form-control" runat="server" TabIndex="5" Enabled="false"></asp:DropDownList>
                                </div>
                                <div class="form-group formlay">
