<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="rptAnnual_Growth_V2.aspx.cs" Inherits="AstralFFMS.rptAnnual_Growth_V2" %>
    ...
    <script type="text/javascript">
        ...
        function btnSubmitfunc() {
            ...
            $("#<%=Lstpartybox.ClientID %> :selected").each(function () {
             ...
             var selectedValues = [];
             $("#<%=LstPrdGrp.ClientID %> :selected").each(function () {
                selectedValues.push($(this).val());
            });
            $("#hidprdgrp").val(selectedValues);
            //if (selectedValues == "") {
            //    errormessage("Please Select Area");
            //    return false;
            //}
         ...
         function BindGridView() {
             ...
             $.ajax({
                 type: "POST",
                 url: "rptAnnual_Growth_V2.aspx/GetAnnualGrowthSale",
                 data: '{areaid: "' + $("#hidarea").val() + '",beatid: "' + $("#hidbeat").val() + '",RetailerId: "' + $("#hidretailer").val() + '", year: "' + $("#hidyear").val() + '", PrdGrp: "' + $("#hidprdgrp").val() + '",  MonthText: "' + $("#hidmonthtext").val() + '",Month: "' + $("#hidmonth").val() + '", View: "' + $("#hidview").val() + '"}',
                    ...
                    <div id="InputWork">
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                  <img src="img/Location/growth.png" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <asp:ListBox ID="lstAreaBox" runat="server" SelectionMode="Multiple" OnSelectedIndexChanged="lstAreaBox_SelectedIndexChanged" AutoPostBack="true" class="form-control"></asp:ListBox>
                                            <input type="hidden" id="hidsp" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <asp:ListBox ID="LstPrdGrp" runat="server" SelectionMode="Multiple" class="form-control"></asp:ListBox>
                                        </div>
                                    </div>
                            ...
                            <div class="box-footer">
                              <%--  <input type="button" runat="server" onclick="btnSubmitfunc();" class="btn btn-primary button1" value="Generate" />--%>
                                <asp:Button Style="margin-right: 5px;" type="button" ID="btnGo" runat="server" Text="Generate" class="btn btn-primary button1" 
                                    OnClientClick="javascript:return btnSubmitfunc(); "
                                    OnClick="btnGo_Click" />
