<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="DistributorDashboardLevel2.aspx.cs" Inherits="AstralFFMS.DistributorDashboardLevel2" %>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-default">
                        <div class="box-header">
                            <h3 class="box-title">Distributor Screen L-2</h3>
...
<asp:Panel ID="Panel1" runat="server" BackColor="White" Height="320px" Width="290px" style="display:none">
    <div  style="height:10%; background-color: #367FA9; color:white; font-weight:bold; font-size:larger" align="center">
        Failed Visit
    </div>
    <div style="margin-left:10px;margin-right:10px">
<table style="padding-left:5px" width="100%" height:"100%" cellpadding="0" cellspacing="0" class="table-responsive">
<tr style="background-color: #367FA9;">
