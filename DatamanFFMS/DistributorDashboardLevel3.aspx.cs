...
{
    public partial class DistributorDashboardLevel3 : System.Web.UI.Page
    {
     ...
     //           CalendarExtender3.StartDate = Convert.ToDateTime(GetVisitDate(Convert.ToInt32(VisitID)));
        ...
        private void UpdateDiscussion()
        {
            try
            {
                    ...
                    string imgurl = "";                   
                        ...
                        //int RetUpdate = dp.UpdateDist(getID(), txtdiscussion.Text);
                        //if (RetUpdate > 0)
                        //{
                        //    System.Web.UI.ScriptManager.RegisterStartupScript(this, GetType(), "Successmessage", "Successmessage('Record Updated Successfully');", true);
        ...
        {
            Response.Redirect("DistributerPartyList.aspx?VisitID=" + VisitID + "&CityID=" + CityID+"&Level="+3);
        }

        protected void Button4_Click(object sender, EventArgs e)
        {
            Response.Redirect("DSRVistEntry.aspx?VisitID=" + VisitID + "&CityID=" + CityID + "&Level=" + 3);
        }
        ...
        protected void rpt_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            if (e.CommandName == "Coll")
            {
                Response.Redirect("DistributorCollection.aspx?DistID=" + e.CommandArgument.ToString() + "&CityID=" + CityID + "&VisitID=" + VisitID + "&Level=3" + "&PartyId=" + DistID);
            }
            if (e.CommandName == "DDisc")
            {
                Response.Redirect("DistributorDiscussion.aspx?DistID=" + e.CommandArgument.ToString() + "&CityID=" + CityID + "&VisitID=" + VisitID + "&Level=3");
            }
            if (e.CommandName == "StockTemplate")
            {
                Response.Redirect("DistributorItemTemplate.aspx?DistID=" + e.CommandArgument.ToString() + "&CityID=" + CityID + "&VisitID=" + VisitID + "&Level=3");
            }
            if (e.CommandName == "Stock")
            {
                Response.Redirect("DistributorItemStock.aspx?DistID=" + e.CommandArgument.ToString() + "&CityID=" + CityID + "&VisitID=" + VisitID + "&Level=3");
            }
        }
