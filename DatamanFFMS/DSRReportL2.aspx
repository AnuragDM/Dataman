<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="DSRReportL2.aspx.cs" Inherits="AstralFFMS.DSRReportL2" %>
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <div style="text-align: center;display:none;">
                                ...
                                <br />
                                <h4 style="color: #ff8000;">Daily Working Summary L2</h4>
                            </div>
                                          ...
                                          <%--  <asp:Label ID="BrandActivityLabel" runat="server" Visible="false" Text='<%# Eval("BrandActivity")%>'></asp:Label> 
                                           ...
                                           <%-- <asp:Label ID="OtherGeneralInfoLabel" runat="server" Visible="false" Text='<%# Eval("OtherGeneralInfo")%>'></asp:Label> 
                                            ...
                                            <td><%# Eval("Longitude")%></td>
                                             <td><%# Eval("Latitude")%></td>
                                             <td><%# Eval("Address")%></td>
                                            <td><asp:LinkButton ID="lnkViewDemoImg" runat="server" Visible="false" OnClick="lnkViewDemoImg_Click" >View Image</asp:LinkButton>
         ...
         $(function () {
             $('#example1').dataTable({
                 "footerCallback": function (tfoot, data, start, end, display) {
                     ...
                     $(api.column(8).footer()).html(searchTotal3);
                     if (searchTotal == 'NaN' || searchTotal == '') { $(api.column(11).footer()).html('0.0') }
                     if (searchTotal1 == 'NaN' || searchTotal1 == '') { $(api.column(9).footer()).html('0.0') }
                     if (searchTotal3 == 'NaN' || searchTotal3 == '') { $(api.column(8).footer()).html('0.0') }
