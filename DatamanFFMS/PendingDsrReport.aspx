<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="PendingDsrReport.aspx.cs" Inherits="AstralFFMS.PendingDsrReport" %>
                    ...
                    <div id="InputWork">
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <%--<h3 class="box-title">Absent and non approval of DSR - Report</h3>--%>
                            ...
                            <div class="box-body" id="div1">
                               <div class="row">
                                 ...
                                 <div class="row">
                                    <div class="col-md-2 col-sm-5 col-xs-9">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Dsr Allow Days:</label>                                          
                                            <%--<asp:TextBox ID="dadtext" runat="server" CssClass="form-control" Style="background-color: white;" onkeypress="javascript:return isNumber (event)"></asp:TextBox>--%>
                                            <input type="text" runat="server" class="form-control numeric text-right" maxlength="10" id="DsrAllow" value="2" onkeypress="javascript:return isNumber (event)" placeholder="Enter Dsr Allow Days">
                                        </div>
                                    </div> 
                                      <div class="col-md-2 col-sm-3 col-xs-5">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">DSR Type:</label>
                                            <asp:DropDownList ID="ddldsrtype" class="form-control" runat="server">
                                             <asp:ListItem Text="Non Approval DSR" Value="0" />
                                             <asp:ListItem Text="Absent" Value="1" />
                               ...
                               <asp:CheckBox ID="chkdsr" runat="server" />
                            </div>
                                    </div>
                            ...
                            <div class="box-body table-responsive">
                                <div id="noteDiv" runat="server" style="display:none;">
                                  ...
                                  P - Present ,  E - Dsr Entry, L/A - Leave Approved , L - Leave , H - Holiday , Off - Week Off ,  L/R - Leave Rejected , E/R - Dsr Rejected,FHL - First Half Leave,FHL/A - First Half Leave Approved,FHL/R - First Half Leave Rejected,SHL - Second Half Leave,SHL/A - Second Half Leave Approved,SHL/R - Second Half Leave Rejected </span> </asp:Label>&nbsp;&nbsp;
                                <br/><asp:TextBox ID="TextBox1" Height="14px" Width="14px" runat="server" Enabled="false" BackColor="Red"></asp:TextBox>&nbsp;Holiday&nbsp;&nbsp;
                                ...
                                <asp:GridView runat="server" ID="gvData" Width="100%" EmptyDataText="No Records Found"
                                    ...
                                    <Columns>
                                        <asp:BoundField HeaderText="HOD" DataField="Head" ItemStyle-Wrap="false"></asp:BoundField>
                                        <asp:BoundField HeaderText="Reporting  Person" DataField="Reporting" ItemStyle-Wrap="false"></asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="Enter" HeaderText="Entered" Visible="false">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Approve" HeaderText="Approved" Visible="false">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
