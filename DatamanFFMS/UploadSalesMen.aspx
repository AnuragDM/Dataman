<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="UploadSalesMen.aspx.cs" Inherits="FFMS.UploadSalesMen" %>
                ...
                <div id="InputWork">
                    ...
                    <div class="box box-primary">
                      ...
                      <div style="float:right">
                        <asp:HyperLink ID="hpl" runat="server" Text="Download Sample" NavigateUrl="~/SampleImportSheets/Salesman.xls" ></asp:HyperLink>
