<%@ Page Title="" Language="C#" MasterPageFile="~/FFMS.Master" AutoEventWireup="true" CodeBehind="DistributerPurchOrderReport.aspx.cs" Inherits="AstralFFMS.DistributerPurchOrderReport" %>
   ...
   <%-- <script src="<%=ResolveUrl("~")%>plugins/select2/select2.js"></script>
    ...
    <script type="text/javascript">
      ...
      function BindGridView() {
          $.ajax({
              type: "POST",
              url: "DistributerPurchOrderReport.aspx/GetDistributorItemSale",
        ...
        function BindGridViewNew() {
            $('#spinner').show();
            $.ajax({
                type: "POST",
                url: "DistributerPurchOrderReport.aspx/GetDistributorItemSale1",
                data: '{PODOCID: "' + $("#<%=hidqsdocid.ClientID %>").val() + '"}',
                <%--data: "{'Distid':'" + $("#hidpersons").val() + "','Fromdate':'" + $('#<%=txtfmDate.ClientID%>').value + "','Todate':'" + $('#<%=txttodate.ClientID%>').val() + "'}",--%>
              contentType: "application/json; charset=utf-8",
              dataType: "json",
                        ...
                        <div id="InputWork">
                            ...
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <%--<h3 class="box-title">Distributor Purchase Order</h3>--%>
                                       ...
                                       <%-- <div class="col-md-3 col-sm-6 col-xs-7" hidden>
                                        ...
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" id="hidqsdocid" runat="server" />
                                            </div>
                                        ...
                                        <table id="itemsaleTable" class="table table-bordered table-striped">
                                            <thead>
                                                <tr>                                                  
                                                    ...
                                                    <th style="text-align: left; width: 20%">Order No.</th>
