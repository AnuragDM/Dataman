...
{
    public partial class ProductiveRetailer1 : System.Web.UI.Page
    {
        string roleType = "";
        int cnt = 0;
        ...
        protected void btnGo_Click(object sender, EventArgs e)
        {
            ...
            if (smIDStr1 != "")
            {
                ...
                string query = @"SELECT a.smid,a.vdate,a.Visid,a.partyid,a.beatid,a.SMName,a.PartyName,a.Address1,a.Mobile FROM (SELECT om.SMID,om.VDate,om.VisId, om.PartyId,P.BeatId,ms.SMName,p.PartyName,p.Address1,p.Mobile FROM TransOrder om LEFT JOIN mastparty p ON p.PartyId=om.PartyId LEFT JOIN mastsalesrep ms ON om.SMId=ms.SMId UNION ALL SELECT om.SMID,om.VDate,om.VisId, om.PartyId,P.BeatId,ms.SMName,p.PartyName,p.Address1,p.Mobile FROM Temp_TransOrder om LEFT JOIN mastparty p ON p.PartyId=om.PartyId LEFT JOIN mastsalesrep ms ON om.SMId=ms.SMId)a LEFT JOIN mastsalesrep ms ON a.smid=ms.SMId WHERE a.VDate>='" + Settings.dateformat(txtfmDate.Text) + " 00:00' and VDate<='" + Settings.dateformat(txttodate.Text) + " 23:59' AND a.smid IN (SELECT smid FROM MastSalesRep WHERE SMId IN (SELECT smid FROM mastsalesrepgrp WHERE  maingrp IN (" + smIDStr1 + ")) and Active=1)";
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=ProductiveRetailers.csv");
