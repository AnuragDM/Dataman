...
public class UploadData
{
    ...
    public int InsertUpdatePerson(int id, string personname, string DeviceNo, string FromTime, string ToTime, string Interval, string code, string UploadInt, string RetryInt, string degree, Boolean Check, Boolean check1, char Sys_Flag, string Mobile, string SendAlarm, int AlarmMins, string SendSms, string srMobile, String SendSmsP, string SendSmsS, string Lat, string Long, string Empcode, string pushnotification, string BatteryRecord, string active)
    {
        ...
        cmd.Parameters.AddWithValue("@PushNotification", pushnotification);
        cmd.Parameters.AddWithValue("@BatteryRecord", BatteryRecord);
    ...
    //public void SendDeletionEmail(string Name, string MobileNo, string DeviceID,string GroupName)
    //{
    ...
    //        sb.AppendLine("<td>Mobile Number : " + MobileNo + " </td></tr><tr>");
    ...
    //}
    //public void SendInsertionEmail(string Name, string DeviceID, string MobileNo, string GroupName)
    //{
    ...
    //        return false;
    //}
    //public bool SavePersonLicence(string Name, string DeviceID)
    //{
    //    ServiceReferenceDMTracker.WebServiceSoapClient DMT = new ServiceReferenceDMTracker.WebServiceSoapClient("WebServiceSoap");
    //    string val = DMT.SaveLicense_Tracker(Settings.Instance.CompCode, DeviceID, Name, Settings.Instance.CompUrl);
    //    if (val == "1")
    //        return true;
    //    else
    //        return false;
    ...
    //public bool UpdatePersonMasterLicence(string Name, string OldMobileNo, string newmobile,string Active)
    //{
    //    if (!string.IsNullOrEmpty(Name) && !string.IsNullOrEmpty(OldMobileNo))
    //    {
    //        ServiceReferenceDMTracker.WebServiceSoapClient DMT = new ServiceReferenceDMTracker.WebServiceSoapClient("WebServiceSoap");
    //        string val = DMT.UpdateLicense_Tracker(Name, OldMobileNo, newmobile,Active);
    //        if (val == "1")
    //            return true;
    //        else
    //            return false;
    ...
    #endregion
    #region Delete Co-Ordinates
    public void DeleteTransactionData(string Fromdt, string Todt)
    {
        string sqlCommand = "sp_deleteTransactionData";
        SqlConnection con = Connection.Instance.GetConnection();
        SqlCommand cmd = new SqlCommand(sqlCommand, con);
        cmd.CommandType = CommandType.StoredProcedure;
