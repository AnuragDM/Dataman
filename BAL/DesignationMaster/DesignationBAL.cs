...
namespace BAL.DesignationMaster
{
    ...
    {
        //add sort type--------- 14-07-2021
        public int Insert(string DesName, string SyncId, bool Active, DateTime CreatedDate, bool EligibleForConveyance, int GradeId, string DesType, int SortType)
        {
            ...
            dbParam[8] = new DbParameter("@DesType", DbParameter.DbType.VarChar, 20, DesType);
            dbParam[9] = new DbParameter("@SortType", DbParameter.DbType.Int, 1, SortType);
        ...
        //add sort type--------- 14-07-2021
        public int Update(string DesId, string DesName, string SyncId, bool Active, DateTime CreatedDate, bool EligibleForConveyance, int GradeId, string DesType, int SortType)
        {
            DbParameter[] dbParam = new DbParameter[11];
