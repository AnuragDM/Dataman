...
namespace BAL.ProjectMaster
{
    public class ProjectMasterBAL
    {
        public int Insert(string Name, string SyncId, bool Active, DateTime CreatedDate)
        {
            ...
            DbConnectionDAL.ExecuteNonQuery(CommandType.StoredProcedure, "sp_MastProject_ups", dbParam);
            return Convert.ToInt32(dbParam[6].Value);
        }

        public int Update(string Id, string Name, string SyncId, bool Active, DateTime CreatedDate)
        {
            DbParameter[] dbParam = new DbParameter[7];
        ...
        public int delete(string Id)
        {
            ...
            DbConnectionDAL.ExecuteNonQuery(CommandType.StoredProcedure, "sp_MastProject_del", dbParam);
            return Convert.ToInt32(dbParam[1].Value);
        }
        public int UpdateCRMData(int days)
        {
            DbParameter[] dbParam = new DbParameter[2];
            dbParam[0] = new DbParameter("@addday", DbParameter.DbType.Int, 1, days);
            dbParam[1] = new DbParameter("@ReturnVal", DbParameter.DbType.Int, 1, ParameterDirection.Output);
            DbConnectionDAL.ExecuteNonQuery(CommandType.StoredProcedure, "Sp_UpdateCRMData", dbParam);
            return Convert.ToInt32(dbParam[1].Value);
        }
    }
}
