...
namespace BAL
{
    public class ExpenseBAL
    {
        ...
        public int InsertExpenses(Int32 ExpDetailId, string SyncId, int EmployeeId, int ExpenseTypeId, string BillNumber, DateTime BillDate, int FromCity, int ToCity, string FromDate, string ToDate, int CityId, string Remarks, decimal ClaimAmount, decimal BillAmount, int UserId, Boolean IsSupportingAttached, string TravelModeId, int ExpenseGrpId, Boolean StayWithRelative, decimal PerKmRate, decimal kmVisited, string TimeFrom, String TimeTo, string GSTNo, Boolean ischkGstnNo, string vendor, decimal CGSTAmt, decimal SGSTAmt, decimal IGSTAmt, int Fromarea, int Toarea, decimal DA, string tocitymultiple, string toareamultiple, string toareamultipleName)
        {
            DbParameter[] dbParam = new DbParameter[36];
            ...
            dbParam[16] = new DbParameter("@TravelModeId", DbParameter.DbType.VarChar, 200, TravelModeId);
            ...
            dbParam[30] = new DbParameter("@FromArea", DbParameter.DbType.Int, 8, Fromarea);
            dbParam[31] = new DbParameter("@ToArea", DbParameter.DbType.Int, 8, Toarea);
            dbParam[32] = new DbParameter("@DA", DbParameter.DbType.Decimal, 8, DA);
            dbParam[33] = new DbParameter("@tocitymultiple", DbParameter.DbType.VarChar, 500, tocitymultiple);
            dbParam[34] = new DbParameter("@toareamultiple", DbParameter.DbType.VarChar, 500, toareamultiple);
            dbParam[35] = new DbParameter("@toareamultipleName", DbParameter.DbType.VarChar, 500, toareamultipleName);
        ...
        //}
        public int InsertExpenses(Int32 ExpDetailId, string SyncId, int EmployeeId, int ExpenseTypeId, string BillNumber, DateTime BillDate, int FromCity, int ToCity, string FromDate, string ToDate, int CityId, string Remarks, decimal ClaimAmount, decimal BillAmount, int UserId, Boolean IsSupportingAttached, string TravelModeId, int ExpenseGrpId, Boolean StayWithRelative, decimal PerKmRate, decimal kmVisited, string TimeFrom, String TimeTo, string GSTNo, Boolean ischkGstnNo, string vendor, decimal CGSTAmt, decimal SGSTAmt, decimal IGSTAmt, int Fromarea, int Toarea, decimal DA, string tocitymultiple, string toareamultiple, string toareamultipleName, Boolean Ex)
        {
            DbParameter[] dbParam = new DbParameter[37];
            dbParam[0] = new DbParameter("@ExpDetailId", DbParameter.DbType.Int, 10, ExpDetailId);
            dbParam[1] = new DbParameter("@SyncId", DbParameter.DbType.VarChar, 25, SyncId);
            dbParam[2] = new DbParameter("@EmployeeId", DbParameter.DbType.Int, 10, EmployeeId);
            dbParam[3] = new DbParameter("@ExpenseTypeId", DbParameter.DbType.Int, 10, ExpenseTypeId);
            ...
            dbParam[34] = new DbParameter("@toareamultiple", DbParameter.DbType.VarChar, 500, toareamultiple);
            dbParam[35] = new DbParameter("@toareamultipleName", DbParameter.DbType.VarChar, 500, toareamultipleName);
            dbParam[36] = new DbParameter("@Ex", DbParameter.DbType.Bit, 1, Ex);
            DbConnectionDAL.ExecuteNonQuery(CommandType.StoredProcedure, "Sp_InsertExpenses1", dbParam);
            return Convert.ToInt32(dbParam[24].Value);
        }
        ...
        public void UpdateExpenseStatus(Int32 ExpGroupId, Int32 ExpDetailId, Int32 SPSMID, int IsApprRej, string PassRejRemarks, decimal ApprovedAmt, int IsSupportingApproved, int Flag, string TaxCodeApproved, Boolean IsGSTINReg, string GSTINNo, string Vendor, decimal CGSTAmt, decimal SGSTAmt, decimal IGSTAmt)
        {
            ...
            dbParam[14] = new DbParameter("@AppSenior", DbParameter.DbType.Int, 10, SPSMID);
        ...
        public int InsertExpenses_V1(Int32 ExpDetailId, string SyncId, int EmployeeId, int ExpenseTypeId, string BillNumber, DateTime BillDate, int FromCity, int ToCity, string FromDate, string ToDate, int CityId, string Remarks, decimal ClaimAmount, decimal BillAmount, int UserId, Boolean IsSupportingAttached, string TravelModeId, int ExpenseGrpId, Boolean StayWithRelative, decimal PerKmRate, decimal kmVisited, string TimeFrom, String TimeTo, string GSTNo, Boolean ischkGstnNo, string vendor, decimal CGSTAmt, decimal SGSTAmt, decimal IGSTAmt, int Fromarea, int Toarea, decimal DA, string tocitymultiple, string toareamultiple, string toareamultipleName, Boolean Ex, int FromState, int ToState, decimal extraKm, decimal dis_btw_city_km, Boolean returnJourneyFlag, string NighthaltAmt = "0")
        {
            ...
            dbParam[35] = new DbParameter("@toareamultipleName", DbParameter.DbType.VarChar, 500, toareamultipleName);
            dbParam[36] = new DbParameter("@Ex", DbParameter.DbType.Bit, 1, Ex);
            dbParam[37] = new DbParameter("@FromState", DbParameter.DbType.Int, 10, FromState);
            dbParam[38] = new DbParameter("@ToState", DbParameter.DbType.Int, 10, ToState);
            dbParam[39] = new DbParameter("@extraKm", DbParameter.DbType.Decimal, 15, extraKm);
            dbParam[40] = new DbParameter("@dis_btw_city_km", DbParameter.DbType.Decimal, 15, dis_btw_city_km);
            dbParam[41] = new DbParameter("@returnJourneyFlag", DbParameter.DbType.Bit, 1, returnJourneyFlag);
            dbParam[42] = new DbParameter("@NighthaltAmt", DbParameter.DbType.Decimal, 20, NighthaltAmt);
            DbConnectionDAL.ExecuteNonQuery(CommandType.StoredProcedure, "Sp_InsertExpenses1_V1", dbParam);
            return Convert.ToInt32(dbParam[24].Value);
        }
