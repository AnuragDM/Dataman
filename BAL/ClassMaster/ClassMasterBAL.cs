...
namespace BAL.ClassMaster
{
    public class ClassMasterBAL
    {
        public int Insert(string Name, string SyncCode, bool Active, DateTime CreatedDate)
        {
            ...
            DbConnectionDAL.ExecuteNonQuery(CommandType.StoredProcedure, "sp_MastItemClass_ups", dbParam);
        ...
        public int delete(string Id)
        {
            ...
            DbConnectionDAL.ExecuteNonQuery(CommandType.StoredProcedure, "sp_MastItemClass_del", dbParam);
