...
namespace BAL
{
   public class LocalConveyanceLimtBAL
   {
       //public int InsertUpdateLocalConveyanceLimt(Int32 Id, Int32 CityTypeId, Int32 DesId,decimal Amount, string SyncId, bool Active,string Remarks)
       //{
       ...
       //    DbConnectionDAL.ExecuteNonQuery(CommandType.StoredProcedure, "Sp_InsUpdLocalConveyanceLimt", dbParam);
       //    return Convert.ToInt32(dbParam[7].Value);
       //}

       public int InsertUpdateLocalConveyanceLimt(Int32 Id, Int32 CityTypeId, Int32 DesId, decimal Amount, string SyncId, bool Active, string Remarks, bool Ex)
       {
           ...
           dbParam[6] = new DbParameter("@Remarks", DbParameter.DbType.VarChar, 500, Remarks);
           dbParam[7] = new DbParameter("@ReturnVal", DbParameter.DbType.Int, 1, ParameterDirection.Output);
           dbParam[8] = new DbParameter("@Ex", DbParameter.DbType.Bit, 1, Ex);
       ...
       public int delete(string Id)
       {
           ...
           DbConnectionDAL.ExecuteNonQuery(CommandType.StoredProcedure, "Sp_DeleteLocalConveyanceLimt", dbParam);
