...
namespace BAL.PartyCollection
{
  public   class PartyCollection
    {
      public int Insert(string CollDocId, int UserId, int DistId, int SMId, string Mode, decimal Amount, DateTime PaymentDate, string Cheque_DDNo, string Cheque_DD_Date, string Bank, string Branch, string Remarks, string VisId, string VDate, int AreaId)
        {
            ...
            dbParam[3] = new DbParameter("@PartyId", DbParameter.DbType.Int, 4, DistId);
            ...
            dbParam[15] = new DbParameter("@AreaId", DbParameter.DbType.Int, 4, AreaId);
            ...
            DbConnectionDAL.ExecuteNonQuery(CommandType.StoredProcedure, "sp_Temp_TransCollection_ups", dbParam);
            return Convert.ToInt32(dbParam[17].Value);
        }

      public int Update(int CollId, int UserId, int DistId, int SMId, string Mode, decimal Amount, DateTime PaymentDate, string Cheque_DDNo, string Cheque_DD_Date, string Bank, string Branch, string Remarks, string VisId, string VDate, int AreaId)
        {
            DbParameter[] dbParam = new DbParameter[18];
            ...
            dbParam[2] = new DbParameter("@PartyId", DbParameter.DbType.Int, 4, DistId);
            ...
            dbParam[14] = new DbParameter("@AreaId", DbParameter.DbType.Int, 4, AreaId);
        ...
        public int delete(string CollId)
        {
            ...
            DbConnectionDAL.ExecuteNonQuery(CommandType.StoredProcedure, "sp_Temp_TransCollection_del", dbParam);
